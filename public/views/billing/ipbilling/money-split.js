(function() {
    ...
    angular
        .module('app.pages')
        .controller('moneysplitController', moneysplitController);

function moneysplitController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
    var vm = this;
...
moneysplitController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
