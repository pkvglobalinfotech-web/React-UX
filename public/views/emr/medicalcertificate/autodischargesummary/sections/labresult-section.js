...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('dislabSectionController', dislabSectionController);

    function dislabSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.labresults';
    ...
    dislabSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
