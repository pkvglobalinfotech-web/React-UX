(function () {
    ...
    angular
        .module('app.pages')
        .controller('GRNAmendmentController', GRNAmendmentController);

    function GRNAmendmentController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
    ...
    GRNAmendmentController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
