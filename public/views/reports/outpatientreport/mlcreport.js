(function () {
    ...
    angular
        .module('app.pages')
        .controller('mlcreportController', mlcreportController);

    function mlcreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            hiddenElement.download = 'mlc-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintMLCReport',
                data: inputData,
                type: 'post'
            };
    ...
    mlcreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
