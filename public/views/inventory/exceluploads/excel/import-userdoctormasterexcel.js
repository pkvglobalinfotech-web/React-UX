...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('importUserDoctorMasterExcelController', importUserDoctorMasterExcelController);
        
    function importUserDoctorMasterExcelController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter) {
        var vm = this;
        $scope.Items = [];
        $scope.Item = [];
        ...
        $scope.download = function () {
            ...
            const JsonFields = ["Title", "FirstName", "MiddleName", "LastName", "Age",
                "DOB", "Gender", "Qualification", "AddressLine1", "AddressLine2", "Pincode", "Area", "Mobile", "Email", "LicenseNo",
                "LicenseIssueDate", "LicenseExpiryDate", "UserName", "Password", "ActiveStatusId", "IsActive"]
            ...
            hiddenElement.download = 'User/Doctor Bulk Upload.csv';
            hiddenElement.click();
        ...
        $scope.save = function (inputData) {
            ...
            for (var idx in inputData) {
                ...
                if (data.Title) {
                    let genderlen = $scope.lookup.Title.length;
            ...
            $scope.loading = true;
            var options = {
                action: 'SystemSettings/user/AddUserDoctorMasterExcel',
                data: {
                    Data: result
                },
                type: 'post',
    ...
    importUserDoctorMasterExcelController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$timeout', '$filter'];
