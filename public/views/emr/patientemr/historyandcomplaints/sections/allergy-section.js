(function () {
    ...
    angular
        .module('app.pages')
        .controller('allergySectionHstryController', allergySectionHstryController);

    function allergySectionHstryController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.allergyhstryform', {
    ...
    allergySectionHstryController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
