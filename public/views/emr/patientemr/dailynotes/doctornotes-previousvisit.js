(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorNotesPreviousListController', DoctorNotesPreviousListController);

    function DoctorNotesPreviousListController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.gridData = [];
        $scope.Items = [];
        $scope.currentfilter = {
    ...
    DoctorNotesPreviousListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
