(function () {
    ...
    angular
        .module('app.pages')
        .controller('surgeryentryreportController', surgeryentryreportController);

    function surgeryentryreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            data.Data.forEach(function (rowArray) {
                ...
                if (rowArray.SurgeryRegisteredOn) {
                    ...
                    date = utl.Formatter.getDateTimeString(rowArray.SurgeryRegisteredOn);
                }
                if (rowArray.Patient) {
        ...
        vm.gridConfig = {
            ...
            {
                field: "Doctor Name",
                displayName: $translate.instant('Secondary Surgeon'),
                cellTemplate: "<div class='ui-grid-cell-contents'>\
                                       <span ng-if='entity.AssistantSurgeon.Title && entity.AssistantSurgeon.Title.Description'>{{entity.AssistantSurgeon.Title.Description}}&nbsp;</span>\
                                       <span>{{entity.AssistantSurgeon.FirstName}}</span>&nbsp;<span>{{entity.AssistantSurgeon.LastName}}</span>\
                                        </div>"
            },
            {
                field: "Anaesthesist",
    ...
    surgeryentryreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
