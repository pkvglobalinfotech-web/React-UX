(function () {
    ...
    angular
        .module('app.pages')
        .controller('disfollowupSectionController', disfollowupSectionController);

    function disfollowupSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        $scope.sectionData = {};

        var SRef = 'emr.cn.followup';
    ...
    disfollowupSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
