(function() {
    ...
    angular
        .module('app.pages')
        .controller('PreviousEmergencyPatientslistController', PreviousEmergencyPatientslistController);

    function PreviousEmergencyPatientslistController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    PreviousEmergencyPatientslistController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
