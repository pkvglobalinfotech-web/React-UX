...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('diagnosisSectionController', diagnosisSectionController);

    function diagnosisSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    diagnosisSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
