(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterContractFormController', newitemmasterContractFormController);

    function newitemmasterContractFormController($scope, $stateParams, $state, $translate, Upload, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    newitemmasterContractFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'Upload', 'utl', '$uibModalInstance', 'modalConfig'];
