(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemMastersListController', newitemMastersListController);

    function newitemMastersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.getItemCallback = function (scope, res, options, hasError) {
            ...
            */
            if (res.Data.length > 0) {
                $state.go('app.itemmasterformtab.itemmasterform', {
                    id: res.Data[0].Id,
        ...
        $scope.addNew = function () {
            $state.go('app.itemmasterformtab.itemmasterform', { id: 0 });
        };
    ...
    newitemMastersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
