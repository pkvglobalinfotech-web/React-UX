(function () {
    ...
    angular
        .module('app.pages')
        .controller('EyesocialHistorySectionController', EyesocialHistorySectionController);

    function EyesocialHistorySectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.socialhistoryform', {
    ...
    EyesocialHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
