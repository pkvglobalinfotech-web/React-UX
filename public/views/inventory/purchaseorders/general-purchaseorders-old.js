(function () {
    ...
    function generalpurchaseOrdersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                Params: [{
                    ...
                    {
                        Key: 6,
                        Value: $scope.advancedfilter.ToStoreId
                    },
                    {
                        Key: 11,
                        Value: $scope.advancedfilter.FromFacility
                    },
                    {
                        Key: 12,
                        Value: $scope.advancedfilter.ToFacility
                    },
                    {
                        Key: 13,
                    ...
                    {
                        Key: 14,
                        Value: $scope.advancedfilter.AuthorizedBy
                    },
                    {
                        Key: 16,
                    ...
                    {
                        Key: 17,
                        Value: $scope.currentfilter.VendorFacilityMapId
                    },
                    {
                        Key: 18,
        ...
        function setDefaults() {
            ...
            $scope.currentfilter.PoStatusId = SaveId + "," + ApprovedId;
        }
