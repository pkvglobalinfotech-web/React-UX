(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientcndtnHstryFormController', PatientcndtnHstryFormController);
    function PatientcndtnHstryFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, uibButtonConfig) {
        var vm = this;
    ...
    PatientcndtnHstryFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
})();