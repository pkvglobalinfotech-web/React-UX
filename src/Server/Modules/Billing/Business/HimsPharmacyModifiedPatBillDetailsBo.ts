...
import {
    PharmacyModifyPatBillDetailsInstance,
    PharmacyModifyPatBillDetailsAttributes
...
export class PharmacyModifyPatBillDetailsBo extends BaseBo<PharmacyModifyPatBillDetailsInstance,
    PharmacyModifyPatBillDetailsAttributes>  {
    public async AddPatientBillDetails(req: BaseRequest): Promise<number> {
        let result = await this.Save(req.Data);
        return result.dataValues.Id;
    }
    public async ManagePatientBillDetails(PatientBillId: number, details: PharmacyModifyPatBillDetailsAttributes[]): Promise<any> {
        details = details || [];
    ...
    public GetModel(): SStatic.Model<PharmacyModifyPatBillDetailsInstance, PharmacyModifyPatBillDetailsAttributes> {
        return this.Models.PharmacyModifyPatBillDetails;
    }
