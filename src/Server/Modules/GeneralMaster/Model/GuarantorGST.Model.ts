...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.GuarantorGSTInstance, i.GuarantorGSTAttributes> {
    let GuarantorGST = sequelize.define<i.GuarantorGSTInstance, i.GuarantorGSTAttributes>('GuarantorGST', {
        Id: { type: DataTypes.BIGINT, field: 'GuarantorGSTId', primaryKey: true, autoIncrement: true },
