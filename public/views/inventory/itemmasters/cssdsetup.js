(function () {
    ...
    angular
        .module('app.pages')
        .controller('cssdsetupController', cssdsetupController);

    function cssdsetupController($scope, $stateParams, $state, $translate, utl, ) {
        var vm = this;
    ...
    cssdsetupController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
