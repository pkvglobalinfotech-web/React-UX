(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnFamilySocialHistorySectionController', discasshtcnFamilySocialHistorySectionController);

    function discasshtcnFamilySocialHistorySectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnFamilySocialHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
