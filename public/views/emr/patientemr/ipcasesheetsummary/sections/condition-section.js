(function () {
    ...
    function conditionSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    conditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
