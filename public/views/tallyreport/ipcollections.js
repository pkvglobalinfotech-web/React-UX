(function () {
    ...
    angular
        .module('app.pages')
        .controller('IPCollectionsReportController', IPCollectionsReportController);

    function IPCollectionsReportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
    ...
    IPCollectionsReportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
