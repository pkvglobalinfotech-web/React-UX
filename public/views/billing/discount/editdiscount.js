(function () {
    ...
    function editdiscountController($scope, $filter, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        ...
        $scope.DiscountApproved = function () {

                $scope.item.DiscountApprovalStatusId = 2;
                $scope.UpdatePatientBillsForDiscountApproval();
            };
            $scope.DiscountRejected = function () {

                $scope.item.DiscountApprovalStatusId = 3;
                $scope.UpdatePatientBillsForDiscountApproval();
            };
        $scope.UpdatePatientBillsForDiscountCallback = function (scope, data, options, hasError) {
            utl.Alert.showSuccessMsg($translate.instant('common.successmsg.lbl'));
            $scope.confirmCallback();
        };
        $scope.UpdatePatientBillsForDiscountApproval = function () {
            let actionName = 'Billing/PatientBills/UpdatePatientBillsforDiscount';
            var inputData = {
                    Id:  $scope.item.Id,
                    DiscountApprovalStatusId: $scope.item.DiscountApprovalStatusId,
            ...
            var options = {
                ...
                type: 'post',
                onComplete: $scope.UpdatePatientBillsForDiscountCallback
            };
            utl.Http.doAction(options);
        };
