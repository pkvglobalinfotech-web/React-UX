(function () {
    ...
    angular
        .module('app.pages')
        .controller('surgerysurgeonreportController', surgerysurgeonreportController);

    function surgerysurgeonreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    surgerysurgeonreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
