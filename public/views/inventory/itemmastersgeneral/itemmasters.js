(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalitemMastersListController', generalitemMastersListController);

    function generalitemMastersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.getItemCallback = function (scope, res, options, hasError) {
            ...
            */
            if (res.Data.length > 0) {
                $state.go('app.itemmastertabgeneral.itemmastergeneral', {
                    id: res.Data[0].Id,
        ...
        $scope.addNew = function () {
            $state.go('app.itemmastertabgeneral.itemmastergeneral', { id: 0 });
        };
    ...
    generalitemMastersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
