(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientListReportController', PatientListReportController);

    function PatientListReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            const JsonFields = ["Patient Name", "Age and Sex", "MRN", "Registration Date", "Referral Type", "Referral", "City", "Reason"]
            ...
            data.Data.forEach(function (rowArray) {
                ...
                if (rowArray.RegisteredDate) {
                    ...
                    visit = utl.Formatter.getDateTimeString(rowArray.RegisteredDate);
                }
                ...
                csvContent += name + ',' + age + ',' + mrn + ',' + visit + ',' + reftype + ',' + ref + ',' + city + ',' + reason + "\n";
            });
        ...
        vm.gridConfig = {
...

            {
                ...
                displayName: $translate.instant('Registered Date'),
            ...
            },
            {
                ...
                displayName: $translate.instant('ReferralType')
            },
            {
    ...
    PatientListReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
