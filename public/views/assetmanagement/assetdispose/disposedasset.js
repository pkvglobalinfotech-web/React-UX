(function () {
    ...
    angular
        .module('app.pages')
        .controller('DisposedAssetController', DisposedAssetController);

    function DisposedAssetController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    DisposedAssetController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
