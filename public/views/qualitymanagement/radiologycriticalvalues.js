(function() {
    ...
    angular
        .module('app.pages')
        .controller('RadiologyCriticalValuesController', RadiologyCriticalValuesController);

    function RadiologyCriticalValuesController($rootScope, $timeout, $scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    RadiologyCriticalValuesController.$inject = ['$rootScope', '$timeout', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
