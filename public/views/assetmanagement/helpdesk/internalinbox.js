(function () {
    ...
    angular
        .module('app.pages')
        .controller('InternalInboxController', InternalInboxController);

    function InternalInboxController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    InternalInboxController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
