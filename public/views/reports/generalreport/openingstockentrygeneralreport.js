(function () {
    ...
    angular
        .module('app.pages')
        .controller('openingstockentrygeneralreportController', openingstockentrygeneralreportController);

    function openingstockentrygeneralreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    openingstockentrygeneralreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
