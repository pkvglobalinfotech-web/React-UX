(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalpurchaseOrdersListController', generalpurchaseOrdersListController);

    function generalpurchaseOrdersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    generalpurchaseOrdersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
