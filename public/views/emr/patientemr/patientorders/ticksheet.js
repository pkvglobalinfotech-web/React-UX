(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientOrderFormticksheetController', patientOrderFormticksheetController);

function patientOrderFormticksheetController($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
...
patientOrderFormticksheetController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
