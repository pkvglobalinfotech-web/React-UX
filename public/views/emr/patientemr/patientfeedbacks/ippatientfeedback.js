(function () {
    ...
    angular
        .module('app.pages')
        .controller('IPpatientfeedbacksFormController', IPpatientfeedbacksFormController);

    function IPpatientfeedbacksFormController($scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, lodash, $uibModalInstance, modalConfig) {
        var vm = this;
        $scope.item = {
    ...
    IPpatientfeedbacksFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', 'lodash', '$uibModalInstance', 'modalConfig'];
