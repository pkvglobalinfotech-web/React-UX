(function () {
    ...
    angular
        .module('app.pages')
        .controller('emergencypatientreportController', emergencypatientreportController);

    function emergencypatientreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            hiddenElement.download = 'daycare-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintEmergencyPatientReport',
                data: inputData,
                type: 'post'
            };
    ...
    emergencypatientreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
