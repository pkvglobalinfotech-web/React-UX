(function () {
    ...
    angular
        .module('app.pages')
        .controller('CurrentPrescriptionController', CurrentPrescriptionController);

    function CurrentPrescriptionController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.gridData = [];
        $scope.Prescriptions = [];
        $scope.currentfilter = {
    ...
    CurrentPrescriptionController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
