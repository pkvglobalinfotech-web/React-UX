(function () {
    ...
    angular
        .module('app.pages')
        .controller('dissurgicalSectionController', dissurgicalSectionController);

    function dissurgicalSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.surgical';
    ...
    dissurgicalSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
