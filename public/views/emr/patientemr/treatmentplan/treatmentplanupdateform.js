(function() {
    ...
    angular
        .module('app.pages')
        .controller('TreatmentPlanUpdateFormController', TreatmentPlanUpdateFormController);

    function TreatmentPlanUpdateFormController($scope, $interval, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter) {
        var vm = this;
    ...
    TreatmentPlanUpdateFormController.$inject = ['$scope', '$interval', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$filter'];
