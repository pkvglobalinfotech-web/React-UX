(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientrequestdetailsController', patientrequestdetailsController);

    function patientrequestdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    patientrequestdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
