(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientConditionSectionController', PatientConditionSectionController);

    function PatientConditionSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.patientconhstryform', {
    ...
    PatientConditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
