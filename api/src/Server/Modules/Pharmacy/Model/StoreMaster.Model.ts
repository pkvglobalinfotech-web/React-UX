...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.StoreMasterInstance, i.StoreMasterAttributes> {
    let StoreMaster = sequelize.define<i.StoreMasterInstance, i.StoreMasterAttributes>('StoreMaster', {
        Id: { type: DataTypes.BIGINT, field: 'StoreMasterId', primaryKey: true, autoIncrement: true },
    ...
    (StoreMaster as any).associate = function (models: Models) {
        StoreMaster.belongsTo(models.ReferenceValue, { as: 'ActiveStatus', targetKey: 'ReferenceValueCodeId' });
        StoreMaster.belongsTo(models.ReferenceValue, { as: 'StoreType', targetKey: 'ReferenceValueCodeId' });
        StoreMaster.belongsTo(models.ReferenceValue, { as: 'StoreSubType', targetKey: 'ReferenceValueCodeId' });
        StoreMaster.belongsTo(models.ReferenceValue, { as: 'StorePolicy', targetKey: 'ReferenceValueCodeId' });
        StoreMaster.belongsTo(models.ReferenceValue, { as: 'PrinterOption', targetKey: 'ReferenceValueCodeId' });
        StoreMaster.belongsTo(models.Facility);
        StoreMaster.belongsTo(models.Department);
        StoreMaster.belongsToMany(models.ItemMaster, { through: models.ItemStoreMap });
    };
    return StoreMaster;
}
