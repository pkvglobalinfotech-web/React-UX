...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.OtScheduleDetailsInstance, i.OtScheduleDetailsAttributes> {
    let OtScheduleDetails = sequelize.define<i.OtScheduleDetailsInstance, i.OtScheduleDetailsAttributes>('OtScheduleDetails', {
        Id: { type: DataTypes.BIGINT, field: 'OTScheduleDetailId', primaryKey: true, autoIncrement: true },
        OTScheduledId: { type: DataTypes.BIGINT, field: 'OTScheduledId' },
        // OTScheduledOn: { type: DataTypes.DATE, field: 'OTScheduledOn' },
        PatientId: { type: DataTypes.BIGINT, field: 'PatientId' },
        // PatientName: { type: DataTypes.STRING, field: 'PatientName' },
        // OTScheduledId: { type: DataTypes.DATE, field: 'OTScheduledId' },
    ...
    },
        {
            indexes: [],
            timestamps: true,
            tableName: 'hims_surgeryscheduledetails',
            createdAt: 'CreatedAt',
            updatedAt: 'UpdatedAt',
    ...
    (OtScheduleDetails as any).associate = function (models: Models) {

        // OtScheduleDetails.belongsTo(models.User, { as: 'Doctor', foreignKey: 'DoctorId' });
        // OtSchedule.belongsTo(models.User, { as: 'ChiefSurgeon', foreignKey: 'ChiefSurgeonId' });
        OtScheduleDetails.belongsTo(models.Patient);
        OtScheduleDetails.belongsTo(models.Facility, { foreignKey: 'FacilityId' });
        OtScheduleDetails.belongsTo(models.Department, { foreignKey: 'DepartmentId' });
        OtScheduleDetails.belongsTo(models.Procedure, { foreignKey: 'ProcedureId' });
        // OtScheduleDetails.belongsTo(models.User, { as: 'CreatedUser', foreignKey: 'CreatedBy' });
        // OtScheduleDetails.belongsTo(models.User, { as: 'ScheduledUser', foreignKey: 'ScheduleBy' });
        // OtScheduleDetails.belongsTo(models.User, { as: 'ConfirmedUser', foreignKey: 'ConfirmedBy' });
        // OtScheduleDetails.belongsTo(models.User, { as: 'CancelledUser', foreignKey: 'CancelledBy' });
        // OtScheduleDetails.belongsTo(models.User, { as: 'Anaesthesist', foreignKey: 'AnaesthesistId' });
        // OtScheduleDetails.belongsTo(models.ReferenceValue,
        ...
        //     OtScheduleDetails.belongsTo(models.PatientGuarantor, { as: 'PatientGuarantor', foreignKey: 'GuarantorId' });
    };
    return OtScheduleDetails;
}
