(function() {
    ...
    angular
        .module('app.pages')
        .controller('EmropbilldetailsController', EmropbilldetailsController);

    function EmropbilldetailsController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    EmropbilldetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
