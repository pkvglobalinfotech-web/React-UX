(function () {
    ...
    angular
        .module('app.pages')
        .controller('SalesGSTReportController', SalesGSTReportController);

    function SalesGSTReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    SalesGSTReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
