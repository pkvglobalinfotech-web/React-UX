...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('FamilySocialHistorySectnController', FamilySocialHistorySectnController);

    function FamilySocialHistorySectnController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.familysocialhstryform', {
    ...
    FamilySocialHistorySectnController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
