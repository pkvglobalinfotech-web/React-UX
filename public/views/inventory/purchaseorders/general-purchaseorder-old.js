(function () {
    ...
    function generalpurchaseOrderFormController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.onVendorItemSelected = function (idx, selectedItem) {
            ...
            selectedItem.DefinedFreeQty = SelectedMasterItem.FreeQty || 0;
        ...
        $scope.computeAmount = function (item) {
            if (checkprqty(item)) {
                if (parseFloat(item.PoQuantity) > 0) {
                    ...
                    item.UnitGrossAmount = parseFloat((parseFloat(item.PurchasePrice) * parseInt(item.PoQuantity)).toFixed(4));
                    item.UnitNetAmount = parseFloat((parseFloat(item.UnitCostPrice) * parseInt(item.PoQuantity)).toFixed(4));
    ...
    generalpurchaseOrderFormController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
