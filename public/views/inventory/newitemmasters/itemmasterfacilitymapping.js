(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterFacilityMapController', newitemmasterFacilityMapController);

    function newitemmasterFacilityMapController($scope, $stateParams, $state, $translate) {
    ...
    newitemmasterFacilityMapController.$inject = ['$scope', '$stateParams', '$state', '$translate'];
