(function () {
    ...
    angular
        .module('app.pages')
        .controller('outstandingreportviewController', outstandingreportviewController);

    function outstandingreportviewController($scope, $stateParams, $state, $translate, $filter, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    outstandingreportviewController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', '$uibModalInstance', 'modalConfig'];
