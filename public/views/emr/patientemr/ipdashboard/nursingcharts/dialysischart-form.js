(function () {
    ...
    angular
        .module('app.pages')
        .controller('DialysisChartFormController', DialysisChartFormController);

    function DialysisChartFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.item = {
            DialysisChartDate: utl.Formatter.getCurrentDate(),
            DialysisChartTime: time,
        ...
        $scope.getItem = function (pageNo) {
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                ...
                var options = {
                    action: 'emr/PatientDialysisChart/GetPatientDialysisChartById',
        ...
        $scope.saveItem = function () {
            ...
            var actionName = 'emr/PatientDialysisChart/AddPatientDialysisChart';
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                actionName = 'emr/PatientDialysisChart/UpdatePatientDialysisChart';
            }
        ...
        //autosearch for capturedby starts
        ...
        function postsearchuser() {
            for (var idx in vm.usercontrolconfig.result) {
                ...
                item.UserId = item.Id;
                item.UserName = item.Title.Description + ' ' + item.FirstName + ' ' + item.LastName;
                item.Qualification = item.Qualification;
                item.Speciality = item.Department.DepartmentName;
            }
        }
        //autosearch for capturedby ends
    ...
    DialysisChartFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
