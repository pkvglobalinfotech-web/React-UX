(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterpriceController', newitemmasterpriceController);

    function newitemmasterpriceController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    newitemmasterpriceController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
