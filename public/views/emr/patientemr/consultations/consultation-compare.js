(function () {
    ...
    angular
        .module('app.pages')
        .controller('consultationCompareController', consultationCompareController);

    function consultationCompareController($scope, $sce, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    consultationCompareController.$inject = ['$scope', '$sce', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
