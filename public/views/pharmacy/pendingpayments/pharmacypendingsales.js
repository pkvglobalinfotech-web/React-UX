(function () {
    ...
    angular
        .module('app.pages')
        .controller('pharmacyPendingsalesController', pharmacyPendingsalesController);

    function pharmacyPendingsalesController($scope, $interval, $stateParams, $state,
        $translate, utl, $filter, $uibModalInstance, modalConfig, $timeout) {
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.currentcontext.storeid = modalConfig.params.storeid;
            ...
            if ($scope.PatientBillInfo && $scope.PatientBillInfo.length > 0) {
                ...
                $scope.PatientBillInfo.forEach(patientbills => {
                    ...
                    if ($scope.item.PharmacySaleTypeId == 4) {
                        ...
                        if (patientbills && patientbills.Encounter &&
                            patientbills.Encounter.VisitIdentifier) {
                            $scope.item.VisitIdentifier = patientbills.Encounter.VisitIdentifier;
                        }
                        ...
                        $scope.GuarantorTypeChange({ Id: patientbills.GuarantorTypeId });
            ...
            if (SearchBillId && SearchBillId > 0) {
                var inputData = {
                    Params: [
                        ...
                        { Key: 29, Value: $scope.currentcontext.storeid }
                    ],
                    PageContext: {
                        PageSize: 100,
                        PageNumber: 1
    ...
    pharmacyPendingsalesController.$inject = ['$scope', '$interval', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig', '$timeout'];
