(function () {
    ...
    function refundFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        ...
        if (modalConfig && modalConfig.params.receipt) {
            if(modalConfig.params.receipt.ReceiptTypeId == 7) {
                $scope.item.ReceiptTypeId = modalConfig.params.receipt.ReceiptTypeId;
        ...
        $scope.getEncounter = function () {
            var options = {
                action: 'encounter/encounter/GetEncounterById',
                data: {
