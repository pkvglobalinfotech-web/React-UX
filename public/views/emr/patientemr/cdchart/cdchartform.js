(function () {
    ...
    angular
        .module('app.pages')
        .controller('CdChartFormController', CdChartFormController);

    function CdChartFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.item = {
            CdChartDate: utl.Formatter.getCurrentDate(),
            CdChartTime: time,
        ...
        $scope.getItem = function (pageNo) {
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                ...
                var options = {
                    action: 'emr/CdChart/GetCdChartById',
        ...
        $scope.saveItem = function () {
            ...
            var actionName = 'emr/CdChart/AddCdChart';
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                actionName = 'emr/CdChart/UpdateCdChart';
            }
...
/* autosearch End */
    ...
    CdChartFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
