(function () {
    ...
    angular
        .module('app.pages')
        .controller('billsettingFormController', billsettingFormController);

    function billsettingFormController($scope, $stateParams, $state, $translate, utl, jsonPath) {
    ...
    billsettingFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'jsonPath'];
