(function () {
    ...
    angular
        .module('app.pages')
        .controller('ConsignmentInvoiceFormController', ConsignmentInvoiceFormController);

    function ConsignmentInvoiceFormController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.getGrnDetailsCallback = function (scope, res, options, hasError) {
            ...
            for (var idx in $scope.grnDetails) {
                ...
                if (grnitem.ItemMasterId > 0) {
                    ...
                    grnitem.GrnQuantity = grnitem.PoQuantity;
        ...
        $scope.backToList = function () {
            $state.go('app.consignmentinvoice', {
    ...
    ConsignmentInvoiceFormController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
