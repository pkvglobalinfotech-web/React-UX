(function () {
    ...
    angular
        .module('app.pages')
        .controller('taxgstreportController', taxgstreportController);

    function taxgstreportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.salesgstreport = function () {
            $state.go('app.salesgstreport', { context: 'storetaxreport' })
        }
        $scope.returngstreport = function () {
            $state.go('app.returngstreport', { context: 'storetaxreport' })
        }
        $scope.purchasesalesgstreport = function () {
            $state.go('app.purchasesalesgstreport', { context: 'storetaxreport' })
        }
        $scope.purchasereturngstreport = function () {
            $state.go('app.purchasereturngstreport', { context: 'storetaxreport' })
        }
        $scope.staffcreditsummaryreport = function () {
            $state.go('app.staffcreditsummaryreport')
        }
        $scope.consolidatesalesgstreport = function () {
            $state.go('app.consolidatesalesgstreport', { context: 'storetaxreport' })
        }
        $scope.consolidatepurchasegstreport = function () {
            $state.go('app.consolidatepurchasegstreport', { context: 'storetaxreport' })
        }
        $scope.stocksummaryproductgstreport = function () {
            $state.go('app.stocksummaryproductgstreport', { context: 'storetaxreport' })
        }
        $scope.consolidateinputgstsummary = function () {
            $state.go('app.consolidateinputgstsummary', { context: 'storetaxreport' })
        }
        $scope.consolidateoutputgstsummary = function () {
            $state.go('app.consolidateoutputgstsummary', { context: 'storetaxreport' })
        }
    }
    taxgstreportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
