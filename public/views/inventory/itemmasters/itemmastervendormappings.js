(function() {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterVendorMapListController', itemmasterVendorMapListController);

    function itemmasterVendorMapListController($scope, $stateParams, $state, $translate, utl, $filter, modalConfig) {
        var vm = this;
    ...
    itemmasterVendorMapListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'modalConfig'];
