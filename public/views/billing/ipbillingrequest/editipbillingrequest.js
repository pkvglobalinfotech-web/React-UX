(function () {
    ...
    angular
        .module('app.pages')
        .controller('editipbillingrequestController', editipbillingrequestController);

    function editipbillingrequestController($scope, $filter, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
