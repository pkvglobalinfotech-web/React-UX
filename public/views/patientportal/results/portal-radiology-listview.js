(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientRadiologyListController', patientRadiologyListController);

function patientRadiologyListController($scope, $stateParams, $state, $translate, utl, $filter) {
    var vm = this;
    ...
    $scope.radiologydetails = function () {
...
patientRadiologyListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
