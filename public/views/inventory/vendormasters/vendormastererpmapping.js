(function() {
    ...
    angular
        .module('app.pages')
        .controller('vendormasterERPMapFormController', vendormasterERPMapFormController);

    function vendormasterERPMapFormController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.backToList = function() {
            $state.go('app.vendormastertab.vendormastererpmappings');
        }
    ...
    vendormasterERPMapFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
