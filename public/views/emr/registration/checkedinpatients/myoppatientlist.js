(function () {
    ...
    angular
        .module('app.pages')
        .controller('MyOPPatientsController', MyOPPatientsController);

    function MyOPPatientsController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
        ...
        function attendPatient(data) {
            ...
            var inputData = {
                ...
                ocId: data.ocid,
                doctor: data.doctor,
                appointmentDisplay: data.appointmentDisplay
            }
            var options = {
                encounter: {},
                action: actionName,
    ...
    MyOPPatientsController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
