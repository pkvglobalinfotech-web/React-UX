(function () {
    ...
    angular
        .module('app.pages')
        .controller('patientdischargeListController', patientdischargeListController);

    function patientdischargeListController($scope, $filter, $stateParams, $state, $translate, utl, uibButtonConfig) {
        var vm = this;
        ...
        $scope.currentfilter = {
            ...
            From: utl.Formatter.addDays(utl.Formatter.getCurrentDate(), -7),
        ...
        $scope.getList = function () {
            ...
            if ($scope.currentfilter.patientnamemrn) {
                $scope.currentfilter.From = '';
                $scope.currentfilter.To = '';
