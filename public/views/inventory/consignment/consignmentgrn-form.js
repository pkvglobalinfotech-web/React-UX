(function () {
    ...
    angular
        .module('app.pages')
        .controller('ConsignmentGRNFormController', ConsignmentGRNFormController);

    function ConsignmentGRNFormController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.saveItem = function () {
            ...
            if (!$scope.item.DcNumber) {
                utl.Alert.showErrorMsg($translate.instant('Please Enter DC Number'));
                return false;
            }
            if ($scope.item.DcNumber && $scope.item.DcNumber == '') {
                utl.Alert.showErrorMsg($translate.instant('Please Enter DC Number'));
                return false;
            }
            if (!utl.Validator.validate($scope)) {
    ...
    ConsignmentGRNFormController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
