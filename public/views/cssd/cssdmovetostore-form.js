(function() {
    ...
    angular
        .module('app.pages')
        .controller('cssdmovetostoreformController', cssdmovetostoreformController);

    function cssdmovetostoreformController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cssdmovetostoreformController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
