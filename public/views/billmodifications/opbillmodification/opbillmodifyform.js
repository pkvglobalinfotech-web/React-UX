(function () {
    ...
    angular
        .module('app.pages')
        .controller('opbillmodifyFormController', opbillmodifyFormController);

    function opbillmodifyFormController($scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.editPatientBillDetails = function (idx, item) {
            utl.Modal.open('app.opbillmodifydetails', {
                params: {
                    pid: item.PatientId,
        ...
        vm.serviceitemcontrolconfig = {
            ...
            options: [{
                ...
                {
                    header: 'Night Tariff %',
                    field: 'NightTariffAmt',
                    datatype: 'string',
                    headercls: 'td-rate',
                    fieldcls: 'td-rate'
                },
                {
                    header: 'Holiday Tariff %',
                    field: 'HolidayTariffAmt',
                    datatype: 'string',
                    headercls: 'td-rate',
                    fieldcls: 'td-rate'
                }
    ...
    opbillmodifyFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
