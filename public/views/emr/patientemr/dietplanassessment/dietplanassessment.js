(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientDietPlanAssessmentController', PatientDietPlanAssessmentController);

    function PatientDietPlanAssessmentController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    PatientDietPlanAssessmentController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
