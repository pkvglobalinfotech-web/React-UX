(function () {
    ...
    angular
        .module('app.pages')
        .controller('otrequesthistoryController', otrequesthistoryController);

    function otrequesthistoryController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        vm.gridConfig = {
            columnDefs: [
                ...
                { field: "PatientDispense.StoreName", displayName: $translate.instant('inventory.pr-history.store.lbl') },
                { field: "PatientDispense.PatientRequestNumber", displayName: $translate.instant('inventory.pr-history.srnumber.lbl') },
                {
                    field: "PatientDispense.DispenseDateTime",
                    displayName: $translate.instant('inventory.pr-history.srdate.lbl'),
                    cellTemplate: "<ngformatdate date-val='row.entity.StockRequest.DispenseDateTime'></ngformatdate>"
                },
    ...
    otrequesthistoryController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
