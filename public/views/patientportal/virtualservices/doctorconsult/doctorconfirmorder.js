(function() {
    ...
    angular
        .module('app.pages')
        .controller('doctorconfirmorderController', doctorconfirmorderController);

    function doctorconfirmorderController($scope, $stateParams, $state, $translate, utl, Upload, $timeout) {
    ...
    doctorconfirmorderController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload', '$timeout'];
