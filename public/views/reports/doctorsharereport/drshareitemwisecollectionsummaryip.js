(function () {
    ...
    angular
        .module('app.pages')
        .controller('drshareitemwisecollectionsummaryipController', drshareitemwisecollectionsummaryipController);

    function drshareitemwisecollectionsummaryipController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/CollectionBaseRevenue/PrintDocShareItemCollectionSummaryIPReport',
                data: inputData,
                type: 'post'
            };
    ...
    drshareitemwisecollectionsummaryipController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
