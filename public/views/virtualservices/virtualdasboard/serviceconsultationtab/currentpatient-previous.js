(function () {
    ...
    angular
        .module('app.pages')
        .controller('ServicePreviousPatientsController', ServicePreviousPatientsController);

    function ServicePreviousPatientsController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    ServicePreviousPatientsController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
