(function() {
    ...
    angular
        .module('app.pages')
        .controller('managecssditemgroupFormController', managecssditemgroupFormController);

    function managecssditemgroupFormController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    managecssditemgroupFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
