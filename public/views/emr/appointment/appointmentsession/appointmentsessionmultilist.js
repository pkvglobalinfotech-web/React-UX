(function () {
    ...
    angular
        .module('app.pages')
        .controller('apptmultiSessionListController', apptmultiSessionListController);

    function apptmultiSessionListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        if ($scope.$parent && $scope.$parent.currentcontext &&
            $scope.$parent.currentcontext.selecteddocid) {
            $scope.currentfilter.DoctorId = $scope.$parent.currentcontext.selecteddocid;
        }
        ...
        $scope.addNew = function () {
            utl.Modal.open('app.apptmultisessionfrom', {
                params: { id: 0, selecteddocid: $scope.currentfilter.DoctorId },
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                { field: "AppointmentSessionType.Description", displayName: $translate.instant('appointment.appointmentsession-list.appointmentsessiontype.lbl') },
                {
                    field: "User.FirstName", displayName: $translate.instant('appointment.appointmentsession-list.doctor.lbl'),
                ...
                {
                    field: "StartDate", displayName: $translate.instant('appointment.appointmentsession-list.startdate.lbl'),
                    cellTemplate: "<ngformatdate date-val='entity.StartDate'></ngformatdate>"
                },
                {
                    field: "StartTime", displayName: $translate.instant('appointment.appointmentsession-list.starttime.lbl'),
                    cellTemplate: "<ngformatdate date-val='entity.StartTime'></ngformatdate>"
                },
                {
                    field: "EndDate", displayName: $translate.instant('appointment.appointmentsession-list.enddate.lbl'),
                    cellTemplate: "<ngformatdate date-val='entity.EndDate'></ngformatdate>"
                },
                {
                    field: "EndTime", displayName: $translate.instant('appointment.appointmentsession-list.endtime.lbl'),
                    cellTemplate: "<ngformatdate date-val='entity.EndTime'></ngformatdate>"
                },
                { field: "MaxSlotPerDay", displayName: $translate.instant('appointment.appointmentsession-list.maxslotperday.lbl') },
    ...
    apptmultiSessionListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
