(function () {
    ...
    angular
        .module('app.pages')
        .controller('tallysalesreturnreportReportController', tallysalesreturnreportReportController);

    function tallysalesreturnreportReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    tallysalesreturnreportReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
