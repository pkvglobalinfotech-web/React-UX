(function () {
    ...
    angular
        .module('app.pages')
        .controller('deceasedFormController', deceasedFormController);

    function deceasedFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    deceasedFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
