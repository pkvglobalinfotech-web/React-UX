(function() {
    ...
    angular
        .module('app.pages')
        .controller('newgeneralitemmasterVendorMapListController', newgeneralitemmasterVendorMapListController);

    function newgeneralitemmasterVendorMapListController($scope, $stateParams, $state, $translate, utl, $filter, modalConfig) {
        var vm = this;
        ...
        $scope.addNew = function() {
            utl.Modal.openFixedDialog('app.newitemmastertabgeneral.itemmastervendormappinggeneral', {
    ...
    newgeneralitemmasterVendorMapListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'modalConfig'];
