(function () {
    ...
    angular
        .module('app.pages')
        .controller('wardandbedlistController', wardandbedlistController);

    function wardandbedlistController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.getListCallback = function (scope, data, options, hasError) {
            ...
            if ($scope.currentfilter.BedStatusId > 0) {
                $scope.BedStatusName = data.Data[0].BedStatus.Description;
            }
            else {
                $scope.BedStatusName = '';
            }
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            hiddenElement.download = 'wardandbedlist-report.csv';
            hiddenElement.click();
        ...
        $scope.excelDownload = function () {
         var inputData = {
                Params: [
                    ...
                    {
                        Key: 5,
                        Value: $scope.currentfilter.BedStatusId
                    },
                    {
                        Key: 3,
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'GeneralMaster/WardRoomBedMaster/PrintWardRoomBedMasters',
                data: inputData,
                type: 'post'
            };
    ...
    wardandbedlistController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
