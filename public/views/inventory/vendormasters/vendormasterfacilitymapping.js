(function () {
    ...
    angular
        .module('app.pages')
        .controller('vendormasterFacilityMapController', vendormasterFacilityMapController);

    function vendormasterFacilityMapController($scope, $stateParams, $state, $translate) {
    ...
    vendormasterFacilityMapController.$inject = ['$scope', '$stateParams', '$state', '$translate'];
