(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorFormController', DoctorFormController);

    function DoctorFormController($scope, $stateParams, $state, $translate, utl, Upload) {
        ...
        $scope.amount = function () {
            if ($scope.item.PrivateDueLimit > 10000) {
                utl.Alert.showErrorMsg($translate.instant('Amount Should Not Exceed 10000'));
                return false;
            }
        };
        ...
        $scope.getvirtualsubcategory = function () {
            var inputData = [{
                ...
                Request: {
                    Params: [{
                            Key: 1,
                            Value: $scope.item.VirtualCategoryId
                        },
                        {
                            Key: 4,
                            Value: 2
    ...
    DoctorFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
