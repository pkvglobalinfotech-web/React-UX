(function () {
    ...
    angular
        .module('app.pages')
        .controller('totalcallFormController', totalcallFormController);

    function totalcallFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    totalcallFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
