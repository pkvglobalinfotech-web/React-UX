(function () {
    ...
    angular
        .module('app.pages')
        .controller('totalcallListController', totalcallListController);

    function totalcallListController($rootScope,$scope, $stateParams, $state, $translate, utl,$timeout) {
        ...
        $scope.openModal = function (Id) {
            utl.Modal.openFixedDialog('app.totalcall-form', {
                params: { id: Id },
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('app.totalcall-form', {
                params: { id: Id },
                confirmCallback: $scope.initLookup
            });
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                {
                    field: "FirstName",
                    displayName: $translate.instant('dashboard.agent.lbl'),
                ...
                },
                {
                    ...
                    displayName: $translate.instant('dashboard.extno.lbl')
                },
                {
                    field: "UserType.Description",
                    displayName: $translate.instant('dashboard.date&time.lbl')
                },
                {
                    field: "Group.GroupName",
                    displayName: $translate.instant('dashboard.completed.lbl')
                },
                // {
                ...
                {
                    field: "UserName",
                    displayName: $translate.instant('dashboard.callduration.lbl')
                },
                {
                    field: "UserDept.DepartmentName",
                    displayName: $translate.instant('dashboard.calltype.lbl')
                },
                {
                    field: "ActiveStatus.Description",
                    displayName: $translate.instant('dashboard.cmt.lbl')
                },
                {
                    field: "Id",
    ...
    totalcallListController.$inject = ['$rootScope','$scope', '$stateParams', '$state', '$translate', 'utl','$timeout'];
