...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('disprogressSectionController', disprogressSectionController);

    function disprogressSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.progressnote';
    ...
    disprogressSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
