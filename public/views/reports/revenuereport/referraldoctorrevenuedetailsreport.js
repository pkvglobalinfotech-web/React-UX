(function () {
    ...
    angular
        .module('app.pages')
        .controller('referraldoctorrevenuedetailsreportController', referraldoctorrevenuedetailsreportController);

    function referraldoctorrevenuedetailsreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/patientbills/PrintReferralDoctorRevenueDetailsReport',
                data: inputData,
                type: 'post'
            };
    ...
    referraldoctorrevenuedetailsreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
