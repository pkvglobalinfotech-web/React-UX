(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterCustomerMapFormController', itemmasterCustomerMapFormController);

    function itemmasterCustomerMapFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    itemmasterCustomerMapFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
