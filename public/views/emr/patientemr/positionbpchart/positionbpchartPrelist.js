(function () {
    ...
    angular
        .module('app.pages')
        .controller('PositionBpChartPreListController', PositionBpChartPreListController);

    function PositionBpChartPreListController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, ) {
        var vm = this;
    ...
    PositionBpChartPreListController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig',];
