(function () {
    ...
    angular
        .module('app.pages')
        .controller('ConsignmentStockController', ConsignmentStockController);

    function ConsignmentStockController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    ConsignmentStockController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
