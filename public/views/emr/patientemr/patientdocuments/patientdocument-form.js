(function () {
    ...
    angular
        .module('app.pages')
        .controller('patientDocumentFormController', patientDocumentFormController);

    function patientDocumentFormController($scope, $stateParams, $state, $translate, Upload, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    patientDocumentFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'Upload', 'utl', '$uibModalInstance', 'modalConfig'];
