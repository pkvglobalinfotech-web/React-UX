(function() {
    ...
    function StocktransferViewController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    StocktransferViewController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
