(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterUOMConversionController', newitemmasterUOMConversionController);

    function newitemmasterUOMConversionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        $scope.Items = [];
        $scope.item = {};
        $scope.currentfilter = {};
    ...
    newitemmasterUOMConversionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
