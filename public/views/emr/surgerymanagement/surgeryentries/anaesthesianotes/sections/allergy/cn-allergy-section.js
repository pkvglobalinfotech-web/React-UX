(function () {
    ...
    angular
        .module('app.pages')
        .controller('otcnAllergySectionController', otcnAllergySectionController);

    function otcnAllergySectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    otcnAllergySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
