(function () {
    ...
    angular
        .module('app.pages')
        .controller('inboundIgnoreListController', inboundIgnoreListController);

    function inboundIgnoreListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.currentfilter = { 
            ...
            EventStatusId: 2 // EventStatusId - Pending 
        };
    ...
    inboundIgnoreListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
