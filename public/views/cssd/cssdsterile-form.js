(function() {
    ...
    angular
        .module('app.pages')
        .controller('cssdsterileformController', cssdsterileformController);

    function cssdsterileformController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.initLookup = function() {
            var inputData = [
                { "Key": "PackingType" },
                { "Key": "HighTemperature", "Default": false },
                { "Key": "LowTemperature", "Default": false },
                { "Key": "Tray" },
                { "Key": "User" },
                { "Key": "TempType", "Default": false }
            ];
            var options = {
    ...
    cssdsterileformController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
