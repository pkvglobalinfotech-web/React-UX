(function () {
    ...
    angular
        .module('app.pages')
        .controller('stockstatusbatchgeneralreportController', stockstatusbatchgeneralreportController);

    function stockstatusbatchgeneralreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            const JsonFields = ["Item Code", "Item Name", "Quantity", "UCP", "Total UCP"]
            ...
            data.Data.forEach(function (rowArray) {
                ...
                csvContent += itemcode + ',' + itemname + ',' + qty + ',' + ucp + ',' + totalucp + "\n";
            });
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'pharmacy/stockserialitem/PrintGeneralStockStatusBatchReport',
                data: inputData,
                type: 'post',
            };
    ...
    stockstatusbatchgeneralreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
