(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemMasterFormBybranchController', itemMasterFormBybranchController);

    function itemMasterFormBybranchController($scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.itemmastersbybranch');
        };
    ...
    itemMasterFormBybranchController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
