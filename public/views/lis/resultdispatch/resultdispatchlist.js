(function () {
    ...
    angular
        .module('app.pages')
        .controller('resultdispatchlistController', resultdispatchlistController);

    function resultdispatchlistController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                {
                    field: "Order#", displayName: $translate.instant('lis.resultdispatch.ordernr.lbl'),
                    cellTemplate: '<div class="ui-grid-cell-contents" > {{row.entity.Ordernumber}} </div>'
                },
                {
                    field: "OrderReq", displayName: $translate.instant('lis.resultdispatch.orderreqdate.lbl'),
                ...
                {
                    field: "priority", displayName: $translate.instant('lis.resultdispatch.priority.lbl'),
                    cellTemplate: '<div class="ui-grid-cell-contents " > {{row.entity.PriorityStatus.DisplayName}} </div>'
                },
                {
                    field: "Orderstatus", displayName: $translate.instant('lis.resultdispatch.orderstatuse.lbl'),
    ...
    resultdispatchlistController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
