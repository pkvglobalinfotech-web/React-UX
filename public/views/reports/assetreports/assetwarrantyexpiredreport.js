(function () {
    ...
    angular
        .module('app.pages')
        .controller('assetwarrantyexpiredreportController', assetwarrantyexpiredreportController);

    function assetwarrantyexpiredreportController($rootScope, $scope, $stateParams, $state, $translate, $filter, utl, $timeout) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            data.Data.forEach(function (rowArray) {
                ...
                if (rowArray.NoOfPendingServices) {
                    pendingserve = rowArray.NoOfPendingServices;
                }
                ...
                csvContent += code + ',' + name + ',' + category + ',' + type + ',' + modeNo + ',' + warranty + ',' + fromDate + ',' + toDate + ',' + noService + ',' + pendingserve + ',' + costValue + ',' + refNo + "\n";
            });
            var encodedUri = encodeURI(csvContent);
            var hiddenElement = document.createElement('a');
            hiddenElement.href = 'data:text/csv;charset=utf-8,' + encodedUri;
            hiddenElement.target = '_blank';
            hiddenElement.download = 'assetwarrantyexpired-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'AssetManagement/Assetwarranty/PrintAssetwarrantyexpiredReport',
                data: inputData,
                type: 'post'
            };
    ...
    assetwarrantyexpiredreportController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', '$timeout'];
