(function () {
    ...
    angular
        .module('app.pages')
        .controller('appointmentsFromAppController', appointmentsFromAppController);

    function appointmentsFromAppController($rootScope, $scope, $stateParams, $state, $translate, utl, $timeout, $filter) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var From = $filter('date')($scope.currentfilter.appointmentdate, 'yyyy-MM-dd 00:00:00') || null;
            var To = $filter('date')($scope.currentfilter.appointmentdate, 'yyyy-MM-dd 23:59:59') || null;
        ...
        vm.gridConfig = {
            ...
            {
                field: "Patient.MRN",
                displayName: $translate.instant('Swostha Id')
            },
            {
                field: "Slot Time",
            ...
            },
            {
                ...
                cellTemplate: "<div class='ui-grid-cell-contents'>\
                                                    <div style='height:15px;width:20px;border-radius: 7px;margin-top: 4px;background:{{entity.AppointmentStatus.ColorCode}}' class='col-sm-2'></div>\
    ...
    appointmentsFromAppController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$timeout', '$filter'];
