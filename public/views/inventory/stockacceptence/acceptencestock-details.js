(function () {
    ...
    angular
        .module('app.pages')
        .controller('AcceptenceStockdetailsController', AcceptenceStockdetailsController);

    function AcceptenceStockdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.purchaserequest', { itemmasterid: 0 });
        }
    ...
    AcceptenceStockdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
