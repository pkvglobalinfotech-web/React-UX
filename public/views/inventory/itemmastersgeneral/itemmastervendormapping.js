(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalitemmasterVendorMapFormController', generalitemmasterVendorMapFormController);

    function generalitemmasterVendorMapFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.itemmastertabgeneral.itemmastervendormappingsgeneral');
        };
    ...
    generalitemmasterVendorMapFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
