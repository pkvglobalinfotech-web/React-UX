(function () {
    ...
    function PatientPaymentAdjustmentController($scope, $filter, $stateParams, $state, $translate, utl) {
        ...
        var rowtpl = '<div ng-class="{\'priority\':row.entity.IsAdvance==1 }"><div ng-repeat="(colRenderIndex, col) in colContainer.renderedColumns track by col.colDef.name" class="ui-grid-cell" ng-class="{ \'ui-grid-row-header-cell\': col.isRowHeader }" ui-grid-cell></div></div>';
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                ...
                cellTemplate: "<div class='ui-grid-cell-contents'><span class='pl-3'>{{row.entity.TransactionDate | date : 'dd-MMM-yyyy'}}&nbsp;</span>" + "<span class='pl-3'>{{row.entity.TransactionDate| date: 'HH:mm'}}</span>" + "</div>"
            },
            {
