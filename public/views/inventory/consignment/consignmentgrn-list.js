(function () {
    ...
    angular
        .module('app.pages')
        .controller('ConsignmentGRNsListController', ConsignmentGRNsListController);

    function ConsignmentGRNsListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.consignmentgrnform', {
                id: 0,
        ...
        vm.gridConfig = {
            ...
            {
                field: "GrnNumber",
                displayName: $translate.instant('Consignment DC')
            },
            {
    ...
    ConsignmentGRNsListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
