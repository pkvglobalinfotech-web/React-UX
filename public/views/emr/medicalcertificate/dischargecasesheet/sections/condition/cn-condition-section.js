(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnConditionSectionController', discasshtcnConditionSectionController);

    function discasshtcnConditionSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnConditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
