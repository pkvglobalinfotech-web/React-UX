(function () {
    ...
    angular
        .module('app.pages')
        .controller('procedurereorderController', procedurereorderController);

    function procedurereorderController($rootScope, $timeout, $scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.getList = function () {
            var inputData = {
                Params: [
                    ...
                    { Key: 3, Value: $scope.currentfilter.ProductTypeId },
            ...
            var options = {
                action: 'pharmacy/ReorderLevel/GetReorderLevels',
                data: inputData,
                type: 'post',
        ...
        $scope.getStoredProcedureListCallback = function (scope, res, options, hasError) {
            $scope.getList();
        };

        $scope.getStoredProcedureList = function () {
            var RolDate = $filter('date')(utl.Formatter.getCurrentDate(), 'yyyy-MM-dd 00:00:00');
            var Facility = $scope.item.FacilityId;
            var StoreMaster = $scope.currentfilter.StoreMasterId;
            var inputData = {
                From: RolDate,
                RolPeriod: 3,
                FacilityId: Facility,
            ...
            var options = {
                action: 'pharmacy/itemmaster/getExcuteStoredProcedure',
                data: {
                    Data: inputData
                },
                type: 'post',
        ...
        $scope.getListCallback = function (scope, res, options, hasError) {
            $scope.ItemReOrderDetails = [];
            $scope.ItemReOrderDetails = res.Data || [];
    ...
    procedurereorderController.$inject = ['$rootScope', '$timeout', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
