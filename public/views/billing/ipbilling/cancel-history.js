(function () {
    ...
    angular
        .module('app.pages')
        .controller('cancelHistoryFormController', cancelHistoryFormController);

    function cancelHistoryFormController($scope, $filter, $stateParams,
    ...
    cancelHistoryFormController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
