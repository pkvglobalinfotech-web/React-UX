(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemMastersListController', itemMastersListController);

    function itemMastersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.currentcontext.CanItemmasterEdit = $scope.HasAccess('itemmaster', 'ItemmasterEdit');
        ...
        $scope.getSubCategory = function () {
            ...
            var inputData = [{
                ...
                Request: {
                    Params: [{
                        Key: 5,
                        Value: $scope.currentfilter.CategoryId || -1
                    }, {
                        Key: 3,
                        Value: 2
                    }, {
        ...
        $scope.getProductType = function () {
            ...
            var inputData = [{
                ...
                Request: {
                    Params: [{
                        Key: 6,
                        Value: $scope.currentfilter.SubCategoryId || -1
                    }, {
                        Key: 3,
                        Value: 2
                    }, {
        ...
        $scope.getSubType = function () {
            $scope.currentfilter.SubTypeId = -1;
            var inputData = [{
                "Key": "ItemSubType",
                Request: {
                    Params: [{
        ...
        $scope.getProductSubType = function () {
            $scope.currentfilter.SubProductTypeId = -1;
            var inputData = [{
                "Key": "ProductSubType",
                Request: {
                    Params: [{
                        ...
                        Key: 5,
                        Value: $scope.currentfilter.ProductTypeId || -1
                    }]
                }
            }];
            // $scope.getList();
        ...
        $scope.getListCallback = function (scope, data, options, hasError) {
            ...
            // vm.gridConfig.data.showEdit = $scope.currentcontext.CanEdit ? 1 : 0;
            // vm.gridConfig.pagerObj.totalItems = res.PageContext.TotalRecords;
            vm.gridConfig.data = [];
            if (data.Data.length > 0) {
                for (var idx in data.Data) {
                    var item = data.Data[idx];
                    item.showEdit = $scope.currentcontext.CanItemmasterEdit ? 1 : 0;
                    console.log("Show", item.showEdit)
        ...
        $scope.getList = function (pageNo) {
            ...
            var inputData = {
                Params: [{
                    ...
                    {
                        Key: 2,
                        Value: $scope.currentfilter.ItemName
                    },
                    {
                        Key: 3,
                    ...
                    {
                        Key: 30,
                        Value: $scope.currentfilter.SubTypeId
                    },
                    {
                        Key: 6,
                        Value: $scope.currentfilter.SubCategoryId
                    },
                    {
                        Key: 28,
                        Value: false
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                    field: "ItemCode",
                    displayName: $translate.instant('inventory.itemmasters.code.lbl')
                },
                {
                    field: "ItemName",
                    displayName: $translate.instant('inventory.itemmasters.name.lbl'),
                ...
                },
                {
                    ...
                    displayName: $translate.instant('Main Category')
                },
                {
                    field: "ItemSubType.SubTypeName",
                    displayName: $translate.instant('Sub Category')
                },
                {
                    field: "ProductType.ProductTypeName",
                    displayName: $translate.instant('Product Type')
                },
                {
                    field: "GenericMaster.GenericName",
                    displayName: $translate.instant('inventory.itemmasters.genericid.lbl')
                },
                // {
                //     field: "ProductType.ProductTypeName",
                //     displayName: $translate.instant('inventory.itemmasters.producttypeid.lbl')
                // },
                {
                    field: "IsActive",
                    displayName: $translate.instant('inventory.itemmasters.isactive.lbl')
                },
                {
                    field: "PurConQty",
                    displayName: $translate.instant('Pack Qty')
                },
                {
                    field: "ItemPrice",
                    displayName: $translate.instant('Item Price')
                },
                {
                    field: "MrPrice",
                    displayName: $translate.instant('MRP')
                },
                // {
                //     field: "IsExpiryMandatory",
                //     displayName: $translate.instant('inventory.itemmasters.isexpirymandatory.lbl')
                // },
                // {
                //     field: "IsBillable",
                //     displayName: $translate.instant('inventory.itemmasters.isbillable.lbl')
                // },
                // {
                //     field: "ActiveStatus.Description",
                //     displayName: $translate.instant('inventory.itemmasters.status.lbl')
                // },
                {
                    field: "Id",
                    displayName: $translate.instant('common.actions_col.lbl'),
                    cellTemplate: '<div class="ui-grid-cell-contents">\
                                    <span class="grid-action" ng-click="handleEvents(\'edit\',entity)" ng-show="entity.showEdit==1&&entity.ActiveStatusId==2||entity.ActiveStatusId==3||entity.ActiveStatusId==4||entity.ActiveStatusId==5"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
        ...
        function initDynamicForm() {
            ...
            $scope.advancedFilterSchema = {
                ...
                controls: [{
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.isbatchmandatory.lbl',
                        model: 'IsBatchMandatory',
                        position: {
                            r: 1,
                            c: 0
                        }
                    ...
                    {
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.isbillable.lbl',
                        model: 'IsBillable',
                        position: {
                            r: 1,
                            c: 1
                    ...
                    {
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.isexpirymandatory.lbl',
                        model: 'IsExpiryMandatory',
                        position: {
                            r: 2,
                            c: 0
                        }
                    ...
                    {
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.ismanufacture.lbl',
                        model: 'IsManufacture',
                        position: {
                            r: 2,
                            c: 1
                    ...
                    {
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.ismrprequired.lbl',
                        model: 'IsMRPRequired',
                        position: {
                            r: 3,
                            c: 0
                    ...
                    {
                        type: 'checkbox',
                        translate: 'inventory.itemmaster.isreusable.lbl',
                        model: 'IsReusable',
                        position: {
                            r: 3,
                            c: 1
    ...
    itemMastersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
