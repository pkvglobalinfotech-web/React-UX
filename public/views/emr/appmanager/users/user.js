(function () {
    ...
    function userFormController($scope, $stateParams, $state, $translate, utl, Upload) {
        ...
        $scope.getItemCallback = function (scope, data, options, hasError) {
            ...
            if ($scope.currentcontext.id > 0) {
                $scope.item.DistrictId = $scope.item.DistrictId;
                $scope.item.CityId = $scope.item.CityId;
                $scope.item.StateId = $scope.item.StateId;
                $scope.item.CountryId = $scope.item.CountryId;
            }
    ...
    userFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
