...
function socialHistorySectionController($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
...
socialHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
