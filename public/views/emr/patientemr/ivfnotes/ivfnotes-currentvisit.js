(function () {
    ...
    angular
        .module('app.pages')
        .controller('IVFNotescurrentListController', IVFNotescurrentListController);

    function IVFNotescurrentListController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.gridData = [];
        $scope.Items = [];
        $scope.currentfilter = {
    ...
    IVFNotescurrentListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
