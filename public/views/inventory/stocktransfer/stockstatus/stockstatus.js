(function () {
    ...
    function stockStatusController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        vm.gridConfig = {
            ...
            //{
            //   field: "BarCodeId",
            //   displayName: $translate.instant('inventory.stockstatus.barcode.lbl')
            //},
            {
                field: "BatchId",
    ...
    stockStatusController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
