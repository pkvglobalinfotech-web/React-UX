...
export interface PatientBillDetailsAttributes extends IAttributes {
    Id: number;
    ...
    IsSchemeDiscount: boolean;
    IsPharmacyAdjusted: boolean;
    SchemeDiscountAmt: number;
    SchemeDiscountRate: number;
    CancelReqRaisedStatusId: number;
    DetCancelReqRaisedStatusId: number;
}

export interface PatientBillDetailsInstance extends Instance<PatientBillDetailsAttributes> {
    // I'm exposing every DB column as an instance field to so that tsc won't complain.
    // CreatedAt: Date;
    // UpdatedAt: Date;
    dataValues: PatientBillDetailsAttributes;
}
