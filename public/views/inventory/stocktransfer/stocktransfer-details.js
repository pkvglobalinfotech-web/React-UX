(function() {
    ...
    angular
        .module('app.pages')
        .controller('stocktransferdetailsController', stocktransferdetailsController);

    function stocktransferdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    stocktransferdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
