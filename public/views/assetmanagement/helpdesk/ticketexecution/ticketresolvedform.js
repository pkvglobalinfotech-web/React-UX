(function () {
    ...
    angular
        .module('app.pages')
        .controller('TicketResolvedFormController', TicketResolvedFormController);

    function TicketResolvedFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.saveItem = function () {
            ...
            for (var idx in $scope.item.Rating) {
                var ratingdata = $scope.item.Rating[idx];
                if (ratingdata == true) {
                    $scope.item.RatingId = parseInt(idx);
                }
            }
    ...
    TicketResolvedFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
