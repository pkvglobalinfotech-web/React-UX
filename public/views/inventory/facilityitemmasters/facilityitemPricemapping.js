(function () {
    ...
    angular
        .module('app.pages')
        .controller('facilityitemPriceController', facilityitemPriceController);

    function facilityitemPriceController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    facilityitemPriceController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
