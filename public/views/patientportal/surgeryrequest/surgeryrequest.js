(function() {
    ...
    angular
        .module('app.pages')
        .controller('surgeryrequestController', surgeryrequestController);

function surgeryrequestController($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
    $scope.items = [];
...
surgeryrequestController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
