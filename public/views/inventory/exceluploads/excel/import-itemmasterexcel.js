...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('importInvestigationExcelController', importInvestigationExcelController);
        
    function importInvestigationExcelController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter) {
        var vm = this;
        $scope.Items = [];
        $scope.Item = [];
    ...
    importInvestigationExcelController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$timeout', '$filter'];
