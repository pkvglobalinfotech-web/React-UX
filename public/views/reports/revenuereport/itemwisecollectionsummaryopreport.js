(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemwisecollectionSummaryOPReportController', itemwisecollectionSummaryOPReportController);

    function itemwisecollectionSummaryOPReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    itemwisecollectionSummaryOPReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
