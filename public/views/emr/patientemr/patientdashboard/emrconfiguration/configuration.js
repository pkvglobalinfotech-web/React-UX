(function () {
    ...
    angular
        .module('app.pages')
        .controller('emrconfigurationController', emrconfigurationController);

    function emrconfigurationController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    emrconfigurationController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
