(function() {
    ...
    angular
        .module('app.pages')
        .controller('facilityDeptMapController', facilityDeptMapController);

function facilityDeptMapController($scope, $stateParams, $state, $translate, utl) {
 ...
 $scope.save = function () {
    ...
    $scope.saveItem = function () {
        ...
        var actionName = 'SystemSettings/Facility/MapDepartments';
...
facilityDeptMapController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
