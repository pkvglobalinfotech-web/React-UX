(function () {
    ...
    angular
        .module('app.pages')
        .controller('InvoicesubmissionListController', InvoicesubmissionListController);

    function InvoicesubmissionListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.invoicesubmissionform', {
                id: 0,
            ...
            },
            {
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">\
                                                    <span class="grid-action" ng-click="handleEvents(\'view\',entity)" ng-show="entity.GrnStatusId==2||entity.GrnStatusId==3||entity.GrnStatusId==4||entity.GrnStatusId==5"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                     ...
                                                     <span class="grid-action" uib-tooltip="Submit" tooltip-placement="bottom" ng-hide="entity.SubmissionStatusId==2||entity.SubmissionStatusId==3" ng-click="handleEvents(\'submit\',entity)" ng-show="entity.GrnStatusId==3"><i class="fas fa-check-circle"></i></span>\
    ...
    InvoicesubmissionListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
