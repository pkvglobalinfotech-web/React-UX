(function () {
    ...
    angular
        .module('app.pages')
        .controller('AllergyHistoryFormController', AllergyHistoryFormController);
    function AllergyHistoryFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, uibButtonConfig) {
        var vm = this;
        ...
        $scope.emrfavouritesettings = function () {
            utl.Modal.open('app.favoritemaster', {
                params: { id: 0, favoritetypeid: 1, parent: "txn" },
        ...
        $scope.saveclick = function () {
            ...
            for (var idx in $scope.favconfig.selectedlist) {
                ...
                var item = {
                    PatientId: $scope.currentcontext.pid, AllergyId: favitem.ItemId, eid: $scope.currentcontext.eid,
            ...
            var options = {
                action: 'emr/patientallergy/ManagePatientSocialHistorys',
                data: { Data: list },
                type: 'post',
        ...
        $scope.caretClicked = function (detail) {
            ...
            $scope.item.AllergyId = detail.ItemId;
            // $scope.currentcontext.option = 'detail';
    ...
    AllergyHistoryFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
})();