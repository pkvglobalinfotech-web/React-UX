(function () {
    ...
    angular
        .module('app.pages')
        .controller('AdviceMedicationSectionController', AdviceMedicationSectionController);

    function AdviceMedicationSectionController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    AdviceMedicationSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
