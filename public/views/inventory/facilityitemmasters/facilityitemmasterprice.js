(function () {
    ...
    angular
        .module('app.pages')
        .controller('facilityitemmasterpriceController', facilityitemmasterpriceController);

    function facilityitemmasterpriceController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.addNew = function () {
            utl.Modal.open('app.itemmastertab.itemmastervendormapping', {
                params: { id: 0 },
        ...
        $scope.addNew = function () {
            $state.go('app.itemmastertab.itemmastervendormapping', { itemvendormapid: 0, ItemCode: $state.params.ItemCode, ItemName: $state.params.ItemName });
        };
        ...
        //            utl.Modal.open('app.itemmastertab.itemmastervendormapping', { id: row.entity.Id, IsProfile: row.entity.IsProfile, ItemCode: row.entity.ItemCode, ItemName: row.entity.ItemName });
        ...
        $scope.handleEvents = function (actionType, row) {
            if (actionType == 'edit') {
                $state.go('app.itemmastertab.itemmastervendormapping', { itemvendormapid: row.entity.Id });
            } else if (actionType == 'delete') {
        ...
        //     if (actionType == 'edit') {
        //         //$scope.openModal(row.entity.Id);
        //          utl.Modal.open('app.itemmastertab.itemPricemapping', { id: row.entity.Id });
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                //{ field: "Price", displayName: $translate.instant('inventory.itemrackmapping.purchaseprice.lbl') },
                {
                    field: "Price",
                ...
                //{ field: "UnitCostPrice", displayName: $translate.instant('inventory.itemrackmapping.ucp.lbl') },
                {
                    field: "UnitCostPrice",
                    displayName: $translate.instant('inventory.itemrackmapping.ucp.lbl'),
                    cellTemplate: "<div class='ui-grid-cell-contents'><span class='pl-3'>{{row.entity.UnitCostPrice | displaycurrency}}</span>" + "</div>"
                },

                {
                    field: "MrPrice",
                    displayName: $translate.instant('inventory.itemrackmapping.mrp.lbl'),
                    cellTemplate: "<div class='ui-grid-cell-contents'><span class='pl-3'>{{row.entity.MrPrice | displaycurrency}}</span>" + "</div>"
                },
    ...
    facilityitemmasterpriceController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
