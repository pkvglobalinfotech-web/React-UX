(function () {
    ...
    angular
        .module('app.pages')
        .controller('patientfeedbacksanalyzerFormController', patientfeedbacksanalyzerFormController);

    function patientfeedbacksanalyzerFormController($rootScope, $timeout, $scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, lodash) {
        var vm = this;
        $scope.item = {
    ...
    patientfeedbacksanalyzerFormController.$inject = ['$rootScope', '$timeout', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', 'lodash'];
