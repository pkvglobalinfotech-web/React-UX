(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalPOBasedGRNListController', generalPOBasedGRNListController);

    function generalPOBasedGRNListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
            ...
            },
            {
                ...
                cellTemplate: '<div class="ui-grid-cell-contents">\
                                                    <span class="grid-action" ng-click="handleEvents(\'view\',entity)" ng-show="entity.GrnStatusId==2||entity.GrnStatusId==3||entity.GrnStatusId==4||entity.GrnStatusId==5"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                     ...
                                                     <span class="grid-action" uib-tooltip="Amend" tooltip-placement="bottom" ng-click="handleEvents(\'amend\',entity)" ng-show="entity.GrnStatusId==2 || entity.GrnStatusId==3"><span class=\"amend"\><i class="fas fa-user-edit"></i></span></span>\
    ...
    generalPOBasedGRNListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
