(function () {
    ...
    angular
        .module('app.pages')
        .controller('portalcompleteorderController', portalcompleteorderController);

    function portalcompleteorderController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    portalcompleteorderController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
