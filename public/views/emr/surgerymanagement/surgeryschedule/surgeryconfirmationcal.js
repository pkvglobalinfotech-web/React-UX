(function () {
    ...
    angular
        .module('app.pages')
        .controller('SurgeryConfirmationCalFormController', SurgeryConfirmationCalFormController);

    function SurgeryConfirmationCalFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter) {
        var vm = this;
    ...
    SurgeryConfirmationCalFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$filter'];
