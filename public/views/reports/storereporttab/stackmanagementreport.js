(function () {
    ...
    angular
        .module('app.pages')
        .controller('stackmanagementreportController', stackmanagementreportController);

    function stackmanagementreportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.stockissuevocherreport = function () {
            $state.go('app.stockissuevocherreport', { context: 'storereports' })
        }
        $scope.stockindentreport = function () {
            $state.go('app.stockindentreport', { context: 'storereports' })
        }
        ...
        $scope.stockmovementreport = function () {
            $state.go('app.stockmovementreport', { context: 'storereports' })
        }
        $scope.purchasereturnreport = function () {
            $state.go('app.purchasereturnreport')
        }
        $scope.stockstatusreport = function () {
            $state.go('app.stockstatusreport', { context: 'storereports' })
        }
        $scope.stockstatusbatchreport = function () {
            $state.go('app.stockstatusbatchreport', { context: 'storereports' })
        }
        ...
        $scope.stockstatusproductsummaryreport = function () {
            $state.go('app.stockstatusproductsummaryreport', { context: 'storereports' })
        }
        ...
        $scope.stockconsumptionreport = function () {
            $state.go('app.stockconsumptionreport')
        }
        $scope.stocktransistreport = function () {
            $state.go('app.stocktransistreport')
        }
        $scope.backtoReport = function () {
            $state.go('app.storereporttab.masterreport')
        };
    }
    stackmanagementreportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
