(function () {
    ...
    angular
        .module('app.pages')
        .controller('opticalDashboardController', opticalDashboardController);

    function opticalDashboardController($rootScope, $scope, $timeout, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        //     $state.go('app.labresultreviews', { context: 'doctor' });
        // }
    ...
    opticalDashboardController.$inject = ['$rootScope', '$scope', '$timeout', '$filter', '$stateParams', '$state', '$translate', 'utl'];
