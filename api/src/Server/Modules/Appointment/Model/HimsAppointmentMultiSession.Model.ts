...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.AppointmentMultiSessionInstance, i.AppointmentMultiSessionAttributes> {
    let AppointmentMultiSession = sequelize.define<i.AppointmentMultiSessionInstance, i.AppointmentMultiSessionAttributes>
        ('AppointmentMultiSession', {
        ...
        },
            {
                indexes: [],
                timestamps: true,
                tableName: 'appointmentmultisessions',
                createdAt: 'CreatedAt',
                updatedAt: 'UpdatedAt',
    ...
    (AppointmentMultiSession as any).associate = function (models: Models) {
        AppointmentMultiSession.belongsTo(models.Facility);
        AppointmentMultiSession.belongsTo(models.ReferenceValue,
            { as: 'AppointmentSessionType', targetKey: 'ReferenceValueCodeId' });
        AppointmentMultiSession.belongsTo(models.ReferenceValue,
            { as: 'ActiveStatus', targetKey: 'ReferenceValueCodeId' });
        AppointmentMultiSession.belongsTo(models.ReferenceValue,
            { as: 'SessionType', targetKey: 'ReferenceValueCodeId' });
        AppointmentMultiSession.belongsTo(models.User, { foreignKey: 'DoctorId' });
        AppointmentMultiSession.belongsTo(models.ResourceMaster, { foreignKey: 'ResourceId' });
        AppointmentMultiSession.belongsTo(models.Speciality, { foreignKey: 'SpecialityId' });
        AppointmentMultiSession.belongsTo(models.VirtualSubCategory, { foreignKey: 'OrderTypeId' });
    };
    return AppointmentMultiSession;
}
