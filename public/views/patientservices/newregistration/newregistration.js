(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientServicesNewRegController', PatientServicesNewRegController);

    function PatientServicesNewRegController($scope, $timeout, $stateParams, $state, $cookies, $translate, utl, Upload) {
        var vm = this;
        ...
        $scope.save = function () {
            $scope.item.PatientStatusId = 1;
            $scope.saveItem();
        };

        $scope.saveAndApprove = function () {
            $scope.item.PatientStatusId = 2;
    ...
    PatientServicesNewRegController.$inject = ['$scope', '$timeout', '$stateParams', '$state', '$cookies', '$translate', 'utl', 'Upload'];
