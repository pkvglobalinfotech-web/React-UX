(function () {
    ...
    angular
        .module('app.pages')
        .controller('storepharmacyadmindashboardController', storepharmacyadmindashboardController);

    function storepharmacyadmindashboardController($rootScope, $scope, $timeout, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    storepharmacyadmindashboardController.$inject = ['$rootScope', '$scope', '$timeout', '$filter', '$stateParams', '$state', '$translate', 'utl'];
})();