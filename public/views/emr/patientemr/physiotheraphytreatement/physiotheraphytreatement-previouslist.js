(function () {
    ...
    angular
        .module('app.pages')
        .controller('PhysiotheraphyprevioruslistController', PhysiotheraphyprevioruslistController);

    function PhysiotheraphyprevioruslistController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    PhysiotheraphyprevioruslistController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
