(function () {
    ...
    angular
        .module('app.pages')
        .controller('portalconfirmorderController', portalconfirmorderController);

    function portalconfirmorderController($scope, $stateParams, $state, $translate, utl, Upload) {
    ...
    portalconfirmorderController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
