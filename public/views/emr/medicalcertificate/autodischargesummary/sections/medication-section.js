...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('dismedicationSectionController', dismedicationSectionController);

    function dismedicationSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.medications';
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                ...
                { Key: 4, Value: $scope.currentfilter.PatientMedicationStatusId }
                ],
    ...
    dismedicationSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
