(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnDocumentSectionController', cnDocumentSectionController);

    function cnDocumentSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cnDocumentSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
