(function() {
    ...
    angular
        .module('app.pages')
        .controller('generalitemmasterVendorMapListController', generalitemmasterVendorMapListController);

    function generalitemmasterVendorMapListController($scope, $stateParams, $state, $translate, utl, $filter, modalConfig) {
        var vm = this;
        ...
        $scope.addNew = function() {
            utl.Modal.openFixedDialog('app.itemmastertabgeneral.itemmastervendormappinggeneral', {
    ...
    generalitemmasterVendorMapListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'modalConfig'];
