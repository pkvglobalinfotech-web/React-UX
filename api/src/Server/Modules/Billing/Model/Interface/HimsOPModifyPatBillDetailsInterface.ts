...
export interface OPModifyPatBillDetailsAttributes extends IAttributes {
    Id: number;
...
export interface OPModifyPatBillDetailsInstance extends Instance<OPModifyPatBillDetailsAttributes> {
    // I'm exposing every DB column as an instance field to so that tsc won't complain.
    // CreatedAt: Date;
    // UpdatedAt: Date;
    dataValues: OPModifyPatBillDetailsAttributes;
}
