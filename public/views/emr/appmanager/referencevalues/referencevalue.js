(function () {
    ...
    angular
        .module('app.pages')
        .controller('referencevalueFormController', referencevalueFormController);

    function referencevalueFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.saveItem = function () {
            ...
            var actionName = 'SystemSettings/referencevalue/AddReferenceValue';
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                actionName = 'SystemSettings/referencevalue/UpdateReferenceValue';
            }
    ...
    referencevalueFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
