(function () {
    ...
    angular
        .module('app.pages')
        .controller('SurgicalNoteController', SurgicalNoteController);

    function SurgicalNoteController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        ...
        $scope.getList = function () {
            var inputData = {
                Params: [{
                        Key: 1,
                        Value: $scope.currentcontext.otregisterid
                    },
                    {
                        Key: 2,
                        Value: 1
    ...
    SurgicalNoteController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
