(function() {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterCustomerMapListController', itemmasterCustomerMapListController);

    function itemmasterCustomerMapListController($scope, $stateParams, $state, $translate, utl, $filter, modalConfig) {
        var vm = this;
    ...
    itemmasterCustomerMapListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'modalConfig'];
