(function() {
    ...
    angular
        .module('app.pages')
        .controller('familySocialHistoryListController', familySocialHistoryListController);

function familySocialHistoryListController($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
    ...
    $scope.saveFavorites = function() {
        ...
        for(var idx in $scope.favconfig.selectedlist) {
            ...
            var item = { PatientId : $scope.currentcontext.pid, SocialTypeId : favitem.ItemId,
...
familySocialHistoryListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
