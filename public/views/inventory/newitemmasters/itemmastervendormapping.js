(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterVendorMapFormController', newitemmasterVendorMapFormController);

    function newitemmasterVendorMapFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    newitemmasterVendorMapFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
