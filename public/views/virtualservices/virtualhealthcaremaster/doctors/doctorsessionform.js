(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorSessionFormController', DoctorSessionFormController);

    function DoctorSessionFormController($scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, $uibModalInstance, modalConfig, $timeout) {
        var vm = this;
        ...
        $scope.item.AppointmentSessionTypeId = 1;
        $scope.item.ClinicId = 1;
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.currentfilter.DoctorId = modalConfig.params.selecteddocid;
            $scope.item.DoctorId = $scope.currentfilter.DoctorId;
            if (!$scope.currentcontext.id)
                $scope.currentcontext.newform = 1;
    ...
    DoctorSessionFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', '$uibModalInstance', 'modalConfig', '$timeout'];
