(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterpriceController', itemmasterpriceController);

    function itemmasterpriceController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    itemmasterpriceController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
