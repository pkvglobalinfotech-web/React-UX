(function () {
    ...
    angular
        .module('app.pages')
        .controller('StockAcceptenceListController', StockAcceptenceListController);

    function StockAcceptenceListController($rootScope,$scope, $filter, $stateParams, $state, $translate, utl,$timeout) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'edit') {
                $state.go('app.stockacceptenceform', { id: entity.Id });
    ...
    StockAcceptenceListController.$inject = ['$rootScope','$scope', '$filter', '$stateParams', '$state', '$translate', 'utl','$timeout'];
