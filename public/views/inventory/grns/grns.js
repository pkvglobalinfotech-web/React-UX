(function () {
    ...
    angular
        .module('app.pages')
        .controller('GRNsListController', GRNsListController);

    function GRNsListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    GRNsListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
