(function() {
    ...
    angular
        .module('app.pages')
        .controller('PhysiotheraphyTabController', PhysiotheraphyTabController);

    function PhysiotheraphyTabController($scope, $stateParams, $state, $translate, utl) {
        var tabvm = this;
    ...
    PhysiotheraphyTabController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
})();