(function () {
    ...
    angular
        .module('app.pages')
        .controller('samplereviewdetaillist', samplereviewdetaillist);

    function samplereviewdetaillist($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        vm.gridConfig = {
            columnDefs: [

                {
                    ...
                    cellTemplate: '<center> <span ng-switch="{{row.entity.Orderstatuse}}"><span ng-switch-when="2"><input type="checkbox" ng-model="row.entity.IsTick"  style="zoom:1.5" ></span><span ng-switch-default><input type="checkbox" ng-model="row.entity.IsTick"  style="zoom:1.5" disabled  ></span></center>'
                },
                {
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents " > {{row.entity.Department.DepartmentName}} </div>'
                },
                /*{ field : "Id", displayName : $translate.instant('common.actions_col.lbl'),
                           cellTemplate : '<a class="lnk-action" ng-click="grid.appScope.handleEvents(\'approve\',row)">  <img src="app/ico/16-16/approve.png" alt="Image" class="block-center img-rounded" /></a> &nbsp;&nbsp;| '+
                           '<a class="lnk-action" ng-click="grid.appScope.handleEvents(\'history\',row)"> <img src="app/ico/16-16/info.png" alt="Image" class="block-center img-rounded" /></a> &nbsp;&nbsp;| '+
                           '<a class="lnk-action" ng-click="grid.appScope.handleEvents(\'cancel\',row)"> <img src="app/ico/16-16/delete.png" alt="Image" class="block-center img-rounded" /></a> '
    ...
    samplereviewdetaillist.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
