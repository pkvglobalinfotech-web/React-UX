(function () {
    ...
    angular
        .module('app.pages')
        .controller('InvoicereceiptataccountFormController', InvoicereceiptataccountFormController);

    function InvoicereceiptataccountFormController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.applyVisibilityRules = function () {
            ...
            if($scope.item.SubmissionStatusId==3){
                $scope.canShowReceiptBtn = false;
                $scope.canShowRejectBtn = false;
            }
            if($scope.item.SubmissionStatusId==5){
                $scope.canShowReceiptBtn = false;
                $scope.canShowRejectBtn = false;
            }
        };
        $scope.Receiveinvoice = function () {
            ...
            var confirmOptions = {
                ...
                messageKey: 'Do you want to Receipt invoice?',
                yesKey: 'common.yeskey.lbl',
                noKey: 'common.nokey.lbl',
                onSuccessMethod: $scope.onReceiveinvoiceConfirmed,
            };
            utl.Dialog.confirmMessage(confirmOptions);
        };

        $scope.onReceiveinvoiceConfirmed = function () {
        ...
        $scope.Rejectinvoice = function () {
            ...
            var confirmOptions = {
                ...
                yesKey: 'common.yeskey.lbl',
                noKey: 'common.nokey.lbl',
                onSuccessMethod: $scope.onRejectinvoiceConfirmed,
            };
            utl.Dialog.confirmMessage(confirmOptions);
        };

        $scope.onRejectinvoiceConfirmed = function () {
        ...
        $scope.backToList = function () {
            $state.go('app.invoicereceiptataccountlist', {
    ...
    InvoicereceiptataccountFormController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
