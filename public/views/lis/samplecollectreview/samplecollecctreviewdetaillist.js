(function () {
    ...
    function orderdetaillistController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    orderdetaillistController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
