(function () {
    ...
    function completeorderController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                ...
                // {
                //     Key: 17,
                //     Value: utl.Formatter.getFilterDate(FrRegDt)
                // },
                // {
                //     Key: 18,
                //     Value: utl.Formatter.getFilterDate(ToRegDt)
                // },
                // {
                //     Key: 17,
                //     Value: FrRegDt
    ...
    completeorderController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
