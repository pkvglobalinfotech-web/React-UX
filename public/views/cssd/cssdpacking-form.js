(function() {
    ...
    angular
        .module('app.pages')
        .controller('cssdpackingformController', cssdpackingformController);

    function cssdpackingformController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cssdpackingformController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
