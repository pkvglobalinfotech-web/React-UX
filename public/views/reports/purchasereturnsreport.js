(function () {
    ...
    angular
        .module('app.pages')
        .controller('PurchaseReturnsReportController', PurchaseReturnsReportController);

    function PurchaseReturnsReportController($scope, $stateParams, $filter, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'pharmacy/PurchaseReturn/PrintPurchaseReturnlist',
                data: inputData,
                type: 'post'
            };
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                ...
                {
                    field: "PrnNumber",
                    displayName: $translate.instant('inventory.purchasereturns.gon.lbl')
                },
                {
                    field: "PrnDate",
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents">\
                                    ...
                                    <span class="grid-action" ng-click="handleEvents(\'delete\',entity)" ng-show="entity.PrnStatusId==1"><img class="drhms-edit-button" src="assets/svg/delete.svg" alt=""></span>\
                                </div>',
    ...
    PurchaseReturnsReportController.$inject = ['$scope', '$stateParams', '$filter', '$state', '$translate', 'utl'];
