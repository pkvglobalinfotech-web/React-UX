(function() {
    ...
    angular
        .module('app.pages')
        .controller('DischargeSummaryTabController', DischargeSummaryTabController);

    function DischargeSummaryTabController($scope, $stateParams, $state, $translate, utl) {
        var tabvm = this;
    ...
    DischargeSummaryTabController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
})();