(function () {
    ...
    angular
        .module('app.pages')
        .controller('StockRequestViewController', StockRequestViewController);

    function StockRequestViewController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    StockRequestViewController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
