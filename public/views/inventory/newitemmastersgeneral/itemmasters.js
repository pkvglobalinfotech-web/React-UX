(function () {
    ...
    angular
        .module('app.pages')
        .controller('newgeneralitemMastersListController', newgeneralitemMastersListController);

    function newgeneralitemMastersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.newitemmastertabgeneral.itemmastergeneral', { id: 0 });
        };
    ...
    newgeneralitemMastersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
