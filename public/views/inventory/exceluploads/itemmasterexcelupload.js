(function () {
    ...
    angular
        .module('app.pages')
        .controller('ItemMasterExceluploadController', ItemMasterExceluploadController);

    function ItemMasterExceluploadController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        vm.gridConfig = {
            ...
            },
            {
                ...
                cellTemplate: "<div class='ui-grid-cell-contents'><span>{{entity.ItemCategory.CategoryName}}</span>" + "</div>"
            },            
            {
    ...
    ItemMasterExceluploadController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
