(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoccurrentpatientmultiController', DoccurrentpatientmultiController);

    function DoccurrentpatientmultiController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    DoccurrentpatientmultiController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
