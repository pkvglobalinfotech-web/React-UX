(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorprescriptionFormController', DoctorprescriptionFormController);

    function DoctorprescriptionFormController($scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, lodash) {
        var vm = this;
        ...
        $scope.item.IsDischargeMedication = false;
        $scope.currentcontext.isPatientHasAllergy = false;
        $scope.item.DoctorId = $stateParams.doctid;
        $scope.item.DepartmentId = $stateParams.deptid;
    ...
    DoctorprescriptionFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', 'lodash'];
