(function () {
    ...
    angular
        .module('app.pages')
        .controller('clinicaldischargeListController', clinicaldischargeListController);

    function clinicaldischargeListController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.currentfilter = {
            ...
            FindLockedBills: 0,
            IsEstimatedBill: 0,
            admissiondateFromAdm: utl.Formatter.getCurrentDate(),
            admissiondateToAdm: utl.Formatter.getCurrentDate()
        };
        ...
        $scope.getList = function (val) {
            ...
            var FromAdm = $filter('date')($scope.currentfilter.admissiondateFromAdm, 'yyyy-MM-dd 00:00:00') || null;
            var ToAdm = $filter('date')($scope.currentfilter.admissiondateToAdm, 'yyyy-MM-dd 23:59:59') || null;
    ...
    clinicaldischargeListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
