(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientreturndetailsController', patientreturndetailsController);

    function patientreturndetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    patientreturndetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
