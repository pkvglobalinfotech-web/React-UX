(function () {
    ...
    angular
        .module('app.pages')
        .controller('IPReferralDoctorReportController', IPReferralDoctorReportController);

    function IPReferralDoctorReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            const JsonFields = ["DOA", "IP Number", "Patient Name", "MRN", "Room Details", "Doctor Name", "Payer Name", "Department", "Referral", "Type", "Admission Status"]
            ...
            data.Data.forEach(function (rowArray) {
                ...
                csvContent += doa + ',' + ipNum + ',' + patname + ',' + mrn + ',' + room + ',' + docName + ',' + insurance + ',' + dept + ',' + ref + ',' + type + ',' + admission + "\n";
            });
            var encodedUri = encodeURI(csvContent);
            var hiddenElement = document.createElement('a');
            hiddenElement.href = 'data:text/csv;charset=utf-8,' + encodedUri;
            hiddenElement.target = '_blank';
            hiddenElement.download = 'ipreferraldoctor-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintIPPatientReferralReport',
                data: inputData,
                type: 'post'
            };
    ...
    IPReferralDoctorReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
