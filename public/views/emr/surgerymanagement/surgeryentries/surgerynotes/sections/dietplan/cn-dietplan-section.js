(function () {
    ...
    angular
        .module('app.pages')
        .controller('otcnDietPlanSectionController', otcnDietPlanSectionController);

    function otcnDietPlanSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.item.pid = $scope.$parent.currentcontext.pid;
    ...
    otcnDietPlanSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
