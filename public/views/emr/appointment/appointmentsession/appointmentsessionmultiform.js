(function () {
    ...
    angular
        .module('app.pages')
        .controller('apptmultiSessionFormController', apptmultiSessionFormController);

    function apptmultiSessionFormController($scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, $uibModalInstance, modalConfig, $timeout) {
        var vm = this;
    ...
    apptmultiSessionFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', '$uibModalInstance', 'modalConfig', '$timeout'];
