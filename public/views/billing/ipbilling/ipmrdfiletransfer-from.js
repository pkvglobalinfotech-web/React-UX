(function () {
    ...
    angular
        .module('app.pages')
        .controller('MRDFileTransferFormController', MRDFileTransferFormController);

    function MRDFileTransferFormController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.ipmrdfiletransfer');
        };
        ...
        $scope.saveAndApprove = function () {
            var confirmOptions = {
                ...
                messageKey: 'Do you want to transfer the file?',
        ...
        $scope.onSaveandApproveConfirmed = function () {
            $scope.item.MRDIPFileStatusId = 4;
            $scope.item.TransferredBy = utl.Session.getCurrentUserId();
            $scope.item.TransferredDate = utl.Formatter.getCurrentDate();
            $scope.saveItem();
        };
    ...
    MRDFileTransferFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
