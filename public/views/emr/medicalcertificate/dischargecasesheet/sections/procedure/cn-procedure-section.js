(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnProcedureSectionController', discasshtcnProcedureSectionController);

    function discasshtcnProcedureSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnProcedureSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
