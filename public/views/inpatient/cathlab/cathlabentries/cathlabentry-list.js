(function() {
    ...
    angular
        .module('app.pages')
        .controller('cathlabentrylistController', cathlabentrylistController);

    function cathlabentrylistController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig, $timeout) {
        var vm = this;
        $scope.context = 'main';
        ...
        var action = {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">\
                          ...
                          <span class="grid-action" ng-click="handleEvents(\'summary\',entity)"ng-show="entity.SurgeryEntryStatusId == 2 || entity.SurgeryEntryStatusId == 3"><img src="app/img/prescription.png"></span>\
                          <span class="grid-action" ng-click="handleEvents(\'delete\',entity)" ng-show="entity.SurgeryEntryStatusId==1"><img class="drhms-edit-button" src="assets/svg/delete.svg" alt=""></span>\
                      </div>',
    ...
    cathlabentrylistController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig', '$timeout'];
