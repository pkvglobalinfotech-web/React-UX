(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorInvoicePaymentFormController', DoctorInvoicePaymentFormController);

    function DoctorInvoicePaymentFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.getItemCallBack = function (scope, res, options, hasError) {
            ...
            if (res.Data.length > 0) {
                ...
                $scope.currentcontext.id = DrPaymentData.Id;
                ...
                $scope.item.PaymentType = data.DoctorPayment.PaymentType.Description;
    ...
    DoctorInvoicePaymentFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
