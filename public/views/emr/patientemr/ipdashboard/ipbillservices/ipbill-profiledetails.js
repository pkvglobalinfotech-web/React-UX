(function () {
    ...
    angular
        .module('app.pages')
        .controller('ipbillProfiledetailsController', ipbillProfiledetailsController);

    function ipbillProfiledetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter, $timeout) {
        var vm = this;
        ...
        $scope.saveItem = function () {
            ...
            $scope.item.allowDuplicate = true;
    ...
    ipbillProfiledetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$filter', '$timeout'];
