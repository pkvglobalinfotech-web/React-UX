(function () {
    ...
    angular
        .module('app.pages')
        .controller('AntibioticListController', AntibioticListController);

    function AntibioticListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.getList = function () {
            var inputData = {
                Params: [
                    ...
                    { Key: 3, Value: $scope.currentfilter.AnbioticTypeId },
            ...
            var options = {
                action: 'lis/AntibioticMaster/GetAntibioticMasters',
                data: inputData,
                type: 'post',
        ...
        $scope.openModal = function (Id) {
            utl.Modal.open('app.antibiotic-form', {
        ...
        $scope.addNew = function () {
            // $state.go('app.antibiotictab.antibioticform', { id: 0 });
            $scope.openModal(0);
        }
        ...
        $scope.onDeleteConfirmed = function (deleteId) {
            var options = {
                action: 'lis/AntibioticMaster/DeleteAntibioticMaster',
                data: { Id: deleteId },
                type: 'post',
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'edit') {
                // $state.go('app.antibiotictab.antibioticform', { id: entity.Id });
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                { field: "AntibioticName", displayName: $translate.instant('lis.analyzer.name.lbl') },
                { field: "OrgIsolation.OrgIsolationName", displayName: $translate.instant('lis.antiobiotics.organism.lbl') },
    ...
    AntibioticListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
