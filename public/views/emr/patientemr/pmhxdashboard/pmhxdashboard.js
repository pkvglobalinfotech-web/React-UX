(function() {
    ...
    angular
        .module('app.pages')
        .controller('pmhxDashboardController', pmhxDashboardController);

    function pmhxDashboardController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    pmhxDashboardController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
