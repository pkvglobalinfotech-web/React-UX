(function () {
    ...
    angular
        .module('app.pages')
        .controller('NewAssetApprovedListController', NewAssetApprovedListController);

    function NewAssetApprovedListController($rootScope,$timeout,$scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.openModal = function (Id) {
            utl.Modal.openFixedDialog('app.newassetapprovedform', {
                params: {
                    id: Id
                },
    ...
    NewAssetApprovedListController.$inject = ['$rootScope','$timeout','$scope', '$stateParams', '$state', '$translate', 'utl'];
