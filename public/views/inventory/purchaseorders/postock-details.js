(function () {
    ...
    angular
        .module('app.pages')
        .controller('postockdetailsController', postockdetailsController);

    function postockdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        vm.gridConfig = {
            columnDefs: [{
                    ...
                    displayName: $translate.instant('inventory.stockdetails.store.lbl')
                },
                {
                    field: "BarCodeId",
                    displayName: $translate.instant('inventory.stockdetails.barcode.lbl')
                },
                {
                    field: "BatchId",
                    displayName: $translate.instant('inventory.stockdetails.batch.lbl')
                },
                {
                    field: "ExpiryDate",
                ...
                {
                    field: "Quantity",
                    displayName: $translate.instant('inventory.stockdetails.quantity.lbl')
                }
            ],
            pagerObj: {
                totalItems: 0,
    ...
    postockdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
