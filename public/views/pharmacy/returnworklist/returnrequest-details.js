(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientstockdetailsController', patientstockdetailsController);

    function patientstockdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    patientstockdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
