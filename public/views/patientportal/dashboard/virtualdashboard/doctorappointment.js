...
function doctorappointmentController($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
    ...
    $scope.slotclick = function () {
       $state.go('patientportal.portalconfirmorder');
    }
...
doctorappointmentController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
