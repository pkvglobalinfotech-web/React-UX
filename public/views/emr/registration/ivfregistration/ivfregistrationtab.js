(function () {
    ...
    angular
        .module('app.pages')
        .controller('ivfRegistrationTabController', ivfRegistrationTabController);

    function ivfRegistrationTabController($rootScope, $scope, $stateParams, $state, $translate, utl, $timeout) {
        ...
        $scope.tabs = [{
                title: $translate.instant('registration.fullregistrationtab.tabbasic.lbl'),
                state: 'app.ivfregistrationtab.basic',
                canDisable: false
            },
            // { title: $translate.instant('registration.fullregistrationtab.tabpatientid.lbl'), state: 'app.ivfregistrationtab.patientids', canDisable: canDisableTab },
            // { title: $translate.instant('registration.fullregistrationtab.tabpatientkin.lbl'), state: 'app.ivfregistrationtab.patientkins', canDisable: canDisableTab },
            // { title: $translate.instant('registration.fullregistrationtab.tabguarantor.lbl'), state: 'app.ivfregistrationtab.patientguarantor', canDisable: canDisableTab },
            // { title: $translate.instant('registration.fullregistrationtab.auditlog.lbl'), state: 'app.ivfregistrationtab.auditlog', canDisable: canDisableTab },
            {
                title: $translate.instant('Spouse'),
                state: 'app.ivfregistrationtab.spousereg',
        ...
        $scope.addNewFull = function () {
            $state.go('app.ivfregistrationtab.basic', {
                id: 0
            });
        }
    ...
    ivfRegistrationTabController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
})();