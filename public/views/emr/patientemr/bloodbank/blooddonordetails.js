(function () {
    ...
    angular
        .module('app.pages')
        .controller('BloodDonorDetailsController', BloodDonorDetailsController);

    function BloodDonorDetailsController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    BloodDonorDetailsController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
