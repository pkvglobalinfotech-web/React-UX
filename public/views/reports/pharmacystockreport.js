(function () {
    ...
    angular
        .module('app.pages')
        .controller('PharmacyStockReportController', PharmacyStockReportController);

    function PharmacyStockReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    PharmacyStockReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
