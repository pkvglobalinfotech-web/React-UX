(function () {
    ...
    angular
        .module('app.pages')
        .controller('outboundIgnoreListController', outboundIgnoreListController);

    function outboundIgnoreListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.currentfilter = { 
            ...
            EventStatusId: 4 // EventStatusId - Pending 
        };
    ...
    outboundIgnoreListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
