(function () {
    ...
    angular
        .module('app.pages')
        .controller('daycarereportController', daycarereportController);

    function daycarereportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintDayCareReport',
                data: inputData,
                type: 'post'
            };
    ...
    daycarereportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
