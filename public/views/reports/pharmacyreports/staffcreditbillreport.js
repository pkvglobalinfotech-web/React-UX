(function () {
    ...
    angular
        .module('app.pages')
        .controller('StaffCreditBillReportController', StaffCreditBillReportController);

    function StaffCreditBillReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            hiddenElement.download = 'staffcreditbill-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/patientbills/PrintStaffCreditBillReport',
                data: inputData,
                type: 'post'
            };
    ...
    StaffCreditBillReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
