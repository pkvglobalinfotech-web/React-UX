(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalitemmasterStoreMapController', generalitemmasterStoreMapController);

    function generalitemmasterStoreMapController($scope, $stateParams, $state, $translate, utl) {
    ...
    generalitemmasterStoreMapController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
