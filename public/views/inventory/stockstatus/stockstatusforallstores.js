(function () {
    ...
    angular
        .module('app.pages')
        .controller('StockStatusForAllStoresController', StockStatusForAllStoresController);

    function StockStatusForAllStoresController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    StockStatusForAllStoresController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
