(function () {
    ...
    angular
        .module('app.pages')
        .controller('disimmunizationSectionController', disimmunizationSectionController);

    function disimmunizationSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.immunization';
        ...
        $scope.handleEvents = function (actionType, item) {
           ...
           //Grid Actions
           $scope.open_immunization = function () {
            $state.go('patientemr.patientimmunization');
        }
    ...
    disimmunizationSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
