(function () {
    ...
    angular
        .module('app.pages')
        .controller('OPMlcFormController', OPMlcFormController);

    function OPMlcFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.currentcontext.selectedPatient = modalConfig.params.selectedPatient;
        ...
        $scope.openattachments = function () {
            if ($scope.currentcontext.pid > 0) {
                utl.Modal.open('app.patientattachments', {
                    params: { pid: $scope.currentcontext.pid, itemid: $scope.currentcontext.encounterid, objecttypeid: 2 },
    ...
    OPMlcFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
})();