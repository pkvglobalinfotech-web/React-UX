(function () {
    ...
    angular
        .module('app.pages')
        .controller('vendorMastersByBranchListController', vendorMastersByBranchListController);

    function vendorMastersByBranchListController($rootScope, $scope, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.suppliermasterbybranchform', {
                id: 0
            });
        };
    ...
    vendorMastersByBranchListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
