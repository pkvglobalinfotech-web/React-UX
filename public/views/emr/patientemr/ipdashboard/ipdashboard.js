(function () {
    ...
    function ipDashboardController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        var sectionList = [
            ...
            { id: 'radiologyresult', text :'Radiology Result', tmpl: getSectionPath() + 'radiology-section.html' },
            { id: 'medications', text : 'Medications', tmpl: getSectionPath() + 'medication-section.html' },
            { id: 'prescription', text:'Rx-Prescriptions', tmpl: getSectionPath() + 'prescription-section.html' },
            ...
            { id: 'intakeoutput', text: 'Intake Output', tmpl: getIPSectionPath() + 'intakeoutput-section.html' },
            { id: 'progressnotes', text: 'Progress Notes', tmpl: getIPSectionPath() + 'progressnote-section.html' },
            { id: 'Otsurgerydetail', text: 'OT Surgery Details', tmpl: getIPSectionPath() + 'otsurgerydetail-section.html' }
        ];
        ...
        function getSectionPath() {
            return "app/views/emr/patientemr/patientdashboard/sections/";
        }

        function getIPSectionPath() {
            return "app/views/emr/patientemr/ipdashboard/sections/";
        }

        function refreshPref() {
            $scope.refreshUP($scope.prefKeys.IPDashboardSections, getUserPrefCallback);
        }
        function getUserPref() {
            $scope.getUP($scope.prefKeys.IPDashboardSections, getUserPrefCallback);
        }
        ...
        $scope.configuration = function () {
            utl.Modal.open('patientemr.emrconfiguration', {
                params: { cfg : { master : getMasterList(), prefkey : $scope.prefKeys.IPDashboardSections} },
    ...
    ipDashboardController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
