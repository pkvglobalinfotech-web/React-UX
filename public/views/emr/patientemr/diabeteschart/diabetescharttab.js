(function () {
    ...
    angular
        .module('app.pages')
        .controller('DiabetesChartTabController', DiabetesChartTabController);

    function DiabetesChartTabController($scope, $stateParams, $state, $translate, utl) {
        var tabvm = this;
    ...
    DiabetesChartTabController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
})();