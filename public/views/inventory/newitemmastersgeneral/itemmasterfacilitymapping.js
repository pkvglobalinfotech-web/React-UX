(function () {
    ...
    angular
        .module('app.pages')
        .controller('newgeneralitemmasterFacilityMapController', newgeneralitemmasterFacilityMapController);

    function newgeneralitemmasterFacilityMapController($scope, $stateParams, $state, $translate) {
    ...
    newgeneralitemmasterFacilityMapController.$inject = ['$scope', '$stateParams', '$state', '$translate'];
