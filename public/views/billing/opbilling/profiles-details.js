(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientprofiledetailsController', patientprofiledetailsController);

function patientprofiledetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
    var vm = this;
...
patientprofiledetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
