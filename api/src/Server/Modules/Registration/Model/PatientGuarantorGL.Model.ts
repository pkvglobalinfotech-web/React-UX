...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.PatientGuarantorGLInstance, i.PatientGuarantorGLAttributes> {
    let PatientGuarantorGL = sequelize.define<i.PatientGuarantorGLInstance, i.PatientGuarantorGLAttributes>('PatientGuarantorGL', {
        Id: { type: DataTypes.BIGINT, field: 'PatientGuarantorGLId', primaryKey: true, autoIncrement: true },
