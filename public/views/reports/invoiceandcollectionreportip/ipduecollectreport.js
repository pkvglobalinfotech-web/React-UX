(function () {
    ...
    angular
        .module('app.pages')
        .controller('ipduecollectreportController', ipduecollectreportController);

    function ipduecollectreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            $scope.PaymentOPDueCollections.forEach(function (rowArray) {
                var receiptdate = '';
                var receiptno = '';
                var billno = '';
                var patname = '';
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/PatientPaymentDetails/PrintIPDueCollectionReport',
                data: inputData,
                type: 'post'
            };
    ...
    ipduecollectreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
