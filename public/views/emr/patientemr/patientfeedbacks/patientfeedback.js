(function () {
    ...
    angular
        .module('app.pages')
        .controller('patientfeedbacksFormController', patientfeedbacksFormController);

    function patientfeedbacksFormController($rootScope, $timeout, $scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig, uibButtonConfig, lodash) {
        var vm = this;
        $scope.item = {
    ...
    patientfeedbacksFormController.$inject = ['$rootScope', '$timeout', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig', 'uibButtonConfig', 'lodash'];
