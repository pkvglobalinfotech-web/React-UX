...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('disfamilyConditionSectionController', disfamilyConditionSectionController);

    function disfamilyConditionSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.familycondition';
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                Params: [{ Key: 2, Value: $scope.currentcontext.pid }, { Key: 6, Value: $scope.currentcontext.eid },
    ...
    disfamilyConditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
