...
angular.module('ngFabForm')
    .directive('uiSelect', ['ngFabFormValidationsDirective', function (ngFabFormValidationsDirective)
    {
        'use strict';
    ...
    angular.module('ngFabForm')
    .directive('uibTimepicker', ['ngFabFormValidationsDirective', function (ngFabFormValidationsDirective)
    {
        'use strict';
...
angular.module('ngFabForm')
    .provider('ngFabForm', function ngFabFormProvider()
    {
        ...
        var config = {
            ...
            asteriskStr: '<span style="color:red">*</span>',
...
angular.module('ngFabForm')
    .factory('ngFabFormValidationsDirective', ['ngFabForm', '$compile', '$templateRequest', '$timeout', function (ngFabForm, $compile, $templateRequest, $timeout)
    {
        'use strict';
                ...
                if (labels && labels.length > 0 && attrs.type !== 'radio' && attrs.type !== 'checkbox') {
                    for (var i = 0; i < labels.length; i++) {
                        ...
                        if (label.textContent.slice(-cfg.asteriskStr.length) !== cfg.asteriskStr) {
                            label.innerHTML = label.textContent + cfg.asteriskStr;
                        }
                    }
                }
            }, 100);
                        ...
                        scope.$evalAsync(function ()
                        {
                            ...
                            if (formCtrl && ngModelCtrl) {
                                ...
                                if (ngFabForm.customValidators) {
                                    ngFabForm.customValidators(ngModelCtrl, attrs, el);
                                }
