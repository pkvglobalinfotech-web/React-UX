(function () {
    ...
    angular
        .module('app.pages')
        .controller('mlcListController', mlcListController);

    function mlcListController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    mlcListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
