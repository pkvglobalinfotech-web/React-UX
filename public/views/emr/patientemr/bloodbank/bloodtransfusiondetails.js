(function () {
    ...
    angular
        .module('app.pages')
        .controller('BloodTransfusionDetailsController', BloodTransfusionDetailsController);

    function BloodTransfusionDetailsController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        if ($scope.currentcontext.encounter) {
            ...
            $scope.item.PatientNo = $scope.currentcontext.encounter.PatientMrn;
        }
        $scope.lookup = {};
        $scope.lookup = {};
        ...
        $scope.initLookup = function () {
            var inputData = [
                ...
                { "Key": "BloodGroup" },
                { "Key": "User", Request: { Params: [{ Key: 3, Value: 6 }] } }
            ];
    ...
    BloodTransfusionDetailsController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
