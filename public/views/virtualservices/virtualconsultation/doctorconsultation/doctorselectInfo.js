(function () {
    ...
    angular
        .module('app.pages')
        .controller('doctorselectInfoController', doctorselectInfoController);

    function doctorselectInfoController($scope, $stateParams, $state, $translate, utl, Upload) {
    ...
    doctorselectInfoController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
