...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.PharmacyModifyPatPaymentDetailsInstance, i.PharmacyModifyPatPaymentDetailsAttributes> {
    let PharmacyModifyPatPaymentDetails =
        sequelize.define<i.PharmacyModifyPatPaymentDetailsInstance,
            i.PharmacyModifyPatPaymentDetailsAttributes>('PharmacyModifyPatPaymentDetails', {
            ...
            },
                {
                    ...
                    tableName: 'hims_pharmacymodifypatpaymentdetails',
                    createdAt: 'CreatedAt',
                    updatedAt: 'UpdatedAt',
    ...
    (PharmacyModifyPatPaymentDetails as any).associate = function (models: Models) {
        PharmacyModifyPatPaymentDetails.belongsTo(models.User, { foreignKey: 'DoctorId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.User, { as: 'CreatedUser', foreignKey: 'CreatedBy' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.Department, { foreignKey: 'DepartmentID' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.Patient);
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'ReceiptStatus', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'PaymentType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'CardType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'Bank', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'ReceiptType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.Encounter, { foreignKey: 'EncounterId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.ReferenceValue, { as: 'GuarantorType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.PharmacyModifyPatBills, { foreignKey: 'PatientBillId' });
        PharmacyModifyPatPaymentDetails.belongsTo(models.PatientGuarantor, { foreignKey: 'GuarantorId' });
    };
    return PharmacyModifyPatPaymentDetails;
}
