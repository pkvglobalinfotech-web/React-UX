(function () {
    ...
    angular
        .module('app.pages')
        .controller('InsuranceTariffRateController', InsuranceTariffRateController);

    function InsuranceTariffRateController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        $scope.lookup = {};
    ...
    InsuranceTariffRateController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
