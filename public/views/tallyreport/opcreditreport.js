(function () {
    ...
    angular
        .module('app.pages')
        .controller('opcreditreportController', opcreditreportController);

    function opcreditreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.backtoReport = function () {
            $state.go('app.tallyreporttab.opreport')
        };
    ...
    opcreditreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
