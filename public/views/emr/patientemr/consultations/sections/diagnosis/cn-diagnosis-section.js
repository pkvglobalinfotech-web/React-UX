(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnDiagnosisSectionController', cnDiagnosisSectionController);

    function cnDiagnosisSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        if($scope.$parent.cncontext.encounterid > 0) {
            $scope.currentcontext.eid = $scope.$parent.cncontext.encounterid;
        }
    ...
    cnDiagnosisSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
