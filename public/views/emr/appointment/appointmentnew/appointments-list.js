(function () {
    ...
    function appointmentsListController($rootScope, $scope, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var From = $filter('date')($scope.currentfilter.PoDate, 'yyyy-MM-dd 00:00:00') || null;
            var To = $filter('date')($scope.currentfilter.PoDate, 'yyyy-MM-dd 23:59:59') || null;
    ...
    appointmentsListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
