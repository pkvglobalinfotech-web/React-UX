(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnImmunizationSectionController', discasshtcnImmunizationSectionController);

    function discasshtcnImmunizationSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnImmunizationSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
