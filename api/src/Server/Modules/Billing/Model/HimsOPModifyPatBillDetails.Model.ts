...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.OPModifyPatBillDetailsInstance, i.OPModifyPatBillDetailsAttributes> {
    let OPModifyPatBillDetails =
        sequelize.define<i.OPModifyPatBillDetailsInstance, i.OPModifyPatBillDetailsAttributes>('OPModifyPatBillDetails', {
        ...
        },
            {
                indexes: [],
                timestamps: true,
                tableName: 'opmodifypatbilldetails',
                createdAt: 'CreatedAt',
                updatedAt: 'UpdatedAt',
    ...
    (OPModifyPatBillDetails as any).associate = function (models: Models) {
        OPModifyPatBillDetails.belongsTo(models.Department);
        OPModifyPatBillDetails.belongsTo(models.ServiceItem, { foreignKey: 'ServiceId' });
        OPModifyPatBillDetails.belongsTo(models.ServiceCategory, { foreignKey: 'ServiceCategoryId' });
        OPModifyPatBillDetails.belongsTo(models.User, { as: 'CreatedUser', foreignKey: 'CreatedBy' });
        OPModifyPatBillDetails.belongsTo(models.User, { foreignKey: 'DoctorId' });
        OPModifyPatBillDetails.belongsTo(models.StoreMaster, { foreignKey: 'StoreMasterId' });
        OPModifyPatBillDetails.belongsTo(models.ItemMaster, { foreignKey: 'ItemMasterId' });
        OPModifyPatBillDetails.belongsTo(models.OpticalItemMaster, { foreignKey: 'OpticalItemMasterId' });
        OPModifyPatBillDetails.belongsTo(models.OPModifyPatBills, { foreignKey: 'PatientBillId' });
        OPModifyPatBillDetails.belongsTo(models.Encounter);
        OPModifyPatBillDetails.belongsTo(models.ReferenceValue, { as: 'PatientBillStatus', targetKey: 'ReferenceValueCodeId' });
        OPModifyPatBillDetails.belongsTo(models.OrderStatus);
    };
    return OPModifyPatBillDetails;
}
