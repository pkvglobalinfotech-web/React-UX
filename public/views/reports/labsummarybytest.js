(function () {
    ...
    angular
        .module('app.pages')
        .controller('LabSummaryByTestController', LabSummaryByTestController);

    function LabSummaryByTestController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        $scope.LabTest = [];
    ...
    LabSummaryByTestController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
