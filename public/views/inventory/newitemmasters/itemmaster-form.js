(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemMasterFormController', newitemMasterFormController);

    function newitemMasterFormController($scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.getItemCallback = function (scope, data, options, hasError) {
            $scope.item = data;
            // vm.itemcontrolconfig.rowdata.ItemName = data.ItemName;
        ...
        $scope.saveItem = function () {
            ...
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                ...
                //     $scope.item.ItemMasterId = $scope.currentcontext.id;
                // }
            } else {
                if ($scope.item.ItemMasterId && $scope.item.ItemMasterId > 0) {
    ...
    newitemMasterFormController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
