(function () {
    ...
    angular
        .module('app.pages')
        .controller('opbilldetailsController', opbilldetailsController);

    function opbilldetailsController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.patientChange = function () {
            if ($scope.currentfilter.PatientId > 0) {
                var options = {
                    ...
                    type: 'post',
                    onComplete: function (scope, data, options, hasError) {
                        $scope.selectedPatient = data;
    ...
    opbilldetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
