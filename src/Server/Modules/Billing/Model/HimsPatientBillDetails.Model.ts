...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.PatientBillDetailsInstance, i.PatientBillDetailsAttributes> {
    let PatientBillDetails = sequelize.define<i.PatientBillDetailsInstance, i.PatientBillDetailsAttributes>('PatientBillDetails', {
        Id: { type: DataTypes.BIGINT, field: 'PatientBillDetailId', primaryKey: true, autoIncrement: true },
        ...
        AdjustRate: { type: DataTypes.DECIMAL, field: 'AdjustRate' },
        ...
        IsPartialSupplemetary: { type: DataTypes.BOOLEAN, field: 'IsPartialSupplemetary' },
        ...
        IsDiscountApplied: { type: DataTypes.BOOLEAN, field: 'IsDiscountApplied' },
        ...
        ExecDoctorId: { type: DataTypes.BIGINT, field: 'ExecDoctorId' },
        ...
        AgreementDiscountRate: { type: DataTypes.DECIMAL, field: 'AgreementDiscountRate' },
        IsSchemeDiscount: { type: DataTypes.BOOLEAN, field: 'IsSchemeDiscount' },
        IsPharmacyAdjusted: { type: DataTypes.BOOLEAN, field: 'IsPharmacyAdjusted' },
        SchemeDiscountRate: { type: DataTypes.DECIMAL, field: 'SchemeDiscountRate' },
        SchemeDiscountAmt: { type: DataTypes.DECIMAL, field: 'SchemeDiscountAmt' },
        CancelReqRaisedStatusId: { type: DataTypes.BIGINT, field: 'CancelReqRaisedStatusId' },
        DetCancelReqRaisedStatusId: { type: DataTypes.INTEGER, field: 'DetCancelReqRaisedStatusId' },
    },
        {
            indexes: [],
            timestamps: true,
            tableName: 'patientbilldetails',
            createdAt: 'CreatedAt',
            updatedAt: 'UpdatedAt',
    ...
    (PatientBillDetails as any).associate = function (models: Models) {
        PatientBillDetails.belongsTo(models.Department);
        PatientBillDetails.belongsTo(models.StoreMaster);
        PatientBillDetails.belongsTo(models.Department, { as: 'SubDepartment', foreignKey: 'SubDepartmentId' });
        PatientBillDetails.belongsTo(models.ServiceItem, { foreignKey: 'ServiceId' });
        PatientBillDetails.belongsTo(models.ServiceCategory, { foreignKey: 'ServiceCategoryId' });
        PatientBillDetails.belongsTo(models.User, { as: 'CreatedUser', foreignKey: 'CreatedBy' });
        PatientBillDetails.belongsTo(models.User, { as: 'UpdatedUser', foreignKey: 'UpdatedBy' });
        PatientBillDetails.belongsTo(models.User, { as: 'CancelledUser', foreignKey: 'CancelledBy' });
        PatientBillDetails.belongsTo(models.User, { as: 'Doctor', foreignKey: 'DoctorId' });
        PatientBillDetails.belongsTo(models.User, { as: 'ExeDoctor', foreignKey: 'ExecDoctorId' });
        // PatientBillDetails.belongsTo(models.StoreMaster, { foreignKey: 'StoreMasterId' });
        PatientBillDetails.belongsTo(models.GstMaster, { foreignKey: 'GSTId' });
        PatientBillDetails.belongsTo(models.ItemMaster, { foreignKey: 'ItemMasterId' });
        PatientBillDetails.belongsTo(models.OpticalItemMaster, { foreignKey: 'OpticalItemMasterId' });
        PatientBillDetails.belongsTo(models.PatientBills, { foreignKey: 'PatientBillId' });
        PatientBillDetails.belongsTo(models.Encounter);
        PatientBillDetails.belongsTo(models.ReferenceValue, { as: 'PatientBillStatus', targetKey: 'ReferenceValueCodeId' });
        PatientBillDetails.belongsTo(models.OrderStatus);
        PatientBillDetails.belongsTo(models.StockSerialItem);
        PatientBillDetails.hasMany(models.PatientDoctorShareDetails);
    };
