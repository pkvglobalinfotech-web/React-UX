(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoccurrentpatientsingleController', DoccurrentpatientsingleController);

    function DoccurrentpatientsingleController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    DoccurrentpatientsingleController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
