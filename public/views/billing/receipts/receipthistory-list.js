(function() {
    ...
    angular
        .module('app.pages')
        .controller('receipthistoryListController', receipthistoryListController);

function receipthistoryListController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
    var vm = this;
...
receipthistoryListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
