(function() {
    ...
    angular
        .module('app.pages')
        .controller('stockconsumptiondetailsController', stockconsumptiondetailsController);

    function stockconsumptiondetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    stockconsumptiondetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
