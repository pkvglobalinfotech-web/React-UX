(function () {
    ...
    function InjectionAdviceFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.currentcontext.surgid = parseInt(modalConfig.params.surgid);
            $scope.currentcontext.surgname = modalConfig.params.surgname;
        ...
        $scope.item.SurgeryNameId = $scope.currentcontext.surgid;
        $scope.item.SurgeryName = $scope.currentcontext.surgname;
        ...
        $scope.getItem = function (pageNo) {
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                var options = {
                    action: 'emr/PatientSurgeryAdvice/GetPatientSurgeryAdviceById',
        ...
        $scope.saveItem = function () {
            var actionName = 'emr/PatientSurgeryAdvice/AddPatientSurgeryAdvice';
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                actionName = 'emr/PatientSurgeryAdvice/UpdatePatientSurgeryAdvice';
            }
