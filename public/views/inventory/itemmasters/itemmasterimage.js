(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterImageController', itemmasterImageController);

    function itemmasterImageController($scope, $filter, $stateParams, $state, $translate, utl, Upload) {
        var vm = this;
    ...
    itemmasterImageController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
