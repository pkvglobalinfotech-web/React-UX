(function () {
    ...
    angular
        .module('app.pages')
        .controller('tallysalesreportReportController', tallysalesreportReportController);

    function tallysalesreportReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var options = {
                action: 'billing/PatientBillDetails/SaleGSTDetails',
                data: inputData,
                type: 'post',
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/PatientBillDetails/PrintSaleGSTReport',
                data: inputData,
                type: 'post'
            };
    ...
    tallysalesreportReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
