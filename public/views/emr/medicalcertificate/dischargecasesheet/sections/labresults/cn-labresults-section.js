(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnLabResultsSectionController', discasshtcnLabResultsSectionController);

    function discasshtcnLabResultsSectionController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        function prepareTestResult() {
            for (var jdx in $scope.currentcontext.orders) {
                for (var kdx in $scope.currentcontext.orders[jdx].PatientWorkorders) {
                    var result = $scope.currentcontext.orders[jdx].PatientWorkorders[kdx].PatientWorkorderdetails;
                    var testArr = [];
                    var tabIndex = 0;
                    var profileName = "";
                    var rootProfileName = "";
                    ...
                    $scope.currentcontext.orders[jdx].PatientWorkorders[kdx].woDetails = testArr;
                }
            }
            ...
            for (var jdx in $scope.currentcontext.orders) {
                for (var kdx in $scope.currentcontext.orders[jdx].PatientWorkorders) {
                    var workorder = $scope.currentcontext.orders[jdx].PatientWorkorders[kdx];
                    var woDetailres = $scope.currentcontext.orders[jdx].PatientWorkorders[kdx].woDetails;
    ...
    discasshtcnLabResultsSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
