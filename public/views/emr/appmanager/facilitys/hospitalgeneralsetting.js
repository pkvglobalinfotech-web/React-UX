(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalsettingFormController', generalsettingFormController);

    function generalsettingFormController($scope, $stateParams, $state, $translate, utl, jsonPath) {
    ...
    generalsettingFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'jsonPath'];
