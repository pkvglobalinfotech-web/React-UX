(function () {
    ...
    angular
        .module('app.pages')
        .controller('stockissuevochergeneralreportController', stockissuevochergeneralreportController);

    function stockissuevochergeneralreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            ...
            hiddenElement.download = 'stockissuevocher-report.csv';
            hiddenElement.click();
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'pharmacy/StockTransferDetail/PrintStockIssueVocherReport',
                data: inputData,
                type: 'post',
            };
    ...
    stockissuevochergeneralreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
