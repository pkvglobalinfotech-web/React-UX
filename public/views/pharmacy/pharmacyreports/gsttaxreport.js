(function () {
    ...
    angular
        .module('app.pages')
        .controller('gsttaxreportController', gsttaxreportController);

    function gsttaxreportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.salesgstreport = function () {
            $state.go('app.salesgstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.returngstreport = function () {
            $state.go('app.returngstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.purchasesalesgstreport = function () {
            $state.go('app.purchasesalesgstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.purchasereturngstreport = function () {
            $state.go('app.purchasereturngstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.staffcreditsummaryreport = function () {
            $state.go('app.staffcreditsummaryreport')
        }
        $scope.consolidatesalesgstreport = function () {
            $state.go('app.consolidatesalesgstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.consolidatepurchasegstreport = function () {
            $state.go('app.consolidatepurchasegstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.stocksummaryproductgstreport = function () {
            $state.go('app.stocksummaryproductgstreport', { context: 'pharmacygsttaxreport' })
        }
        $scope.consolidateinputgstsummary = function () {
            $state.go('app.consolidateinputgstsummary', { context: 'pharmacygsttaxreport' })
        }
        $scope.consolidateoutputgstsummary = function () {
            $state.go('app.consolidateoutputgstsummary', { context: 'pharmacygsttaxreport' })
        }
        $scope.consolidategstreportfordeepam = function () {
            $state.go('app.consolidategstreportfordeepam', { context: 'pharmacygsttaxreport' })
        }
    ...
    gsttaxreportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
