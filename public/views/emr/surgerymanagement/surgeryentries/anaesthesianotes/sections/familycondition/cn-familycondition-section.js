(function () {
    ...
    angular
        .module('app.pages')
        .controller('otcnFamilyConditionSectionController', otcnFamilyConditionSectionController);

    function otcnFamilyConditionSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    otcnFamilyConditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
