(function () {
    ...
    function findbillListController($scope, utl, $uibModalInstance, modalConfig) {
        var vm = this;

        var context = modalConfig && modalConfig.params ? modalConfig.params.context : 'OP';
    ...
    findbillListController.$inject = ['$scope', 'utl', '$uibModalInstance', 'modalConfig'];
})();