...
export interface OtScheduleDetailsAttributes extends IAttributes {
    Id: number;
    // OTScheduledOn: Date;
    OTScheduledId: number;
    PatientId: number;
    // PatientName: string;
...
export interface OtScheduleDetailsInstance extends Instance<OtScheduleDetailsAttributes> {
    // I'm exposing every DB column as an instance field to so that tsc won't complain.
    // CreatedAt: Date;
    // UpdatedAt: Date;
    dataValues: OtScheduleDetailsAttributes;
}
