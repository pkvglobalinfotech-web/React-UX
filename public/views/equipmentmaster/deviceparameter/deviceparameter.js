(function () {
    ...
    angular
        .module('app.pages')
        .controller('DeviceParameterListController', DeviceParameterListController);

    function DeviceParameterListController($rootScope, $timeout, $scope, $stateParams, $state, $translate, utl) {
        var vm = this;

        $scope.Items = [];
        $scope.currentfilter = {
            DeviceParametersName: '',
            DeviceParametersCode: '',
        ...
        $scope.getList = function (pageNo) {
            ...
            var inputData = {
                Params: [
                    ...
                    { Key: 2, Value: $scope.currentfilter.DeviceParameterTypeId },
            ...
            var options = {
                action: 'pharmacy/DeviceParameters/GetDeviceParameterss',
                data: inputData,
                type: 'post',
        ...
        $scope.addNew = function () {
            utl.Modal.open('app.deviceparamenter', {
                params: {
                    id: 0
                },
        ...
        $scope.onDeleteConfirmed = function (deleteId) {
            var options = {
                action: 'pharmacy/DeviceParameters/DeleteDeviceParameters',
                data: { Id: deleteId },
                type: 'post',
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'view') {
               utl.Modal.open('app.deviceparamenter', {
                ...
                utl.Dialog.confirmDelete($scope.onDeleteConfirmed, entity.Id, entity.DeviceParametersName);
            }
        }
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                { field: "UOM", displayName: $translate.instant('UOM') },
                { field: "DisplayOrder", displayName: $translate.instant('DisplayOrder') },
                { field: "DeviceParameterType.Description", displayName: $translate.instant('Type') },
    ...
    DeviceParameterListController.$inject = ['$rootScope', '$timeout', '$scope', '$stateParams', '$state', '$translate', 'utl'];
