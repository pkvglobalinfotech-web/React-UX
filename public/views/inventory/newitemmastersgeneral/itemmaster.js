(function () {
    ...
    angular
        .module('app.pages')
        .controller('newgeneralitemMasterFormController', newgeneralitemMasterFormController);

    function newgeneralitemMasterFormController($scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.newitemmastersgeneral');
        };
    ...
    newgeneralitemMasterFormController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
