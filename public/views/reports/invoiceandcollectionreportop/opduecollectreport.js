(function () {
    ...
    angular
        .module('app.pages')
        .controller('opduecollectreportController', opduecollectreportController);

    function opduecollectreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/PatientPaymentDetails/PrintOPDueCollectionReport',
                data: inputData,
                type: 'post'
            };
    ...
    opduecollectreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
