(function () {
    ...
    function SymptomNotesListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('patientemr.symptomnotestab.symptomnotehistory', {
    ...
    SymptomNotesListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
