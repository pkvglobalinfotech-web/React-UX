(function () {
    ...
    angular
        .module('app.pages')
        .controller('OPCollectionsReportController', OPCollectionsReportController);

    function OPCollectionsReportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
    ...
    OPCollectionsReportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
