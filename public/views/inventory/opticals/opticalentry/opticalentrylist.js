(function () {
    ...
    angular
        .module('app.pages')
        .controller('OpticalEntryListController', OpticalEntryListController);

    function OpticalEntryListController($rootScope,$timeout,$scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var options = {
                action: 'pharmacy/OpticalEntry/GetOpticalEntrys',
                data: inputData,
                type: 'post',
        ...
        $scope.addNew = function () {
            $state.go('app.opticalentryform', { id: 0, grnid: $scope.currentcontext.grnid });
        };

        $scope.findGrn = function () {
            $state.go('app.opticalentryform.find', { findid: 0 });
        };
        ...
        $scope.onDeleteConfirmed = function (deleteId) {
            var options = {
                action: 'pharmacy/OpticalEntry/DeleteOpticalEntry',
                data: { Id: deleteId },
                type: 'post',
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                ...
                cellTemplate: "<div class='ui-grid-cell-contents'><span >{{entity.OrderDate | date : 'dd-MMM-yyyy'}}&nbsp;</span>" + "<span >{{entity.OpticalGrnDate| date: 'HH:mm'}}</span>" + "</div>"
            },
            { field: "OrderNo", displayName: $translate.instant('Order Number') },
            { field: "StoreMaster.StoreName", displayName: $translate.instant('Name') },
            // { field: "Patient.Description", displayName: $translate.instant('Patient Id') },
            {
                field: "Patient",
            ...
            { field: "VendorMaster.VendorName", displayName: $translate.instant('Doctor Name') },
            { field: "InvoiceNumber", displayName: $translate.instant('Type of lens') },
            {
                field: "TotalGrossAmount",
                displayName: $translate.instant('Charge'),
    ...
    OpticalEntryListController.$inject = ['$rootScope','$timeout','$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$filter'];
