(function () {
    ...
    angular
        .module('app.pages')
        .controller('facilityitemmasterVendorMapFormController', facilityitemmasterVendorMapFormController);

    function facilityitemmasterVendorMapFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.item.CategoryId = modalConfig.params.CategoryId;
        ...
        $scope.getMasterItem = function () {
            var inputData = {
                Params: [
                    { Key: 0, Value: $scope.currentcontext.ItemFacilityMapId }
                ]
            };
        ...
        $scope.backToList = function () {
            $state.go('app.facilityitemmastertab.facilityitemmastervendormappings');
        };
    ...
    facilityitemmasterVendorMapFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
