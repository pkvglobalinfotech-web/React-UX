(function () {
    ...
    angular
        .module('app.pages')
        .controller('DoctorNotescurrentListController', DoctorNotescurrentListController);

    function DoctorNotescurrentListController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.gridData = [];
        $scope.Items = [];
        $scope.currentfilter = {
    ...
    DoctorNotescurrentListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
