(function () {
    ...
    angular
        .module('app.pages')
        .controller('OutpatientSummaryByInsuranceController', OutpatientSummaryByInsuranceController);

    function OutpatientSummaryByInsuranceController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
        ...
        $scope.GetListOptions = function () {
            ...
            var options = {
                action: 'Visit/Visit/GetOutpatientSummaryInsurance',
                data: inputData,
                type: 'post',
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintOutpatientSummarybyInsurance',
                data: inputData,
                type: 'post'
            };
    ...
    OutpatientSummaryByInsuranceController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
