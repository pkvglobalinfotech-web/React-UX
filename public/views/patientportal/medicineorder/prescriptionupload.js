(function () {
    ...
    angular
        .module('app.pages')
        .controller('PrescriptionUploadController', PrescriptionUploadController);

    function PrescriptionUploadController($scope, $stateParams, $state, $translate, utl, Upload) {
        var vm = this;
    ...
    PrescriptionUploadController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
