(function () {
    ...
    angular
        .module('app.pages')
        .controller('stockmovementgeneralreportController', stockmovementgeneralreportController);

    function stockmovementgeneralreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    stockmovementgeneralreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
