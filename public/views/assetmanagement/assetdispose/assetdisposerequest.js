(function () {
    ...
    angular
        .module('app.pages')
        .controller('AssetDisposeRequestController', AssetDisposeRequestController);

    function AssetDisposeRequestController($rootScope,$timeout,$scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.DisposeRequest = function () {
            $state.go('app.assetdisposetab.disposerequestform', {
                gid: 0
            });
        }
    ...
    AssetDisposeRequestController.$inject = ['$rootScope','$timeout','$scope', '$stateParams', '$state', '$translate', 'utl'];
