(function () {
    ...
    angular
        .module('app.pages')
        .controller('POBasedGRNListController', POBasedGRNListController);

    function POBasedGRNListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    POBasedGRNListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
