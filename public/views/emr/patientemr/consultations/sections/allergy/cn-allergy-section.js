(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnAllergySectionController', cnAllergySectionController);

    function cnAllergySectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                Params: [{
                    ...
                    {
                        Key: 3,
                        Value: $scope.currentfilter.AllergyTypeId
                    },
                    {
                        Key: 4,
                        Value: $scope.currentfilter.PatientAllergyStatusId
                    },
                    {
                        Key: 5,
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                    field: "AllergyType.Description",
                    displayName: $translate.instant('patientemr.patientallergy-list.type.lbl')
                },
                {
                    field: "AllergyName",
                    displayName: $translate.instant('patientemr.patientallergy-list.name.lbl')
                },
                {
                    field: "StartDate",
                    displayName: $translate.instant('patientemr.patientallergy-list.date.lbl'),
                    cellTemplate: "<ngformatdate date-val='row.entity.StartDate'></ngformatdate>"
                },
                {
                    field: "PatientAllergyStatus.Description",
                    displayName: $translate.instant('patientemr.patientallergy-list.status.lbl')
                },
                {
                    field: "Id",
    ...
    cnAllergySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
