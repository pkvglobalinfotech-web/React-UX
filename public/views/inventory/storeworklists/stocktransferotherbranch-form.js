(function () {
    ...
    angular
        .module('app.pages')
        .controller('StocktransferFormOtherbranchController', StocktransferFormOtherbranchController);

    function StocktransferFormOtherbranchController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.getStockRequestCallback = function (scope, data, options, hasError) {
            ...
            // $scope.item.FromStoreName = result.FromStore.StoreName;
            // $scope.item.ToStoreMasterId = result.ToStoreMasterId;
            // $scope.item.ToStoreName = result.ToStore.StoreName;
            ...
            $scope.item.StoreMasterId = result.ToStoreMasterId;
            $scope.item.FromStoreName = result.ToStore.StoreName;
            $scope.item.ToFacilityId = result.FacilityId;
            $scope.item.FacilityId = result.ToFacilityId;
        ...
        */
        ...
        $scope.backToList = function () {
            $state.go('app.indentlistforotherbranchtab.indentlistforotherbranch', $scope.currentcontext.id);
        };
    ...
    StocktransferFormOtherbranchController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
