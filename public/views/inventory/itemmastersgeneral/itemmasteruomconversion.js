(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalitemmasterUOMConversionController', generalitemmasterUOMConversionController);

    function generalitemmasterUOMConversionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        $scope.Items = [];
        $scope.item = {};
        $scope.currentfilter = {};
    ...
    generalitemmasterUOMConversionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
