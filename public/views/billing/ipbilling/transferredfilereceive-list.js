(function () {
    ...
    angular
        .module('app.pages')
        .controller('TransferredFileReceiveListController', TransferredFileReceiveListController);

    function TransferredFileReceiveListController($rootScope,$timeout,
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'filereturn') {
                ...
                $state.go('app.transferredfilereceiveform', {
                    id: entity.Id,
                });
            }
        }
        ...
        vm.gridConfig = {
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents">\
                    <span class="grid-action" ng-click="handleEvents(\'filereturn\',entity)" ng-hide="entity.MRDIPFileStatusId==9"><i class="btn text-white dem-color4  btn-xs" aria-hidden="true"><strong>File Receive</strong></i></span>\
                    <span class="grid-action" ng-click="handleEvents(\'filereturn\',entity)" ng-show="entity.MRDIPFileStatusId==9"><i class="btn text-white dem-color4  btn-xs" aria-hidden="true"><strong>View</strong></i></span>\
                            </div>',
    ...
    TransferredFileReceiveListController.$inject = ['$rootScope','$timeout','$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
