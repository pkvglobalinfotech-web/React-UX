(function () {
    ...
    function ipBillListController($scope, $filter, $stateParams,
    ...
    ipBillListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
