(function () {
    ...
    angular
        .module('app.pages')
        .controller('AssetDisposeRequestFormController', AssetDisposeRequestFormController);

    function AssetDisposeRequestFormController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.assetdisposetab.disposerequest')
        }
        ...
        $scope.Request = function () {
            var confirmOptions = {
                ...
                messageKey: 'assetmanagement.assettransfer.confirmreqmsg.lbl',
    ...
    AssetDisposeRequestFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
