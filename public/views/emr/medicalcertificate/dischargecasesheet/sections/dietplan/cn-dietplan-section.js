(function () {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnDietPlanSectionController', discasshtcnDietPlanSectionController);

    function discasshtcnDietPlanSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnDietPlanSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
