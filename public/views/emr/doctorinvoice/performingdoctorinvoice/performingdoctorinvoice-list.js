(function () {
    ...
    angular
        .module('app.pages')
        .controller('PerformingDoctorInvoiceListController', PerformingDoctorInvoiceListController);

    function PerformingDoctorInvoiceListController($rootScope,$scope, $stateParams, $state, $translate, utl, $filter,$timeout) {
        var vm = this;
        $scope.currentfilter = {
        ...
        $scope.NavigateForm = function (Id) {
            $state.go('app.performingdoctorvoucherform', { id: Id });
        }
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'edit') {
                // $scope.NavigateForm(entity.Id);
                utl.Modal.openFixedDialog('app.performingdoctorinvoicepayment', {
                    params: { id: 0 },
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contents">\
                                                ...
                                                <span class="grid-action" uib-tooltip="Payment Voucher" tooltip-placement="bottom" ng-click="handleEvents(\'edit\',entity)"  ng-show="entity.DoctorInvoiceStatusId==1||entity.DoctorInvoiceStatusId==3"><i class="fas fa-calendar-plus"></i></span>\
                                            </div>',
    ...
    PerformingDoctorInvoiceListController.$inject = ['$rootScope','$scope', '$stateParams', '$state', '$translate', 'utl', '$filter','$timeout'];
