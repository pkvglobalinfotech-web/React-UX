(function() {
    ...
    angular
        .module('app.pages')
        .controller('ProcedureOrderTabController', ProcedureOrderTabController);

    function ProcedureOrderTabController($scope, $stateParams, $state, $translate, utl) {
        var tabvm = this;
    ...
    ProcedureOrderTabController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
})();