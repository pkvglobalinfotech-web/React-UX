(function () {
    ...
    angular
        .module('app.pages')
        .controller('dissocialHistorySectionController', dissocialHistorySectionController);

    function dissocialHistorySectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.socialhistory';
    ...
    dissocialHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
