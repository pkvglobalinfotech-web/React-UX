(function () {
    ...
    angular
        .module('app.pages')
        .controller('emrtaskmanagementformController', emrtaskmanagementformController);

    function emrtaskmanagementformController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    emrtaskmanagementformController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
