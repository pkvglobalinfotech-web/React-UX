(function () {
    ...
    angular
        .module('app.pages')
        .controller('NursingNotesFormController', NursingNotesFormController);

    function NursingNotesFormController($scope,$interval, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    NursingNotesFormController.$inject = ['$scope', '$interval', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
