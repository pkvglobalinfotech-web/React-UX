(function () {
    ...
    angular
        .module('app.pages')
        .controller('findpharmacyDirectoutstandingsListController', findpharmacyDirectoutstandingsListController);

    function findpharmacyDirectoutstandingsListController($scope, $filter, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    findpharmacyDirectoutstandingsListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
