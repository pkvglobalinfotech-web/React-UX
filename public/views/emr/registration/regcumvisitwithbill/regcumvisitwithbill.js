(function () {
    ...
    function regcumvisitwithbillController($rootScope, $scope, $filter, $timeout, $stateParams, $state, $translate, utl, Upload) {
        var vm = this;
        ...
        // $scope.$watch("$scope.item.IsPincodeFreeText", function(newValue, oldValue){
        ...
        $scope.swosthapatient = 0;
        $scope.swosthaintegration = false;
        ...
        $scope.disablereferral = 0;
        $scope.disablereferral = utl.FacilitySetting.getFacilitySettingValue('billing', 'disablereferral');
        $scope.adrsmandatory = utl.FacilitySetting.getFacilitySettingValue('billing', 'adrsmandatory');
        ...
        $scope.allowotherfacpatients = 0;
        $scope.allowotherfacpatients = utl.FacilitySetting.getFacilitySettingValue('billing', 'allowotherfacpatients');
        ...
        $scope.item.FromDate = utl.Formatter.getCurrentDate(),
            $scope.item.ToDate = utl.Formatter.getCurrentDate(),
            $scope.item.From = $filter('date')($scope.item.FromDate, 'yyyy-MM-dd 00:00:00') || null;
        $scope.item.To = $filter('date')($scope.item.ToDate, 'yyyy-MM-dd 23:59:59') || null;
        ...
        $scope.currentcontext.CanReg_Nobill = utl.Privilege.hasAccess('CanReg_Nobill');

        console.log(utl.Session.getMedblazePost());
        ...
        $scope.findSwostha = function () {

            utl.Modal.open('app.findswosthapatient', {
                params: {
                    data: null
                },
        ...
        $scope.crossconsult = function () {
            utl.Modal.open('app.crossconsultation', {
                params: {
        ...
        function loadData(data) {
            ...
            let patientMRN = data.MRN;
            console.log(patientData.length);
            if (patientData.length > 0) {
                utl.Alert.showSuccessMsg($translate.instant('common.successmsg.lbl'));
                $scope.swosthapatient = 1;
                $scope.himsDisabled = true;
                $scope.item = {
                    SwosthaPatientId: patientData[0].Id,
                    SwosthaPatientMRN: patientData[0].MRN,
                    TitleId: patientData[0].TitleId,
                    FirstName: patientData[0].FirstName,
                    MiddleName: patientData[0].FirstName,
                    LastName: patientData[0].MiddleName,
                    Age: patientData[0].Age,
                    DOB: patientData[0].DOB,
                    MaritalStatusId: patientData[0].MaritalStatusId,
                    GuardianTypeId: patientData[0].GuardianTypeId,
                    GuardianName: patientData[0].GuardianName,
                    ReligionId: patientData[0].ReligionId,
                    PreferredLanguageId: patientData[0].PreferredLanguageId,
                    Qualification: patientData[0].Qualification,
                    NationalityId: patientData[0].NationalityId,
                    NationalityIdentifier: patientData[0].NationalityIdentifier,
                    PasspostNumber: patientData[0].PasspostNumber,
                    VisaTypeId: patientData[0].VisaTypeId,
                    VisaNumber: patientData[0].VisaNumber,
                    VisaExpiry: patientData[0].VisaExpiry,
                    IsVip: patientData[0].IsVip,
                    IsMLC: 0,
                    IsRecipient: patientData[0].IsRecipient,
                    PatientAssociate: patientData[0].PatientAssociate,
                    CovidVaccineId: 0,
                    PatientTypeId: patientData[0].PatientTypeId,
                    OccupationId: patientData[0].OccupationId,
                    BloodGroupId: patientData[0].BloodGroupId,
                    ReferTypeId: patientData[0].ReferTypeId,
                    ReferrerId: patientData[0].ReferrerId,
                    AddressLine1: patientData[0].AddressLine1,
                    AddressLine2: patientData[0].AddressLine2,
                    Pincode: patientData[0].Pincode,
                    Area: patientData[0].Area,
                    City: patientData[0].City,
                    State: patientData[0].State,
                    Country: patientData[0].Country,
                    LandLine: patientData[0].LandLine,
                    Mobile: patientData[0].Mobile,
                    Email: patientData[0].Email,
                    IsSmsCommunicationPreference: patientData[0].IsSmsCommunicationPreference,
                    IsEmailCommunicationPreference: patientData[0].IsEmailCommunicationPreference,
                    IsMRDRequest: patientData[0].IsMRDRequest,
                    GenderId: patientData[0].GenderId,
                    MRN: '',
                    PinCodeId: patientData[0].PinCodeId,
                    CityId: patientData[0].CityId,
                    StateId: patientData[0].StateId,
                    CountryId: patientData[0].CountryId,
                    WardId: patientData[0].WardId,
                    Ward: '',
                    DistrictId: patientData[0].DistrictId,
                    District: patientData[0].DistrictMaster.DistrictName,
                    AliasName: patientData[0].AliasName,
                    GuarantorId: patientData[0].GuarantorId,
                    RegisteredDate: patientData[0].RegisteredDate,
                    PatientStatusId: patientData[0].PatientStatusId,
                    MRNTypeId: 1,
                    PhotoPath: patientData[0].PhotoPath,
                    IsBirthDateApproximate: patientData[0].IsBirthDateApproximate,
                    DeathDate: patientData[0].DeathDate,
                    DeathTypeId: patientData[0].DeathTypeId,
                    DeathPlaceId: patientData[0].DeathPlaceId,
                    IsDeathConfirmed: patientData[0].IsDeathConfirmed,
                    DeathConfirmedBy: patientData[0].DeathConfirmedBy,
                    DeathComents: patientData[0].DeathComents,
                    DeathUpdatedBy: patientData[0].DeathUpdatedBy,
                    DeathUpdatedDate: patientData[0].DeathUpdatedDate,
                    DeathApprovedBy: patientData[0].DeathApprovedBy,
                    FacilityId: utl.Session.getCurrentFacilityId(),
                    RemarkId: patientData[0].RemarkId,
                    MRNShortCode: '',
                    ICENo: patientData[0].ICENo,
                    Income: patientData[0].Income,
                    IsInsurance: patientData[0].IsInsurance,
                    ReferralName: patientData[0].ReferralName,
                    NooFVisitFree: patientData[0].NooFVisitFree,
                    IsAdditionalVisit: patientData[0].IsAdditionalVisit,
                    NewVisitFree: patientData[0].NewVisitFree,
                    IsMerged: patientData[0].IsMerged,
                    MergePatientId: patientData[0].MergePatientId,
                    MergeMRN: patientData[0].MergeMRN,
                    UserId: 0,
                    Staff: patientData[0].Staff,
                    IsCorporateCustomer: patientData[0].IsCorporateCustomer,
                    IsEmergencyPatient: 0,
                    EmergencyContactName: patientData[0].EmergencyContactName,
                    AlternateMobileNum: 'NULL',
                    Relation: patientData[0].Relation,
                };

            } else {
                utl.Alert.showErrorMsg($translate.instant($translate.instant('Not Found')));
            }
        ...
        $scope.getLastVisitInfoCallback = function (scope, res, options, hasError) {
            var LastVisitInfo = []
            ...
            try {
                if (LastVisitInfo.length > 0) {
                    $scope.item.GuarantorId = LastVisitInfo[0].GuarantorId;
                }
            } catch (ex) {
                $scope.GuarantorId = 1;
            }
        ...
        $scope.getLastVisitInfo = function () {
            if ($scope.item && $scope.item.PatientId) {
                ...
                var options = {
                    ...
                    data: inputData,
                    type: 'post',
                    onComplete: $scope.getLastVisitInfoCallback
                };
        ...
        $scope.GetGuarantorCallback = function (scope, data, options, hasError) {
            ...
            $scope.lookup["Guarantor"] = data.Data;
            // if ($scope.lookup.Guarantor && $scope.lookup.Guarantor.length > 1) {
            //     // if (!$scope.item.GuarantorId || $scope.item.GuarantorId == -1) {
            //     $scope.item.GuarantorId = $scope.lookup.Guarantor[1].Id;
            //     $scope.item.TpaId = $scope.lookup.Guarantor[1].TPAId;
            //     // }
            //     $scope.PatGuarantorNoofFreeVisit = 0;
            $scope.setDefaultService();
            // }
        ...
        $scope.GetGuarantor = function () {
            ...
            var options = {
                ...
                data: inputData,
                type: 'post',
                onComplete: $scope.GetGuarantorCallback
            };
            utl.Http.doAction(options);
            ...
            if ($scope.item.GuarantorId > 0) {
                ...
                if (SelectedGuarantor) {
                    if ($scope.PatientGuarantor == 0) {
                        ...
                        $scope.item.ServiceRateCategoryId = ServiceRateCategoryId_;
                        $scope.item.GuarantorName = SelectedGuarantor.Text;
                        $scope.currentcontext.GuarantorTypeId = SelectedGuarantor.GuarantorTypeId; //Newly included
                    } else {
                        GuarantorId_ = SelectedGuarantor.Id;
                        $scope.item.AcutalGuarantorId = GuarantorId_;
                    ...
                    var NewVisit = 1;
                    if ($scope.autochargebasedondoctor == 0) {
        ...
        $scope.setDefaultServiceIsOPDCallback = function (scope, data, options, hasError) {
            $scope.DefaultServiceTotalAmt = 0;
            $scope.DefaultServiceGrossAmt = 0;
            if (data) {
                if (data[0].ServiceId != $scope.DefaultServiceInfo[0].ServiceId) {
                    $scope.DefaultServiceInfo.push(data[0]);
                }
            }
            for (var idx in $scope.DefaultServiceInfo) {
                var item = $scope.DefaultServiceInfo[idx];
        ...
        $scope.setDefaultServiceIsOPD = function () {
            // $scope.DefaultServiceInfo = [];
            var GuarantorId_ = 0;
            var ServiceRateCategoryId_ = 0;
            if ($scope.item.GuarantorId > 0) {
                ...
                if (SelectedGuarantor) {
                    ...
                    var Data = {
                        ...
                        'GuarantorTypeId': $scope.currentcontext.GuarantorTypeId,
                        'GuarantorId': 1,
                        'GuarantorServiceRateCategoryId': 1,
                    };
                    var options = {
                        action: 'Visit/Visit/GetOPDefaultServices',
                        data: {
                        ...
                        type: 'post',
                        onComplete: $scope.setDefaultServiceIsOPDCallback
                    };
                    utl.Http.doAction(options);
                }
            }
        ...
        $scope.getPatientBillInfoCallback = function (scope, res, options, hasError) {
            if (res.Data.length > 0) {
                var billinfo = {
                    ...
                    'BillNumber': res.Data[0].BillNumber,
        ...
        $scope.getAppointmentCallback = function (scope, data, options, hasError) {
            ...
            if ($scope.item.EncounterId > 0 && utl.Session.getMedblazePost() == 1) {
                $scope.feedbackData.variables[6].value = $scope.Appointment.Encounters[0].VisitIdentifier;
                if ($scope.feedbackData.variables[5].value == "") {
                    $scope.feedbackData.variables[5].value = $scope.Appointment.Patient.MRN;
                }
        ...
        $scope.printMRDLabel = function () {
            ...
            try {
                ...
                if (window.barcodeclientcode.toLowerCase() == 'lotus') {
        ...
        $scope.patientidcard = function () {
            ...
            try {
                ...
                try {
                    ...
                    if ($scope.Appointment && $scope.Appointment &&
                        $scope.Appointment.AssignedUserName) {
                    ...
                    if ($scope.item && $scope.item &&
                        $scope.item.Encounters[0].DoctorName) {
                        vDoctorName = $scope.item.Encounters[0].DoctorName;
                    }
                    if ($scope.item && $scope.item &&
                        $scope.item.Referrer) {
                        RefDoctorName = $scope.item.Referrer.ReferralName;
                    }
                    if ($scope.item && $scope.item &&
                        $scope.item.RegisteredDate) {
                        vRegisteredDate = utl.Formatter.getDateTimeString($scope.item.RegisteredDate);
                    }
                    if ($scope.item && $scope.item &&
                        $scope.item.Encounters[0].VisitIdentifier) {
                        vvisitNo = $scope.item.Encounters[0].VisitIdentifier;
                    }
                ...
                if (window.barcodeclientcode.toLowerCase() == 'prakriya') {
                    ...
                    //  $scope.printRaw(printData);
                    code += noofprint > 1 ? 'P' + noofprint + printCodes.new_line : 'P1' + printCodes.new_line;
                } else if (window.barcodeclientcode.toLowerCase() == 'eechh') {
                    code += 'I8,A,001' + printCodes.new_line;
                    code += 'Q200,024' + printCodes.new_line;
                    code += 'q831' + printCodes.new_line;
                    code += 'rN' + printCodes.new_line;
                    ...
                    code += 'A620,256,2,4,1,1,N,"' + 'MRN' + '"' + printCodes.new_line;
                    code += 'A530,256,2,4,1,1,N,"' + ' ' + ' ' + ' PHID :' + ' ' + vMRN + '"' + printCodes.new_line;
                    code += 'A620,225,2,4,1,1,N,"' + 'Name.s' + '"' + printCodes.new_line;
                    code += 'A530,225,2,4,1,1,N,"' + ' ' + ' ' + ' Pat.Name :' + ' ' + vTitle + ' ' + vFirstName + ' ' + vLastName + '"' + printCodes.new_line;
                    code += 'A530,194,2,4,1,1,N,"' + ' ' + ' ' + ' Gender/ Age  :' + ' ' + vGender + ' / ' + vAge + ' Y ' + '"' + printCodes.new_line;
                    code += 'A530,163,2,4,1,1,N,"' + ' ' + ' ' + ' Visit Date :' + ' ' + vAppointmentDate + ' /  ' + vAppointmentTime + '"' + printCodes.new_line;
                    code += 'B520,72,2,1,4,12,40,B,"' + ' ' + ' ' + ' ' + ' ' + vMRN + '"' + printCodes.new_line;
                    // $scope.printRaw(printData);
                    code += noofprint > 1 ? 'P' + noofprint + printCodes.new_line : 'P1' + printCodes.new_line;
                } else if (window.barcodeclientcode.toLowerCase() == 'swostha') {
                ...
                } else if (window.barcodeclientcode.toLowerCase() == 'nkhospital-old') {
                    ...
                    code += 'TEXT 385,169,"0",180,10,10,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'TEXT 355,128,"0",180,10,10,"' + +vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    ...
                    code += 'A780,116,2,2,1,1,N,"DH ID No"' + printCodes.new_line;
                    code += 'A780,86,2,2,1,1,N,"OPV Date"' + printCodes.new_line;
                    ...
                    code += 'A675,177,2,2,1,1,N,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'A675,116,2,2,1,1,N,"' + vMRN + '"' + printCodes.new_line;
                    code += 'A675,147,2,2,1,1,N,"' + vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    code += 'A675,84,2,2,1,1,N,"' + vAppointmentDate + '"' + printCodes.new_line;
                    code += 'B689,54,2,1C,2,2,22,N,"' + vMRN + '"' + printCodes.new_line;
                    code += 'A370,185,2,2,1,1,N,"Name"' + printCodes.new_line;
                    code += 'A370,155,2,2,1,1,N,"Age/ Sex"' + printCodes.new_line;
                    code += 'A370,125,2,2,1,1,N,"DH ID No"' + printCodes.new_line;
                    code += 'A370,94,2,2,1,1,N,"OPV Date"' + printCodes.new_line;
                    ...
                    code += 'A266,185,2,2,1,1,N,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'A266,125,2,2,1,1,N,"' + vMRN + '"' + printCodes.new_line;
                    code += 'A266,155,2,2,1,1,N,"' + vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    code += 'A266,92,2,2,1,1,N,"' + vAppointmentDate + '"' + printCodes.new_line;
                    code += 'B326,62,2,1C,2,2,22,N,"' + vMRN + '"' + printCodes.new_line;
                    // start
                    ...
                    // code += 'CLS' + printCodes.new_line;
                    // code += 'CODEPAGE 1252' + printCodes.new_line;
                    // code += 'TEXT 386,185,"ROMAN.TTF",180,1,9,"Name"' + printCodes.new_line;
                    // code += 'TEXT 386,158,"ROMAN.TTF",180,1,9,"Age/ Sex"'+ printCodes.new_line;
                    // code += 'TEXT 386,133,"ROMAN.TTF",180,1,9,"DH ID No"' + printCodes.new_line;
                    // code += 'TEXT 386,104,"ROMAN.TTF",180,1,9," OPV Date "' + printCodes.new_line;
                    // code += 'TEXT 292,185,"0",180,2,9,":"' + printCodes.new_line;
                    // code += 'TEXT 292,158,"0",180,2,9,":"' + printCodes.new_line;
                    // code += 'TEXT 292,133,"0",180,2,9,":"' + printCodes.new_line;
                    // code += 'TEXT 292,104,"0",180,2,9,":"' + printCodes.new_line;
                    // code += 'TEXT 284,185,"ROMAN.TTF",180,1,9,"' + vTitle + ' ' + vFirstName + ' ' + vLastName + '"' + printCodes.new_line;
                    // code += 'TEXT 280,158,"ROMAN.TTF",180,1,9,"' +  vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    // code += 'TEXT 280,133,"ROMAN.TTF",180,1,9,"' + vMRN + '"' + printCodes.new_line;
                    //  code += 'TEXT 280,104,"ROMAN.TTF",180,1,9,"' + vAppointmentDate + '"' + printCodes.new_line;
                    //  code += 'BARCODE 375,72,"93",43,0,180,3,6,"' + vMRN + '"' + printCodes.new_line;
                    code += noofprint > 1 ? 'P' + noofprint + printCodes.new_line : 'P1' + printCodes.new_line;
                    //  //END
                    //  code += 'TEXT 243,24,"ROMAN.TTF",180,1,6,"' + vMRN + '"' + printCodes.new_line;
                    //$scope.printRaw(printData);
                    ...
                    code += 'Q200,25' + printCodes.new_line;
                    code += 'N' + printCodes.new_line;
                    code += 'A570,185,2,2,1,1,N,"Name"' + printCodes.new_line;
                    code += 'A570,155,2,2,1,1,N,"Age/ Sex"' + printCodes.new_line;
                    code += 'A570,125,2,2,1,1,N,"BCH ID"' + printCodes.new_line;
                    code += 'A570,95,2,2,1,1,N,"OPV Date"' + printCodes.new_line;
                    code += 'A570,65,2,2,1,1,N,"Doctor"' + printCodes.new_line;
                    code += 'A510,185,2,2,1,1,N,":"' + printCodes.new_line;
                    code += 'A475,155,2,2,1,1,N,":"' + printCodes.new_line;
                    code += 'A475,125,2,2,1,1,N,":"' + printCodes.new_line;
                    code += 'A475,95,2,2,1,1,N,":"' + printCodes.new_line;
                    code += 'A475,65,2,2,1,1,N,":"' + printCodes.new_line;
                    code += 'A500,185,2,2,1,1,N,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'A466,125,2,2,1,1,N,"' + vMRN + '"' + printCodes.new_line;
                    code += 'A466,155,2,2,1,1,N,"' + vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    code += 'A466,94,2,2,1,1,N,"' + vAppointmentDate + '"' + printCodes.new_line;
                    code += 'A466,65,2,2,1,1,N,"' + vDoctorName + '"' + printCodes.new_line;
                    ...
                    // code += "CLS" + printCodes.new_line;
                    // code += "CODEPAGE 1252" + printCodes.new_line;
                    // code += 'TEXT 720,340,"0",180,12,12,"' + ' Pat.Name : ' + vTitle + vFirstName + vLastName + '"' + printCodes.new_line;
                    // code += 'TEXT 720,290,"0",180,12,12,"' + ' Gender/ Age : ' + vGender + ' / ' + vAge + ' Y ' + '"' + printCodes.new_line;
                    // code += 'TEXT 720,240,"0",180,12,12,"' + ' VISIT NO / UHID : ' + vvisitNo + ' / ' + vMRN + '"' + printCodes.new_line;
                    // code += 'TEXT 720,190,"0",180,12,12,"' + ' Consultant DR : ' + vDoctorName + '"' + printCodes.new_line;
                    // code += 'TEXT 720,140,"0",180,12,12,"' + ' Reg.Date : ' + vRegisteredDate + '"' + printCodes.new_line;
                    // code += 'TEXT 720,140,"0",180,12,12,"' + ' Visit.Date : ' + vAppointmentDate + '"' + printCodes.new_line;
                    ...
                    code += 'Q200,25' + printCodes.new_line;
                    code += 'N' + printCodes.new_line;
                    code += 'A780,350,2,4,1,1,N,"Name"' + printCodes.new_line;
                    code += 'A780,300,2,4,1,1,N,"Age/ Sex"' + printCodes.new_line;
                    code += 'A780,250,2,4,1,1,N,"DH ID No"' + printCodes.new_line;
                    code += 'A780,200,2,4,1,1,N,"OPV Date"' + printCodes.new_line;
                    code += 'A780,150,2,4,1,1,N,"Doctor"' + printCodes.new_line;
                    code += 'A780,100,2,4,1,1,N,"Ref Doctor"' + printCodes.new_line;
                    code += 'A595,350,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A595,300,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A595,250,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A595,200,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A595,150,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A595,100,2,4,1,1,N,":"' + printCodes.new_line;
                    code += 'A575,350,2,4,1,1,N,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'A575,300,2,4,1,1,N,"' + vAge + "Y /" + vGender + '"' + printCodes.new_line;
                    code += 'A575,250,2,4,1,1,N,"' + vMRN + '"' + printCodes.new_line;
                    code += 'A575,200,2,4,1,1,N,"' + vRegisteredDate + '"' + printCodes.new_line;
                    code += 'A575,150,2,4,1,1,N,"' + vDoctorName + '"' + printCodes.new_line;
                    code += 'A575,100,2,4,1,1,N,"' + RefDoctorName + '"' + printCodes.new_line;
                    code += 'B689,70,2,1C,2,2,42,N,"' + vMRN + '"' + printCodes.new_line;
                    code += noofprint > 1 ? 'P' + noofprint + printCodes.new_line : 'P1' + printCodes.new_line;
                    ...
                    code += 'TEXT 565,286,"ROMAN.TTF",180,13,10,"UHID :"' + printCodes.new_line;
                    code += 'TEXT 485,287,"ROMAN.TTF",180,13,10,"' + vMRN + '"' + printCodes.new_line;
                    code += 'TEXT 565,254,"0",180,13,10,"Visit NO :"' + printCodes.new_line;
                    code += 'TEXT 445,254,"0",180,13,10,"' + vvisitNo + '"' + printCodes.new_line;
                    code += 'TEXT 565,218,"0",180,13,10,"Pat. Name :"' + printCodes.new_line;
                    code += 'TEXT 386,221,"0",180,13,10,"' + vTitle + '' + vFirstName + '' + vLastName + '"' + printCodes.new_line;
                    code += 'TEXT 565,187,"0",180,13,10,"Consultant :"' + printCodes.new_line;
                    code += 'TEXT 372,188,"0",180,13,10,"' + vDoctorName + '"' + printCodes.new_line;
                    code += 'TEXT 565,147,"0",180,13,10,"Gender/ Age :"' + printCodes.new_line;
                    code += 'TEXT 360,145,"0",180,13,10,"' + vGender + '"' + printCodes.new_line;
                    code += 'TEXT 236,145,"0",180,13,10,"' + vAge + "Y" + '"' + printCodes.new_line;
                    code += 'TEXT 559,112,"ROMAN.TTF",180,13,10,"Visit.D :"' + printCodes.new_line;
                    code += 'TEXT 379,112,"0",180,13,10,"' + vAppointmentDate + '"' + printCodes.new_line;
                    code += 'BAR 477,54, 5, 30' + printCodes.new_line;
                    code += 'BAR 468,54, 5, 30' + printCodes.new_line;
        ...
        $scope.printPatientLabel = function () {
            ...
            try {
                ...
                if (window.barcodeclientcode.toLowerCase() == 'lotus') {
                    ...
                    code += 'TEXT 598,381,"0",180,16,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,381,"0",180,11,11,"' + vMRN + '"' + printCodes.new_line;
                    code += 'TEXT 781,341,"0",180,11,11,"Visit Number"' + printCodes.new_line;
                    code += 'TEXT 598,341,"0",180,11,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,341,"0",180,11,11,"' + vVisitIdentifier + '"' + printCodes.new_line;
                    code += 'TEXT 771,301,"0",180,11,11,"PatientName"' + printCodes.new_line;
                    code += 'TEXT 598,301,"0",180,11,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,301,"0",180,11,11,"' + vTitle + " " + vFirstName + vLastName + '"' + printCodes.new_line;
                    ...
                    code += 'TEXT 598,221,"0",180,11,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,221,"0",180,11,11,"' + vGender + '"' + printCodes.new_line;
                    code += 'TEXT 781,182,"0",180,11,11,"Visit Date"' + printCodes.new_line;
                    code += 'TEXT 599,182,"0",180,11,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,182,"0",180,11,11,"' + vAppointmentDate + '"' + printCodes.new_line;
                    code += 'TEXT 781,142,"0",180,11,11,"Consultant"' + printCodes.new_line;
                    code += 'TEXT 599,142,"0",180,11,11,":"' + printCodes.new_line;
                    code += 'TEXT 573,142,"0",180,11,11,"' + vDoctorName1 + '"' + printCodes.new_line;
                    code += 'BARCODE 573,90,"93",50,0,180,3,6,"' + vMRN + '"' + printCodes.new_line;
                    code += "PRINT 1,1" + printCodes.new_line;
                    code += "<xpml></page></xpml><xpml><end/></xpml>" + printCodes.new_line;
                    $scope.printRaw(printData);
                    ...
                    code += "<xpml></page></xpml><xpml><end/></xpml>" + printCodes.new_line;
                    $scope.printRaw(printData);
                } else if (window.barcodeclientcode.toLowerCase() == 'sundaram') {
                    code += 'I8,A,001' + printCodes.new_line;
                    code += 'Q406,024' + printCodes.new_line;
                    code += 'q831' + printCodes.new_line;
                    code += 'rN' + printCodes.new_line;
        ...
        $scope.printVisitSlip = function () {
            if ($scope.AppointmentId) {
                ...
                //     billnum = $scope.BillInfo[0].BillNumber
                // }
                var inputData = {
        ...
        $scope.getPatientGuarantorCallback = function (scope, data, options, hasError) {
            if (data && data.PatientGuarantor) {
                ...
                if (data.PatientGuarantor.length == 1) {
                    $scope.NoGuarantor = true;
                }
                $scope.lookup['PatientGuarantor'] = data.PatientGuarantor;
                if ($scope.lookup.PatientGuarantor && $scope.lookup.PatientGuarantor.length > 1) {
                    ...
                    $scope.currentcontext.GuarantorTypeId = $scope.lookup.PatientGuarantor[1].GuarantorTypeId;
                    $scope.PatGuarantorNoofFreeVisit = $scope.lookup.PatientGuarantor[1].NooFVisitFree;
                }
                $scope.currentcontext.OldGuarantorId = $scope.item.GuarantorId;
                $scope.setDefaultService();
                // $timeout(function () {
                //     $scope.setDefaultService();
                // }, 1500);
        ...
        $scope.PatInfoCallback = function (scope, data, options, hasError) {
            ...
            $scope.item.PatientId = $scope.item.Id;
            $scope.item.RegisteredDate = $scope.item.RegisteredDate;
            // if ($scope.item.CreatedUser.Title) {
            //     $scope.item.Title = $scope.item.CreatedUser.Title.Description;
            // }
            // if ($scope.item.CreatedUser.FirstName) {
            //     $scope.item.FirstName = $scope.item.CreatedUser.FirstName;
            // }
            // if ($scope.item.CreatedUser.LastName) {
            //     $scope.item.LastName = $scope.item.CreatedUser.LastName;
            // }
            $scope.item.BannerPatientId = 0;
            ...
            if ($scope.item.Encounters && $scope.item.Encounters.length > 0) {
                var encounteritem = $scope.item.Encounters[0];
                if (encounteritem.AdmissionStatusId != 7) {
                    $scope.item.VisitTypeId = encounteritem.VisitTypeId;
                    $scope.item.IsNoBill = encounteritem.IsNoBill;
                    $scope.item.ReferredById = encounteritem.ReferralId;
                    $scope.item.ReferralId = encounteritem.ReferralId;
                    ...
                    if (encounteritem.EncounterTypeId == 2) {
                        ...
                        if ($scope.item.IsEmergencyPatient == true) {
                            if (encounteritem.EncounterTypeId == 1 && encounteritem.IsLatest == true) {
                            utl.Alert.showErrorMsg($translate.instant('Should not Create Visit for Emergency Patient!...'));
                            $scope.IsOpenEncounter = true;
                            return false;
                            }
                        }
            ...
            // if ($scope.item.Encounters && $scope.item.Encounters.length == 0) {
            if ($scope.item.ReferrerId > 0) {
                $scope.item.ReferralId = $scope.item.ReferrerId;
                if ($scope.disablereferral == 1) {
                    $scope.DisableReferral = true;
                }
            }
            $scope.item.ReferTypeId = $scope.item.ReferTypeId;
            // }
            // $scope.lookup["Referral"].$filter(function (item) {
            //     if (item.Id == $scope.item.ReferralId)
            //         $scope.item.ReferralTypeId = item.ReferralTypeId;
            // });
        ...
        $scope.SelectedGender = function (selectedItem) {
            $scope.item.GenderName = selectedItem.Text;
        };
        ...
        $scope.saveAndApprove = function () {
            if (!utl.Validator.validate($scope)) {
                $scope.showErrorMsg($translate.instant('Please fill all mandatory fields'));
                // console.log(document.getElementsByClassName('Please fill all mandatory fields'));
                return;
                // return;
            }
            if ($scope.item.IsAlternateMobileMandatory == true && !$scope.item.AlternateMobileNum) {
                utl.Alert.showErrorMsg('Please select Alternate Mobile');
                return false;
            }
            if ($scope.item.IsAlternateEmailMandatory == true && !$scope.item.Email) {
                utl.Alert.showErrorMsg('Please select  Email');
                return false;
            }
            ...
            if ($scope.item.PatientId > 0)
                var msg = 'Do You Want to Update for ' + $scope.item.FirstName;
            var confirmOptions = {
                headingKey: 'common.confirm-modal-header.lbl',
                messageKey: msg,
                yesKey: 'common.yeskey.lbl',
        ...
        $scope.savePatientInfoCallback = function (scope, data, options, hasError) {
            console.log('Success');
        };
        $scope.saveSwosthaPatient = function () {

            // if (!utl.Validator.validate($scope)) {
            //     return;
            // }
            // $scope.item.AadharNumber = '3232323232323223';
            ...
            var options = {
                ...
                type: 'post',
                onComplete: $scope.savePatientInfoCallback
            };
            utl.Http.doAction(options);
        }
        ...
        $scope.getBillDataforSave = function () {
            ...
            if ($scope.DefaultServiceInfo.length > 0) {
                ...
                try {
                    Outstandingamt = ((parseFloat(totamt) - parseFloat($scope.currentcontext.TotDiscAmount) +
                        parseFloat(RoundOffValue)) - (parseFloat(receiptamt)));
                } catch (ex) { }
        ...
        $scope.afterSave = function (data, options) {
            ...
            $scope.patientChange();
            // if (window.barcodeclientcode.toLowerCase() == 'gloom') {
            //     $timeout(function () {
            //         //$scope.printOPBill();
        ...
        $scope.saveItem = function () {
            ...
            if ($scope.IsOpenEncounter) {
                utl.Alert.showErrorMsg($translate.instant('registration.registrationcumvisit.openencounter.lbl'));
                return false;
            }
            ...
            if ($scope.DefaultServiceInfo.length > 0) {
                if (!$scope.currentcontext.PaymentTypeId || $scope.currentcontext.PaymentTypeId == -1) {
                    utl.Alert.showErrorMsg($translate.instant('Please Select Payment Type...'));
                    return;
                }
            }
            ...
            if ($scope.item.CountryId != 1) {
                if (!$scope.item.PasspostNumber || $scope.item.PasspostNumber == '') {
                    utl.Alert.showErrorMsg($translate.instant('Please Enter PassPort Number'));
                    return;
                }
            }
            if (!$scope.item.DoctorId) {
            ...
            if ($scope.adrsmandatory == 1) {
                if (!$scope.item.CountryId) {
                    utl.Alert.showErrorMsg($translate.instant('Please Select Country!...'));
                    return;
                }
            ...
            $scope.item.IsGuarantorChanged = false;
            $scope.item.GuarantorTypeId = $scope.currentcontext.GuarantorTypeId;
            if (($scope.currentcontext.OldGuarantorId != $scope.item.GuarantorId) || $scope.NoGuarantor == true) {
                $scope.item.IsGuarantorChanged = true;
            }
            ...
            if ($scope.item.Gender) {
                $scope.item.GenderName = $scope.item.Gender.Description;
            }
            $scope.item.AcutalGuarantorId = $scope.item.GuarantorId;
            $scope.SaveCompleted = true;
            ...
            $scope.feedbackData = {
                ...
                },
                {
                    name: "gender",
                    type: "string",
                    value: ($scope.item.GenderName) ? $scope.item.GenderName : "",
                    scope: "global"
                },
                {
                    name: "uhid",
                    type: "string",
                    value: ($scope.item.MRN) ? $scope.item.MRN : "",
                    scope: "global"
                },
                {
                    name: "opNumber",
                ...
                },
                {
                    ...
                    type: "string",
                    value: ($scope.item.AlternateMobileNum) ? $scope.item.AlternateMobileNum : $scope.item.Mobile,
                    scope: "global"
                },
                {
                    name: "email",
                ...
                },
                {
                    name: "dateOfBirth",
                    type: "date",
                    value: new Date($scope.item.DOB),
                    scope: "global"
                },
                {
                    name: "age",
                    type: "integer",
                    value: $scope.item.Age,
                    scope: "global"
                },
                ],
                returnVariables: false
            };
            if (!$scope.feedbackData.variables[13].value) {
                $scope.feedbackData.variables[13].value = new Date();
            }
            console.log($scope.feedbackData);
            // }
            // return;
        ...
        vm.membernocontrolconfig = {
            ...
            formatdisplay: formatselectedmemebershipno,
            presearch: presearchmemebershipno,
            postsearch: postsearchmembershipno
        };

        function formatselectedmemebershipno() {
            var selectedItem = vm.membernocontrolconfig.selected;
            var result = '';
            if (selectedItem && !utl.Common.isEmptyJSONObject(selectedItem)) {
                result = [selectedItem.FirstName].join(' ');
            } else if (vm.membernocontrolconfig.rowdata) {
                result = [vm.membernocontrolconfig.rowdata.FirstName].join(' ');
            }
            return result;
        }

        function presearchmemebershipno() {
            var query = vm.membernocontrolconfig.query;
            var inputData = {
                Params: [{
                    Key: 7,
                    Value: 2
            ...
            if (!$scope.allowotherfacpatients || $scope.allowotherfacpatients == 0) {
                inputData.Params.push({
                    Key: 29,
                    Value: utl.Session.getCurrentFacilityId()
                });
            }
            if (vm.membernocontrolconfig.searchbyid === true) {
                inputData.Params.push({
                    Key: 0,
                    Value: query
                });
            ...
            vm.membernocontrolconfig.searchparams = inputData;
        }

        function postsearchmembershipno() {
            for (var idx in vm.membernocontrolconfig.result) {
                var item = vm.membernocontrolconfig.result[idx];
                item.Title = item.Title.Description;
                item.PatientName = item.FirstName + ' ' + item.LastName;
                item.Mobile = item.Mobile;
                item.MRN = item.MRN;
                item.CardNumber = item.CardNo;
        ...
        function presearchdoctor() {
            ...
            var selectedDepartmentId = $scope.item.DepartmentId;
        ...
        $scope.clearSelectedDoctor = function () {
            $scope.item.DoctorId = null;
            $scope.item.DoctorName = null;
        };

        $scope.$watch('item.DepartmentId', function (newDepartmentId, oldDepartmentId) {
            if (newDepartmentId !== oldDepartmentId) {
                // $scope.clearSelectedDoctor(); // Clear selected doctor
                $scope.vm.doctorcontrolconfig.query = ''; // Clear doctor search query
            }
        }, true);

        $scope.changeDoctor = function () {
            if ($scope.autochargebasedondoctor == 1) {
                $scope.getDoctorDefaultService();
            }
        }
        ...
        $scope.getDoctorDefaultServiceCallback = function (scope, data, options, hasError) {
            ...
            $scope.DefaultServiceInfo = [];
            $scope.DefaultServiceTotalAmt = 0;
            $scope.TotBalanceAmt = 0;
            $scope.currentcontext.Received = 0;
            if (data) {
        ...
        $scope.getDoctorDefaultService = function () {
            ...
            if ($scope.autochargebasedondoctor) {
                if ($scope.item.DoctorId && $scope.item.DoctorId > 0) {
                    ...
                    if ($scope.item.AcutalGuarantorId == 0) {
                        $scope.item.AcutalGuarantorId = 1;
                    }
        ...
        $scope.getSelectedSchemeInfoCallback = function (scope, data, options, hasError) {
            $scope.CategoryPromotions = [];
            $scope.ItemPromotions = [];
            $scope.PromotionalSchemes = data.Data[0];
            $scope.PromotionalSchemeDetails = data.Data[0].PromotionalSchemeDetails;
        ...
        $scope.getSelectedSchemeInfo = function (item) {
            var inputData = {
                Params: [{
                    Key: 0,
                    Value: item.PromotionalSchemeId
                }]
            };
            var options = {
                ...
                data: inputData,
                type: 'post',
                onComplete: $scope.getSelectedSchemeInfoCallback
            };
            utl.Http.doAction(options);
        }
    ...
    regcumvisitwithbillController.$inject = ['$rootScope', '$scope', '$filter', '$timeout', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
