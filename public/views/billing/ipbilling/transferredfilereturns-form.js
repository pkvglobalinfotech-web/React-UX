(function () {
    ...
    angular
        .module('app.pages')
        .controller('TransferredFileReturnsFormController', TransferredFileReturnsFormController);

    function TransferredFileReturnsFormController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.backToList = function () {
            $state.go('app.transferredfilereturns');
        };
        ...
        $scope.saveAndApprove = function () {
            var confirmOptions = {
                headingKey: 'common.confirm-modal-header.lbl',
                messageKey: 'Do you want to return the file?',
                yesKey: 'common.yeskey.lbl',
                noKey: 'common.nokey.lbl',
        ...
        $scope.onSaveandApproveConfirmed = function () {
            $scope.item.MRDIPFileStatusId = 8;
            $scope.item.ReceivedBy = utl.Session.getCurrentUserId();
            $scope.item.ReceivedDate = utl.Formatter.getCurrentDate();
            $scope.saveItem();
        };
    ...
    TransferredFileReturnsFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
