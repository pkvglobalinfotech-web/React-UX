(function () {
    ...
    angular
        .module('app.pages')
        .controller('managecssditemsFormController', managecssditemsFormController);

    function managecssditemsFormController($scope, $stateParams, $state, $translate, utl, ) {
        var vm = this;
    ...
    managecssditemsFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
