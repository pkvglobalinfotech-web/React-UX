(function () {
    ...
    angular
        .module('app.pages')
        .controller('facilitypharmacyadmindashboardController', facilitypharmacyadmindashboardController);

    function facilitypharmacyadmindashboardController($rootScope, $scope, $timeout, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    facilitypharmacyadmindashboardController.$inject = ['$rootScope', '$scope', '$timeout', '$filter', '$stateParams', '$state', '$translate', 'utl'];
})();