(function () {
    ...
    angular
        .module('app.pages')
        .controller('PatientpendingorderController', PatientpendingorderController);

    function PatientpendingorderController($scope, $state, $translate, $filter, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.currentfilter.pid = parseInt(modalConfig.params.pid);
        $scope.drdetail = modalConfig.params.drData;
        $scope.slotdata = modalConfig.params.slotinfo;
    ...
    PatientpendingorderController.$inject = ['$scope', '$state', '$translate', '$filter', 'utl', '$uibModalInstance', 'modalConfig'];
