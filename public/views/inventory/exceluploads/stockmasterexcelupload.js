(function () {
    ...
    angular
        .module('app.pages')
        .controller('StockMasterExceluploadController', StockMasterExceluploadController);

    function StockMasterExceluploadController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    StockMasterExceluploadController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
