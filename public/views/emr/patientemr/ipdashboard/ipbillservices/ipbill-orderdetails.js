...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('ipbillorderdetailsController', ipbillorderdetailsController);

    function ipbillorderdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter, $timeout) {
        var vm = this;
    ...
    ipbillorderdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$filter', '$timeout'];
