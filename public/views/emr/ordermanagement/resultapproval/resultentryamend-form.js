(function () {
    ...
    angular
        .module('app.pages')
        .controller('ResultapproveAmendmentformController', ResultapproveAmendmentformController);

    function ResultapproveAmendmentformController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.confirmApproveOrder = function () {
            if (!$scope.item.Approvedbyid || $scope.item.Approvedbyid <= 0) {
    ...
    ResultapproveAmendmentformController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
