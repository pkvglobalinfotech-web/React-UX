(function() {
    ...
    angular
        .module('app.pages')
        .controller('otcnLabResultsSectionController', otcnLabResultsSectionController);

    function otcnLabResultsSectionController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    otcnLabResultsSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
