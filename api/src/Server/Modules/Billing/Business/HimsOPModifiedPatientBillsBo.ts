...
import { OPModifyPatBillsInstance, OPModifyPatBillsAttributes } from '../Model/Interface/Index';
import {
...
export class OPModifyPatBillsBo extends BaseBo<OPModifyPatBillsInstance,
    OPModifyPatBillsAttributes>  {
    ...
    public async getBillType(patientbillData: OPModifyPatBillsAttributes): Promise<string> {
        let vbillType = '';
        let apiReqBillType = {
            Id: 0,
            PageContext: { PageSize: 50, PageNumber: 1 },
    ...
    public async GetFindPharmacyBills(apiReq?: ApiRequest<PatientBillsFilters>):
        Promise<ApiResponse<OPModifyPatBillsAttributes[]>> {
    ...
    public async GetPatientPharmacyBills(apiReq?: ApiRequest<PatientBillsFilters>):
        ...
        include.push({ model: this.Models.OPModifyPatPaymentDetails, required: false });
        apiReq.Params.forEach((param) => {
            if (this.IsValidParam(param)) {
                switch (param.Key) {
                    case PatientBillsFilters.Id:
        ...
        include.push({
            model: this.Models.OPModifyPatBillDetails,
    ...
    public async GetPatientBills(apiReq?: ApiRequest<PatientBillsFilters>):
        ...
        include.push({
            model: this.Models.OPModifyPatPaymentDetails,
    ...
    public async DeletePatientBills(req: BaseRequest): Promise<Boolean> {
        let DetailBo = BoFactory.GetBo(billingBO.OPModifyPatBillDetailsBo, this.Request);
        let apiReq = {
            Id: 0,
    ...
    public async PrintPharmacyBills(req: BaseRequest): Promise<FileInfo> {
        ...
        let PatientBillDetailsBo = BoFactory.GetBo(bo.OPModifyPatBillDetailsBo, this.Request);
        let billdetailReq = {
            Id: 0,
            PageContext: { PageSize: -1, PageNumber: 1 },
        ...
        let PatientPaymentDetailsBo = BoFactory.GetBo(bo.OPModifyPatPaymentDetailsBo, this.Request);
    ...
    public GetModel(): SStatic.Model<OPModifyPatBillsInstance, OPModifyPatBillsAttributes> {
        return this.Models.OPModifyPatBills;
    }
