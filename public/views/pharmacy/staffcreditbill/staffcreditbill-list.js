(function () {
    ...
    angular
        .module('app.pages')
        .controller('StaffCreditBillListController', StaffCreditBillListController);

    function StaffCreditBillListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'edit') {
                $state.go('app.staffcreditbill', { id: entity.Id, pid: entity.PatientId });
            } else if (actionType == 'delete') {
                utl.Dialog.confirmDelete($scope.onDeleteConfirmed, entity.Id);
            } else if (actionType == 'view') {
                $state.go('app.staffcreditbill', { id: entity.Id, pid: entity.PatientId });
            }
            else if (actionType == 'staffreturn') {
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                { field: "BillNumber", displayName: $translate.instant('billing.pharmacy.bill#.lbl') },
                ...
                { field: "PatientBillStatus.Description", displayName: $translate.instant('billing.pharmacy.status.lbl') },
                {
                    field: "Id",
                    displayName: $translate.instant('billing.pharmacy.action.lbl'),
                    cellTemplate: '<div class="ui-grid-cell-contents">\
                                                    <span class="grid-action" uib-tooltip="View" tooltip-placement="bottom" ng-click="handleEvents(\'view\',entity)" ng-show="entity.PatientBillStatusId==2||entity.PatientBillStatusId==3||entity.PatientBillStatusId==4||entity.PatientBillStatusId==5"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                    <span class="grid-action" uib-tooltip="Edit" tooltip-placement="bottom" ng-click="handleEvents(\'edit\',entity)"ng-show="entity.PatientBillStatusId==1"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                    <span class="grid-action" uib-tooltip="Delete" tooltip-placement="bottom" ng-click="handleEvents(\'delete\',entity)" ng-show="entity.PatientBillStatusId==1"><img class="drhms-edit-button" src="assets/svg/delete.svg" alt=""></span>\
                                                    <span class="grid-action" uib-tooltip="Staff Return" tooltip-placement="bottom" ng-click="handleEvents(\'staffreturn\',entity)" ng-show="entity.PatientBillStatusId==3"><a><i class="fa fa-retweet" aria-hidden="true"></i></a></span>\
                                                </div>',
        ...
        $scope.getList = function () {
            ...
            var inputData = {
                Params: [
                    ...
                    { Key: 4, Value: $scope.currentfilter.PatientBillStatusId },
                    { Key: 57, Value: $scope.currentfilter.MRN },
                ],
                PageContext: {
        ...
        function setDefaults() {
            ...
            $scope.currentfilter.PatientBillStatusId = ApprovedId + "," + AuthorizedId + "," + CompletedId;
        }
    ...
    StaffCreditBillListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
