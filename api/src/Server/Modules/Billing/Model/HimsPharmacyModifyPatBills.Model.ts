...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.PharmacyModifyPatBillsInstance, i.PharmacyModifyPatBillsAttributes> {
    let PharmacyModifyPatBills =
        sequelize.define<i.PharmacyModifyPatBillsInstance, i.PharmacyModifyPatBillsAttributes>('PharmacyModifyPatBills', {
        ...
        },
            {
                indexes: [],
                timestamps: true,
                tableName: 'hims_pharmacymodifypatbills',
                createdAt: 'CreatedAt',
                updatedAt: 'UpdatedAt',
    ...
    (PharmacyModifyPatBills as any).associate = function (models: Models) {
        PharmacyModifyPatBills.hasMany(models.PharmacyModifyPatBillDetails, { foreignKey: 'PatientBillId' });
        PharmacyModifyPatBills.hasMany(models.PharmacyModifyPatPaymentDetails, { foreignKey: 'PatientBillId' });
        PharmacyModifyPatBills.hasMany(models.PatientBillSplitDetails, { foreignKey: 'PatientBillId' });
        PharmacyModifyPatBills.belongsTo(models.Patient);
        PharmacyModifyPatBills.belongsTo(models.User, { foreignKey: 'DoctorId' });
        PharmacyModifyPatBills.belongsTo(models.User, { as: 'PrivateDue', foreignKey: 'PrivateDueId' });
        PharmacyModifyPatBills.belongsTo(models.PatientGuarantor, { as: 'PatientGuarantor', foreignKey: 'GuarantorDueId' });
        PharmacyModifyPatBills.belongsTo(models.PatientGuarantor, { as: 'Guarantor', foreignKey: 'GuarantorId' });
        PharmacyModifyPatBills.belongsTo(models.Guarantor, { as: 'GuarantorMaster', foreignKey: 'GuarantorId' });
        PharmacyModifyPatBills.belongsTo(models.Encounter, { foreignKey: 'EncounterId' });
        PharmacyModifyPatBills.belongsTo(models.User, { as: 'CreatedUser', foreignKey: 'CreatedBy' });
        PharmacyModifyPatBills.belongsTo(models.User, { as: 'Updateduser', foreignKey: 'UpdatedBy' });
        PharmacyModifyPatBills.belongsTo(models.User, { as: 'CancelledUser', foreignKey: 'UpdatedBy' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'PatientBillStatus', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'BillPriority', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'GuarantorType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.Department, { foreignKey: 'DepartmentId' });
        PharmacyModifyPatBills.belongsTo(models.StoreMaster, { foreignKey: 'StoreMasterId' });
        PharmacyModifyPatBills.belongsTo(models.Facility, { foreignKey: 'FacilityId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'Title', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'Gender', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'ChecklistStatus', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.ReferenceValue, { as: 'EncounterType', targetKey: 'ReferenceValueCodeId' });
        PharmacyModifyPatBills.belongsTo(models.WardRoomMaster, { foreignKey: 'RoomId' });
        PharmacyModifyPatBills.belongsTo(models.WardRoomBedMaster, { foreignKey: 'BedId' });
        PharmacyModifyPatBills.belongsTo(models.WardMaster, { foreignKey: 'WardId' });
    };
    return PharmacyModifyPatBills;
}
