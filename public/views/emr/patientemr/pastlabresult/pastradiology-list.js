(function () {
    ...
    angular
        .module('app.pages')
        .controller('pastRadiologyListController', pastRadiologyListController);

    function pastRadiologyListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.getListCallback = function (scope, data, options, hasError) {
                ...
                for (var idx in data.Data) {
                    ...
                    if (data.Data[idx].TESTMASTERTYPId == 2) {
                        list = data.Data[idx];
        ...
        $scope.addNew = function () {
            $state.go('patientemr.pastradiologyresult', { id: 0, pid: $scope.currentcontext.pid});
        }
        ...
        $scope.handleEvents = function (actionType, row) {
            ...
            if (actionType == 'edit') {
                ...
                $state.go('patientemr.pastradiologyresult', { id: row.entity.Id, pid: row.entity.PatientId  });
            }
    ...
    pastRadiologyListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
