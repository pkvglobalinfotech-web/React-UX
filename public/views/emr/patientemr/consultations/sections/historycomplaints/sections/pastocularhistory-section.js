(function () {
    ...
    angular
        .module('app.pages')
        .controller('PastOcularHistorySectionController', PastOcularHistorySectionController);

    function PastOcularHistorySectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.onDeleteConfirmed = function (deleteId) {
            var options = {
                action: 'emr/PastOcularHistory/DeletePastOcularHistory',
                data: { Id: deleteId },
                type: 'post',
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.pastocularform', {
        ...
        $scope.getList = function () {
            ...
            var options = {
                action: 'emr/PastOcularHistory/GetPastOcularHistorys',
                data: inputData,
                type: 'post',
    ...
    PastOcularHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
