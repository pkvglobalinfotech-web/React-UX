(function () {
    ...
    angular
        .module('app.pages')
        .controller('RadiologyOrderDetailReportController', RadiologyOrderDetailReportController);

    function RadiologyOrderDetailReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            const JsonFields = ["Date", "Order No and Bill No", "Patient Type", "Patient Name", "MRN", "Doctor Name", "Test Name", "Test Code", "Department", "Status"]
            ...
            data.Data.forEach(function (rowArray) {
                ...
                if (rowArray.RequestDate) {
                    ...
                    date = $filter('date')(rowArray.RequestDate, 'yyyy-MM-dd') || null;
                }
                ...
                if (rowArray.BillNo) {
                    orderno = rowArray.BillNo;
                }
                 if (rowArray.PatientOrder.EncounterType) {
                if (rowArray.PatientOrder.EncounterType.Description) {
                    patientType = rowArray.PatientOrder.EncounterType.Description;
                }
                 }
                ...
                if (rowArray.Patient.MRN) {
                  ...
                  if (rowArray.PatientOrder.Doctor) {
                ...
                if (rowArray.Testmaster.Name) {
                    testName = rowArray.Testmaster.Name;
                }
                if (rowArray.Testmaster.Code) {
                    testCode = rowArray.Testmaster.Code;
                }
                if (rowArray.Department.DepartmentName) {
                    dept = rowArray.Department.DepartmentName;
                }
                if (rowArray.OrderStatus) {
                if (rowArray.OrderStatus.DisplayName) {
                    status = rowArray.OrderStatus.DisplayName;
                }
            }
                csvContent += date + ',' + orderno + ',' + patientType + ',' + patientName + ',' + mrn + ',' + docName + ',' + testName + ',' + testCode + ',' + dept + ',' + status + "\n";
            });
        ...
        $scope.excelDownload = function () {
            ...
            var options = {
                action: "patientemr/patientorderdetail/GetPatientOrderDetails",
                data: inputData,
                type: "post",
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'emr/patientorderdetail/PrintRadiologyDetailReport',
                data: inputData,
                type: 'post'
            };
        ...
        vm.gridConfig = {
            ...
            {
                field: "PatientOrder.EncounterType.Description",
    ...
    RadiologyOrderDetailReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
