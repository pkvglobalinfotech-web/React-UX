(function() {
    ...
    angular
        .module('app.pages')
        .controller('dailyrevbybillingreportController', dailyrevbybillingreportController);

    function dailyrevbybillingreportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
    ...
    dailyrevbybillingreportController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
