(function () {
    ...
    angular
        .module('app.pages')
        .controller('CollectionDetailByCashierReportController', CollectionDetailByCashierReportController);

    function CollectionDetailByCashierReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
                ...
                for (var idx in res.Data) {
                    ...
                    if (!PatientRefund.PharmacyReturnId || PatientRefund.PharmacyReturnId == null) {
                        ...
                        if (PatientRefund.PaymentTypeId == 1 && PatientRefund.RefundStatusId == 1) {
                            ...
                            && PatientRefund.PaymentTypeId != 11
                            && PatientRefund.PaymentTypeId != 12 && PatientRefund.RefundStatusId == 1) {
                            ...
                            $scope.TotalRefunds += PatientRefund.RefundAmount;
                        } else if (PatientRefund.PaymentTypeId == 12 && PatientRefund.RefundStatusId == 1) {
                        ...
                        if (PatientRefund.PaymentTypeId == 1) { // CASH
                            ...
                            NetBanking = 0;
                            Afford = 0;
                        } else if (PatientRefund.PaymentTypeId == 12) { // Afford
                            Cash = 0;
                            Card = 0;
                            ChequeOthers = 0;
                            NetBanking = 0;
                ...
                for (var idx in res.Data) {
                    ...
                    for (var payidx in PatientBill.PatientPaymentDetails) {
                        ...
                        if (PatientPaymentDetail.PaymentTypeId == 1 && PatientPaymentDetail.ReceiptStatusId == 3) {
                            ...
                            && PatientPaymentDetail.ReceiptStatusId == 3) {
                        ...
                        if (PatientPaymentDetail.PaymentTypeId == 1) { // CASH
                            ...
                            && PatientPaymentDetail.PaymentTypeId != 12) { // CHEQUE
                            Cash = 0;
                            Card = 0;
                            NetBanking = 0;
                            UPI = 0;
        ...
        $scope.getOPDGSalesListCallback = function (scope, res, options, hasError) {
            ...
            if (res && res.Data && res.Data.length > 0) {
                ...
                for (var idx in res.Data) {
                    ...
                    // if (PatientPaymentDetail.Patient && PatientPaymentDetail.Patient.MRN) {
                    //     PatientName += ' ' + PatientPaymentDetail.Patient.MRN;
                    // }
                    if (PatientPaymentDetail.Patient && PatientPaymentDetail.Patient.MRN) {
                    ...
                    if ($scope.currentfilter.UserId == -1 || $scope.currentfilter.UserId == PatientPaymentDetail.CreatedBy) {
                        if (PatientPaymentDetail.PaymentTypeId == 1 && PatientPaymentDetail.ReceiptStatusId == 1) {
                            ...
                            && PatientPaymentDetail.PaymentTypeId != 7 && PatientPaymentDetail.PaymentTypeId != 10
                            && PatientPaymentDetail.PaymentTypeId != 11 && PatientPaymentDetail.PaymentTypeId != 12 && PatientPaymentDetail.ReceiptStatusId == 1) {
                            ChequeOthers = PatientPaymentDetail.AmountPaid;
                        ...
                        if (PatientPaymentDetail.PaymentTypeId == 1) { // CASH
                            ...
                            PatientPaymentDetail.PaymentTypeId != 6 && PatientPaymentDetail.PaymentTypeId != 10 &&
                            PatientPaymentDetail.PaymentTypeId != 11) { // CHEQUE & OTHERS
                            Cash = 0;
                            Card = 0;
                            NetBanking = 0;
                            UPI = 0;
        ...
        $scope.print = function () {
            var inputData = {
                Data: {
                    ...
                    PaymentTypeId: $scope.currentfilter.PaymentTypeId,
    ...
    CollectionDetailByCashierReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
