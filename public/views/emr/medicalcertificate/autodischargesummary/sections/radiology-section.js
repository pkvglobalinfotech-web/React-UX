...
(function () {
    ...
    angular
        .module('app.pages')
        .controller('disradiologySectionController', disradiologySectionController);

    function disradiologySectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.radiologyresults';
    ...
    disradiologySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
