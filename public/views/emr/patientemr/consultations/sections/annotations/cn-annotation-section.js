(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnAnnotationSectionController', cnAnnotationSectionController);

    function cnAnnotationSectionController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
    ...
    cnAnnotationSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
