(function () {
    ...
    angular
        .module('app.pages')
        .controller('deseasedpatientreportController', deseasedpatientreportController);

    function deseasedpatientreportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.excelDownloadCallbackExcel = function (scope, data, options, hasError) {
            const JsonFields = ["DOA", "DOD", "IP Number", "Patient Name", "MRN", "Room Details", "Doctor Name", "Payer Name", "Department"]
            ...
            data.Data.forEach(function (rowArray) {
                ...
                csvContent += admdate + ',' + discharge + ',' + visitno + ',' + patname + ',' + mrn + ',' + ward + ',' + docname + ',' + insurance + ',' + dept + "\n";
            });
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintDeseasedPatientReport',
                data: inputData,
                type: 'post'
            };
    ...
    deseasedpatientreportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
