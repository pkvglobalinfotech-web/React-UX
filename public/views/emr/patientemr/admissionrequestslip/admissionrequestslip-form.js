(function () {
    ...
    angular
        .module('app.pages')
        .controller('admissionrequestslipformController', admissionrequestslipformController);

    function admissionrequestslipformController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        $scope.item = {
            IsActive: true,
    ...
    admissionrequestslipformController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
