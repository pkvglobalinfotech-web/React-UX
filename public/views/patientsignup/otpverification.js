(function () {
    ...
    angular
        .module('app.pages')
        .controller('OtpVerifyController', OtpVerifyController);

    function OtpVerifyController($rootScope, $scope, $timeout, $stateParams, $state, $translate, utl, Upload, $cookies) {
        var vm = this;
        ...
        $scope.lookupCallback = function (scope, data, options, hasError) {
            forEach(data, function (value, key) {
                ...
                if (key == 'Facility' && $scope.item.FacilityId === 1) {
                    $scope.item.FacilityId = value[1].Id;
                    $scope.item.FacilityName = value[1].Text;
                }
            });
        };
    ...
    OtpVerifyController.$inject = ['$rootScope', '$scope', '$timeout', '$stateParams', '$state', '$translate', 'utl', 'Upload', '$cookies'];
