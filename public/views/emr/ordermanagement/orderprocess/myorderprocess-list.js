(function() {
    ...
    function myOrderProcessListController($rootScope, $timeout, $scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;

        $scope.Items = [];
        $scope.currentfilter = {
            TestTypeId: $stateParams.tp ? parseInt($stateParams.tp) : -1,
            WorkOrderStatusId: 2, //Assigned
        ...
        var actions = {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">\
                 ...
                 <span class="grid-action" title="Work Sheet" ng-click="handleEvents(\'worksheet\',entity)"><i class="fa fa-file-text-o btn btn-warning btn-rounded" aria-hidden="true"></i></span>\
                 </div>',
            handleEvent: $scope.handleEvents,
        };
    ...
    myOrderProcessListController.$inject = ['$rootScope', '$timeout', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
