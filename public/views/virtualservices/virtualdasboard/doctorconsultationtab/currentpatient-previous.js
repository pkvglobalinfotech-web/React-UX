(function () {
    ...
    angular
        .module('app.pages')
        .controller('DocPreviousPatientsController', DocPreviousPatientsController);

    function DocPreviousPatientsController($scope, $stateParams, $state, $translate, $filter, utl, uibButtonConfig, $timeout) {
        var vm = this;
    ...
    DocPreviousPatientsController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl', 'uibButtonConfig', '$timeout'];
