...
export interface OPModifyPatPaymentDetailsAttributes extends IAttributes {
    Id: number;
...
export interface OPModifyPatPaymentDetailsInstance extends Instance<OPModifyPatPaymentDetailsAttributes> {
    // I'm exposing every DB column as an instance field to so that tsc won't complain.
    // CreatedAt: Date;
    // UpdatedAt: Date;
    dataValues: OPModifyPatPaymentDetailsAttributes;
}
