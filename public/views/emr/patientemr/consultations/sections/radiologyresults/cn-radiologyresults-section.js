(function() {
    ...
    angular
        .module('app.pages')
        .controller('cnRadiologyResultsSectionController', cnRadiologyResultsSectionController);

    function cnRadiologyResultsSectionController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cnRadiologyResultsSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
