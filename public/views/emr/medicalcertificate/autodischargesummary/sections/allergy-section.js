(function () {
    ...
    angular
        .module('app.pages')
        .controller('disallergySectionController', disallergySectionController);

    function disallergySectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;

        var SRef = 'emr.cn.allergy';
    ...
    disallergySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
