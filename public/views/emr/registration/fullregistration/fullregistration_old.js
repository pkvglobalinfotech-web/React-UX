    ...
    function fullRegistrationFormController($scope, $timeout, $stateParams, $state, $translate, utl, Upload) {
        ...
        $scope.vitals = function () {
            utl.Modal.open('patientemr.patientvital', {
                params: { id: 0, pid: $scope.currentcontext.id, encounter: $scope.Encounter.Id },
        ...
        $scope.getItem = function (pageNo) {
            if ($scope.currentcontext.id && $scope.currentcontext.id > 0) {
                ...
                $scope.tabvm.currentcontext.patientid = $scope.currentcontext.id;
        ...
        vm.occupationcontrolconfig = {
            ...
            searchbyid: false,
            options: [
                { header: 'Occupation Id', field: 'OccupationId', datatype: 'string', headercls: 'td-code', fieldcls: 'td-code' },
                { header: 'Occupation Code', field: 'Code', datatype: 'string', headercls: 'td-name', fieldcls: 'td-name' },
                { header: 'Occupations', field: 'Occupations', datatype: 'string', headercls: 'td-Occupations', fieldcls: 'td-Occupations' },
                { header: 'Type', field: 'OccupationType', datatype: 'string', headercls: 'td-type', fieldcls: 'td-type' }
            ],
            searchparams: {},
            result: {},
        ...
        function formatselectedoccupation() {
            ...
            if (selectedItem && !utl.Common.isEmptyJSONObject(selectedItem)) {
                ...
                result = [vm.occupationcontrolconfig.rowdata.OccupationId, vm.occupationcontrolconfig.rowdata.Code
                ].join(' ');
            }
