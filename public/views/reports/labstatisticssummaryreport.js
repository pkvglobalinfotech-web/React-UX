(function () {
    ...
    angular
        .module('app.pages')
        .controller('LabStatisticsSummaryReportController', LabStatisticsSummaryReportController);

    function LabStatisticsSummaryReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    LabStatisticsSummaryReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
