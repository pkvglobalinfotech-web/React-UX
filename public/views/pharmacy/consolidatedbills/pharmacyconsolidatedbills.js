(function () {
    ...
    angular
        .module('app.pages')
        .controller('pharmabilldetailsController', pharmabilldetailsController);

    function pharmabilldetailsController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    pharmabilldetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
