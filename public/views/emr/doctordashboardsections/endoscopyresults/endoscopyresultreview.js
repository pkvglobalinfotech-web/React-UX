(function () {
    ...
    angular
        .module('app.pages')
        .controller('EndoscopyResultreviewFormController', EndoscopyResultreviewFormController);

    function EndoscopyResultreviewFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    EndoscopyResultreviewFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
