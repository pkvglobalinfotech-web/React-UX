(function () {
    ...
    angular
        .module('app.pages')
        .controller('CollectionReportController', CollectionReportController);

    function CollectionReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'billing/PatientPaymentDetails/PrintCollectionReport',
                data: inputData,
                type: 'post'
            };
    ...
    CollectionReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
