...
(function (a) {
    ...
    a.extend(a.jqx._jqxScheduler.prototype, {
        ...
        _rendercelltexts: function () {
            var c = String.fromCharCode(119, 119, 119, 46, 106, 113, 119, 105, 100, 103, 101, 116, 115, 46, 99, 111, 109);
        ...
        _renderToolBar: function () {
            var i = this;
            var b = a('<div class="head1" style="width: 100%; height: 100%; position: relative;"></div>');
            ...
            i.dateTimeInput = a('<div class="minicala" style="outline: none; padding: 0px; margin-top: 0px;margin-left: 57px; margin-right: 3px; width: 27px; float: left;"></div>');
            i.toolbarLeftButton.find(".jqx calender").remove();
            i.toolbarRightButton.find("").remove();
            var e = a("<div style='outline: none; margin-left: 6px; width: 15px; height: 15px;'> <span>Previous</span></div>");
            e.addClass(i.toThemeProperty("jqx next"));
            i.toolbarLeftButton.wrapInner(e);
            var j = a("<div style='outline: none; margin-left: 9px; width: 15px; height: 15px;'><span>Next</span> </div>");
            j.addClass(i.toThemeProperty("qx previous"));
            ...
            i.toolbarViews = a('<div class="weeks" style="margin-right: 10px; margin-top:0px; float: right;"></div>');
            if (i.rtl) {
        ...
        addAppointment: function (n) {
            ...
            if (!n.duration) {
                if ((!n.from && !n.to) || (!n.appointmentObject)) {
                    var f = n;
                    var d = {};
