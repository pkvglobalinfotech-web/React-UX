(function() {
    ...
    angular
        .module('app.pages')
        .controller('cathlabscheduleListController', cathlabscheduleListController);

    function cathlabscheduleListController($rootScope, $timeout, $scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
        $scope.context = 'main';
        ...
        $scope.addNew = function() {
            $state.go('app.cathlabscheduleform', { id: 0 });
            // $scope.openModal(0);
        }
        ...
        $scope.handleEvents = function(actionType, entity) {
            ...
            if (actionType == 'edit' || actionType == 'view') {
                $state.go('app.cathlabscheduleform', { id: entity.Id, pid: entity.PatientId, eid: entity.EncouterId });
    ...
    cathlabscheduleListController.$inject = ['$rootScope', '$timeout', '$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
