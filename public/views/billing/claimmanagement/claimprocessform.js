(function () {
    ...
    angular
        .module('app.pages')
        .controller('claimprocessFormController', claimprocessFormController);

    function claimprocessFormController($rootScope, $scope, $timeout, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        $scope.currentfilter = {
        ...
        $scope.handleEvents = function (actionType, row) {
            if (actionType == 'claim') {
                $state.go('app.claimsubmission-form', { id: row.entity.Id })
        ...
        //         {
        //             field: "SubmittedOn",
        //             displayName: $translate.instant('billing.claimsubmission-form.invoicenumber.lbl'),
        //             cellTemplate: "<div class='ui-grid-cell-contents'><span class='pl-3'>{{row.entity.SubmittedOn | date : 'dd-MMM-yyyy'}}&nbsp;</span>"
        //                 + "<span class='pl-3'>{{row.entity.SubmittedOn| date: 'HH:mm'}}</span>" + "</div>"
        //         },
        //         {
        //             field: "ClaimNumber", displayName: $translate.instant('billing.claimprocess.claimno.lbl')
        //         },
        //         {
        //             field: "Guarantor.GuarantorName", displayName: $translate.instant('billing.receiptpicker.date.lbl')
        //         },
        //         {
        //             field: "ClaimAmount",
        //             displayName: $translate.instant('billing.opbilling-list.department.lbl'),
        //             cellTemplate: '<div class="ui-grid-cell-contents" >' + '<span>{{row.entity.ClaimAmount | displaycurrency}}</span>' + '</div>'
        //         },
        //         {
        //             field: "Createdy",
        //             displayName: $translate.instant('billing.claimprocess.crossamount.lbl'),
        //             cellTemplate: "<div class='ui-grid-cell-contents'>" +
        //                 "<span class='pl-3'>{{row.entity.CreatedUser.Title.Description}}&nbsp;</span>" +
        //                 "<span class='pl-3'>{{row.entity.CreatedUser.FirstName}}&nbsp;</span>" +
        //                 "<span class='pl-3'>{{row.entity.CreatedUser.LastName}}&nbsp;</span>" +
        //                 "</span></div>"
        //         },
        //         { field: "ClaimSubmissionStatus.Description", displayName: $translate.instant('billing.claimprocess.disamount.lbl') },
        //         { field: "ClaimSubmissionStatus.Description", displayName: $translate.instant('billing.claimprocess.detamount.lbl') },
        //         { field: "ClaimSubmissionStatus.Description", displayName: $translate.instant('billing.claimprocess.Ins.Amount.lbl') },
        //         {
        //             field: "Id",
        //             displayName: $translate.instant('common.actions_col.lbl'),
        //             cellTemplate: '<div class="ui-grid-cell-contents">\
    ...
    claimprocessFormController.$inject = ['$rootScope', '$scope', '$timeout', '$stateParams', '$state', '$translate', 'utl', '$filter'];
