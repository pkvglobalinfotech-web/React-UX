(function () {
    ...
    function purchaseOrdersListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.currentfilter.FromDate.setDate($scope.currentfilter.FromDate.getDate() - 7);
        ...
        $scope.currentcontext.CanAmend = $scope.HasAccess('PurchaseOrder_Buttons', 'CAN_AMENDPOLIST');
        $scope.currentcontext.CanApprove = $scope.HasAccess('PurchaseOrder_Buttons', 'CAN_APPROVEPOLIST');
        function initDynamicForm() {
            ...
            $scope.advancedFilterSchema = {
                ...
                controls: [{
                        type: 'date',
                        translate: 'inventory.purchaserequest.fromdate.lbl',
                        model: 'From',
                        position: {
                            r: 0,
                            c: 0
                    ...
                    {
                        type: 'date',
                        translate: 'inventory.purchaserequest.todate.lbl',
                        model: 'To',
                        position: {
                            r: 0,
                            c: 1
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaserequest.fromstore.lbl',
                        model: 'StoreId',
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaserequest.tostore.lbl',
                        model: 'ToStoreId',
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaserequest.approvedby.lbl',
                        model: 'ApprovedBy',
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaserequest.authorizedby.lbl',
                        model: 'AuthorizedBy',
                        options: $scope.lookup.AuthorizedUser,
                        position: {
                            r: 2,
                            c: 1
                        }
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaseorder.fromfacility.lbl',
                        model: 'FromFacilityId',
                        options: $scope.lookup.FromFacility,
                        position: {
                            r: 3,
                            c: 0
                        }
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaseorder.tofacility.lbl',
                        model: 'ToFacilityId',
                        options: $scope.lookup.ToFacility,
                        position: {
                            r: 3,
                            c: 1
                        }
                    ...
                    {
                        type: 'select',
                        translate: 'inventory.purchaseorders.type.lbl',
                        model: 'PoTypeId',
        ...
        $scope.getListCallback = function (scope, data, options, hasError) {
            ...
            for (var idx in data.Data) {
                ...
                item.showAmend = $scope.currentcontext.CanAmend ? 1 : 0;
                item.showApprove = $scope.currentcontext.CanApprove ? 1 : 0;
                vm.gridConfig.data.push(item);
            }
            $scope.TotalNetamount = totalnetamount;
            vm.gridConfig.pagerObj.totalItems = data.PageContext.TotalRecords;
        };
        $scope.defaultgetList = function () {
            $scope.currentfilter.PoNumber = '';
            $scope.currentfilter.FromDate = '';
            $scope.currentfilter.ToDate = '';
            $scope.currentfilter.VendorMasterId = -1;
            $scope.currentfilter.PoStatusId = -1;
            ...
            var inputData = {
                Params: [{
                        Key: 1,
                        Value: $scope.currentfilter.PoNumber
                    },
                    {
                        Key: 3,
        ...
        $scope.getList = function () {
            if ($scope.currentfilter.PoNumber) {
                $scope.currentfilter.FromDate = '';
                $scope.currentfilter.ToDate = '';
                $scope.currentfilter.VendorMasterId = -1;
            }
            ...
            var inputData = {
                Params: [{
                    ...
                    {
                        Key: 2,
                        Value: $scope.advancedfilter.PoTypeId
                    },
                    {
                        Key: 3,
                        Value: $scope.currentfilter.VendorMasterId
        ...
        $scope.Approve = function (entity) {
            var actionName = 'pharmacy/purchaseorder/UpdatePurchaseOrder';
            var inputData = {
                Header: {
                    Id: entity.Id,
                    PoStatusId: 3,
                    AuthorizedBy: utl.Session.getCurrentUserId(),
                    AuthorizedDate: utl.Formatter.getCurrentDate()
                },
            };
            var options = {
                action: actionName,
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'edit') {
                ...
                $state.go('app.purchaseorder-amendment', {
                    id: entity.Id,
                    poid: entity.Id
                });
                ...
                //     yesKey: 'common.yeskey.lbl',
                //     noKey: 'common.nokey.lbl',
                //     onSuccessMethod: $scope.Approve,
                // };
                // utl.Dialog.confirmMessage(confirmOptions);
                $scope.Approve(entity);
            }
        };
        ...
        vm.gridConfig = {
            ...
            columnDefs: [{
                ...
                {
                    field: "PoNumber",
                    displayName: $translate.instant('inventory.purchaseorders.po#.lbl')
                },
                ...
                {
                    field: "VendorName",
                    displayName: $translate.instant('inventory.purchaseorders.vendorname.lbl')
                },
                {
                ...
                // }
                {
                    ...
                    cellTemplate: '<div class="ui-grid-cell-contentsname">\
                                                    <span class="grid-action" uib-tooltip="View" tooltip-placement="bottom" ng-click="handleEvents(\'view\',entity)"  ng-show="entity.PoStatusId==2||entity.PoStatusId==3||entity.PoStatusId==4||entity.PoStatusId==5||entity.PoStatusId==6"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                    <span class="grid-action" uib-tooltip="Edit" tooltip-placement="bottom" ng-click="handleEvents(\'edit\',entity)"  ng-show="entity.PoStatusId==1||entity.PoStatusId==6"><img class="drhms-edit-button" src="assets/svg/edit.svg" aria-hidden="true"></span>\
                                                    <span class="grid-action can-{{entity.showAmend}}" uib-tooltip="Amend" tooltip-placement="bottom" ng-click="handleEvents(\'amend\',entity)" ng-show="entity.PoStatusId==2||entity.PoStatusId==3"><i class="fas fa-calendar-plus"></i></button></span>\
                                                    <span class="grid-action can-{{entity.showApprove}}" uib-tooltip="Approve" tooltip-placement="bottom" ng-click="handleEvents(\'approve\',entity)" ng-show="entity.PoStatusId==2">Approve</button></span>\
        ...
        function setDefaults() {
            ...
            var SaveId = utl.Lookup.getDefault($scope.lookup.PoStatus, 'Save');
            ...
            $scope.currentfilter.PoStatusId = SaveId + "," + ApprovedId + "," + CompletedId;
            // $scope.currentfilter.PoStatusId = SaveId + "," + ApprovedId + CompletedId;
        }
    ...
    purchaseOrdersListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
