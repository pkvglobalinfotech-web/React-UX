...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.CategoryRevenueInstance, i.CategoryRevenueAttributes> {
    let CategoryRevenue = sequelize.define<i.CategoryRevenueInstance, i.CategoryRevenueAttributes>('CategoryRevenue', {
