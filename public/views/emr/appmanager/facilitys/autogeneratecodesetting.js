(function () {
    ...
    angular
        .module('app.pages')
        .controller('autogeneratecodesettingFormController', autogeneratecodesettingFormController);

    function autogeneratecodesettingFormController($scope, $stateParams, $state, $translate, utl, jsonPath) {
    ...
    autogeneratecodesettingFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'jsonPath'];
