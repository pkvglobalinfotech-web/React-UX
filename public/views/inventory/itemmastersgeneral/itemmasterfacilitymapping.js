(function () {
    ...
    angular
        .module('app.pages')
        .controller('generalitemmasterFacilityMapController', generalitemmasterFacilityMapController);

    function generalitemmasterFacilityMapController($scope, $stateParams, $state, $translate) {
    ...
    generalitemmasterFacilityMapController.$inject = ['$scope', '$stateParams', '$state', '$translate'];
