(function() {
    ...
    angular
        .module('app.pages')
        .controller('newitemPriceController', newitemPriceController);

    function newitemPriceController($scope, $stateParams, $state, $translate, utl,$uibModalInstance, modalConfig) {
        var vm = this;
    ...
    newitemPriceController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl','$uibModalInstance','modalConfig'];
