(function() {
    ...
    angular
        .module('app.pages')
        .controller('cnLabResultsSectionController', cnLabResultsSectionController);

    function cnLabResultsSectionController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cnLabResultsSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
