(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnClinicalNoteSectionController', cnClinicalNoteSectionController);

    function cnClinicalNoteSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    cnClinicalNoteSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
