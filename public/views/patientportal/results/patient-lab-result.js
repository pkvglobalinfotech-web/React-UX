(function() {
    ...
    angular
        .module('app.pages')
        .controller('patientLabResultController', patientLabResultController);

    function patientLabResultController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    patientLabResultController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
