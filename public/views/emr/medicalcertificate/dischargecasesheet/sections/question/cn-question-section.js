(function() {
    ...
    angular
        .module('app.pages')
        .controller('discasshtcnQuestionSectionController', discasshtcnQuestionSectionController);

    function discasshtcnQuestionSectionController($scope, $stateParams, $state, $translate, utl, uibButtonConfig, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    discasshtcnQuestionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'uibButtonConfig', '$uibModalInstance', 'modalConfig'];
