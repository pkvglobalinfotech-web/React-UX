(function () {
    ...
    angular
        .module('app.pages')
        .controller('MasterBillingReportController', MasterBillingReportController);

    function MasterBillingReportController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
