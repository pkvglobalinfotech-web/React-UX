(function () {
    ...
    angular
        .module('app.pages')
        .controller('ReorderListController', ReorderListController);

    function ReorderListController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.itemmastertab.itemmaster', { id: 0 });
        };
        ...
        $scope.openModal = function (Id) {
            utl.Modal.openFixedDialog('app.reordersetupform', {
                params: { id: Id },
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'edit') {
                $scope.openModal(entity.Id, entity.ItemMasterId, entity.ItemCode, entity.ItemName);
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                // { field: "ItemName", displayName: $translate.instant('inventory.itemmasters.name.lbl') },
                { field: "ItemMaster.ItemCategory.CategoryName", displayName: $translate.instant('inventory.itemmasters.categoryid.lbl') },
                { field: "ItemMaster.ItemSubCategory.SubCategoryName", displayName: $translate.instant('inventory.itemmaster.subcategoryId.lbl') },
                { field: "ItemMaster.GenericMaster.GenericName", displayName: $translate.instant('inventory.itemmasters.genericid.lbl') },
                { field: "ItemMaster.ProductType.ProductTypeName", displayName: $translate.instant('inventory.itemmasters.producttypeid.lbl') },
    ...
    ReorderListController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
