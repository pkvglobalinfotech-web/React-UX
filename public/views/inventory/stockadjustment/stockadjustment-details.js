(function() {
    ...
    angular
        .module('app.pages')
        .controller('stockadjustmentdetailsController', stockadjustmentdetailsController);

    function stockadjustmentdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    stockadjustmentdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
