(function () {
    ...
    angular
        .module('app.pages')
        .controller('otcnSocialHistorySectionController', otcnSocialHistorySectionController);

    function otcnSocialHistorySectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    otcnSocialHistorySectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
