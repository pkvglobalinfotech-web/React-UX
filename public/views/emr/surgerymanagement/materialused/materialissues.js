(function () {
    ...
    angular
        .module('app.pages')
        .controller('MaterialissueController', MaterialissueController);

    function MaterialissueController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        if (modalConfig && modalConfig.params) {
            $scope.currentcontext.id = parseInt(modalConfig.params.historyid);
        ...
        $scope.onBatchSelected = function (pharmacyItem, selectedMasterItem, idx) {
            ...
            if (modified == -1) {
                ...
                utl.Alert.showErrorMsg('This Batch Already Selected for ' + pharmacyItem.ItemName);
        ...
        $scope.ServiceItemChanged = function (idx, selectedItem) {
            ...
            if (SelectedMasterItem.ItemMaster.StockItem &&
                ...
                if (selectedItem.BatchDetails && selectedItem.BatchDetails.length > 0) {
                    ...
                    utl.Alert.showErrorMsg('Either All Batches Selected (or) No Batch for ' + selectedItem.ItemName);
                    return false;
                }
            }
    ...
    MaterialissueController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
})();