(function () {
	...
	angular
		.module('common.utils')
		.controller('portalpatientbannerCtrl', ['utl', '$scope', '$timeout', '$filter', function (utl, $scope, $timeout, $filter) {
			var cvm = this;
			cvm.patientinfo = {};
			cvm.currentcontext = {};
		...
		.component('portalpatientbanner', {
			bindings: {
				patientid: "=",
				encounterid: "=",
				delegatefn: "&"
			},
			controller: 'portalpatientbannerCtrl',
			controllerAs: 'cvm',
			templateUrl: 'vendor/components/portalpatientbanner.html'
		})
