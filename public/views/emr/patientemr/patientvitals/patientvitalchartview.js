(function () {
    ...
    angular
        .module('app.pages')
        .controller('patientVitalChartviewController', patientVitalChartviewController);

    function patientVitalChartviewController($scope, $filter, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    patientVitalChartviewController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
