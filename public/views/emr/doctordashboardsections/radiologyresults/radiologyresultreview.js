(function () {
    ...
    angular
        .module('app.pages')
        .controller('RadiologyResultReviewFormController', RadiologyResultReviewFormController);

    function RadiologyResultReviewFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    RadiologyResultReviewFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
