...
export default function (sequelize: Sequelize, DataTypes: DataTypes):
    SequelizeStatic.Model<i.IPPackageServiceExclusionInstance, i.IPPackageServiceExclusionAttributes> {
    let IPPackageServiceExclusion = sequelize.define<i.IPPackageServiceExclusionInstance,
        i.IPPackageServiceExclusionAttributes>('IPPackageServiceExclusion', {
            Id: { type: DataTypes.BIGINT, field: 'IPPackageServiceExclusionId', primaryKey: true, autoIncrement: true },
        ...
        },
            {
                indexes: [],
                timestamps: true,
                tableName: 'ippackageserviceexclusions',
                createdAt: 'CreatedAt',
                updatedAt: 'UpdatedAt',
    ...
    return IPPackageServiceExclusion;
}
