(function () {
    ...
    angular
        .module('app.pages')
        .controller('OPSalesReportController', OPSalesReportController);

    function OPSalesReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
    ...
    OPSalesReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
