        ...
        $scope.saveItem = function () {
            ...
            if (checkMandatoryFields()) {
                ...
                if ($scope.jssgrn == 1) {
                    ...
                    if (makeRoundOff(parseFloat($scope.item.TotalGstAmount).toFixed(2)) > (makeRoundOff(parseFloat($scope.item.TotalSGstAmount).toFixed(2) + parseFloat($scope.item.TotalCGstAmount).toFixed(2)))) {
            ...
            if (parseFloat(item.UomPrice) === 0 || item.UomPrice === undefined || item.UomPrice === null) {
                ...
                if (item.DiscountMode1Id == 1) {
                    if (parseFloat(item.Discount1) <= parseFloat(item.UomPrice)) {
                        ...
                        item.UomPriceAfterDiscount = parseFloat(item.UomPrice) * parseFloat(item.GrnQuantityAfterConversion) - item.UomDiscountAmount;
                        item.PurchasePriceAfterDiscount = parseFloat((parseFloat(item.PurchasePrice) * parseFloat(item.GrnQuantity)).toFixed(4)) - item.DiscountAmount;
                        ...
                        if (item.DiscountMode2Id == 1) {
                            if (parseFloat(item.Discount2) <= parseFloat(item.UomPrice)) {
                                ...
                                item.UomPriceAfterDiscount = parseFloat(item.UomPrice) * parseFloat(item.GrnQuantityAfterConversion) - item.UomDiscountAmount;
                                item.PurchasePriceAfterDiscount = parseFloat(item.PurchasePrice) * parseFloat(item.GrnQuantityAfterConversion) - item.DiscountAmount;
                            }
