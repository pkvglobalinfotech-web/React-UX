(function () {
    ...
    angular
        .module('app.pages')
        .controller('VirtualMedicineOrderPendingOrderController', VirtualMedicineOrderPendingOrderController);

    function VirtualMedicineOrderPendingOrderController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    VirtualMedicineOrderPendingOrderController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
