(function() {
    ...
    opbilling.controller('dietBillingListController', dietBillingListController);

    function dietBillingListController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        vm.Context = 'DG';
        ...
        $scope.saveCancelled = function() {
            if ($scope.isPartiallyOrderCancelled()) {
                ...
                var confirmOptions = {
                    headingKey: 'common.confirm-modal-header.lbl',
                    messageKey: 'billing.directbilling.cancelmsg.lbl',
                    yesKey: 'common.yeskey.lbl',
                    noKey: 'common.nokey.lbl',
        ...
        $scope.lookupCallback = function(scope, data, options, hasError) {
            ...
            forEach(data, function(value, key) {
                ...
                if (key == 'Department' && $scope.currentfilter.DepartmentId === -1) {
                    $scope.currentfilter.DepartmentId = value[0].Id;
                }
            });
    ...
    dietBillingListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
