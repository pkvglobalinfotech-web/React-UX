(function () {
    ...
    angular
        .module('app.pages')
        .controller('CNFavoriteOrdersController', CNFavoriteOrdersController);

    function CNFavoriteOrdersController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    CNFavoriteOrdersController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
