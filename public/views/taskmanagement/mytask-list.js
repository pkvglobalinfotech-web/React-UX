(function() {
    ...
    angular
        .module('app.pages')
        .controller('mytasklistController', mytasklistController);

    function mytasklistController($scope, $stateParams, $state, $translate, utl, $filter, modalConfig) {
        var vm = this;
        ...
        $scope.addNew = function() {
            utl.Modal.openFixedDialog('app.mytaskform', {
                params: { id: 0 },
    ...
    mytasklistController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'modalConfig'];
