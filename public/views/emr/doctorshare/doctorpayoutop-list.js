(function () {
    ...
    angular
        .module('app.pages')
        .controller('doctorPayoutOPListController', doctorPayoutOPListController);

    function doctorPayoutOPListController($rootScope,$scope, $stateParams, $state, $translate, utl, $filter,$timeout) {
        var vm = this;
        $scope.currentfilter = {
    ...
    doctorPayoutOPListController.$inject = ['$rootScope','$scope', '$stateParams', '$state', '$translate', 'utl', '$filter','$timeout'];
})();