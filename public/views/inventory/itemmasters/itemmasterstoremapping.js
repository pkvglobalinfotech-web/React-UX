(function () {
    ...
    angular
        .module('app.pages')
        .controller('itemmasterStoreMapController', itemmasterStoreMapController);

    function itemmasterStoreMapController($scope, $stateParams, $state, $translate, utl) {
    ...
    itemmasterStoreMapController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
