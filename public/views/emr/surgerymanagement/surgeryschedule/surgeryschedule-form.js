(function () {
    ...
    angular
        .module('app.pages')
        .controller('surgeryscheduleFormController', surgeryscheduleFormController);

    function surgeryscheduleFormController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
    ...
    surgeryscheduleFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
