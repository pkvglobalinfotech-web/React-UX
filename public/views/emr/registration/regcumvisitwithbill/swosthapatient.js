(function () {
    ...
    angular
        ...
        .controller('SwosthaPatientgetController', SwosthaPatientgetController);

    function SwosthaPatientgetController($scope, $stateParams, $state, $translate, utl, $filter, uibButtonConfig, $uibModalInstance, modalConfig, $timeout) {
        var vm = this;
        ...
        $scope.patientCallback = function (scope, data, options, hasError) {
            console.log(data.body.Data);
            console.log(data);
            //utl.Alert.showSuccessMsg($translate.instant('common.successmsg.lbl'));
            $scope.backToList(data.body.Data);
        }
        ...
        $scope.findItem = function () {
            ...
            var inputData = {
                Url: 'v2/app/registration/GetPatients',
                Params: [{
                    'Key': 7,
                    'Value': 2
                  },
            ...
            var options = {
                action: 'General/Swostha/GetSwosthaPatient',
                data: {Data: inputData},
                type: 'post',
                onComplete: $scope.patientCallback
            };
            utl.Http.doAction(options);
    ...
    SwosthaPatientgetController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', 'uibButtonConfig', '$uibModalInstance', 'modalConfig', '$timeout']
