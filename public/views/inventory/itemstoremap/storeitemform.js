(function () {
    ...
    angular
        .module('app.pages')
        .controller('storeitemFormController', storeitemFormController);

    function storeitemFormController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig, $filter) {
        var vm = this;
        ...
        */
        ...
        $scope.getListCallback = function (scope, res, options, hasError) {
            ...
            $scope.item.ItemMasterId = data.ItemMasterId;
            $scope.item.ItemCode = data.ItemCode;
            $scope.item.ItemName = data.ItemName;
            $scope.item.MinQty = data.MinQty;
            $scope.item.MaxQty = data.MaxQty;
            $scope.item.ROLQty = data.ROLQty;
            $scope.item.LeadTime = data.LeadTime;
        };
    ...
    storeitemFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig', '$filter'];
