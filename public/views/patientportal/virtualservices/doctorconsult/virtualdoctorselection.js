(function () {
    ...
    angular
        .module('app.pages')
        .controller('VirtualDoctorSelectionController', VirtualDoctorSelectionController);

    function VirtualDoctorSelectionController($scope, $stateParams, $state, $translate, utl, Upload) {
    ...
    VirtualDoctorSelectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', 'Upload'];
