(function () {
    ...
    angular
        .module('app.pages')
        .controller('AbnormalReviewFormController', AbnormalReviewFormController);

    function AbnormalReviewFormController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    AbnormalReviewFormController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
