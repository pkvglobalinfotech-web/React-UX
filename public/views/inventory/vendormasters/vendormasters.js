(function () {
    ...
    angular
        .module('app.pages')
        .controller('vendorMastersListController', vendorMastersListController);

    function vendorMastersListController($rootScope, $scope, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
    ...
    vendorMastersListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
