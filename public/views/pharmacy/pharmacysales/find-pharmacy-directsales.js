(function () {
    ...
    angular
        .module('app.pages')
        .controller('findpharmacyDirectsalesListController', findpharmacyDirectsalesListController);

    function findpharmacyDirectsalesListController($scope, $filter, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.getList = function (pageNo) {
            ...
            if ($scope.modeldata.BillNumber || $scope.modeldata.MRN ||
                $scope.modeldata.Mobile || $scope.modeldata.PatientName) {
            ...
            var options = {
                action: 'billing/patientbills/GetFindDirectPharmacyBills',
                data: inputData,
                type: 'post',
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'select') {
                $scope.confirmCallback({
                    ...
                    PatientReturns: entity.PatientReturns
                });
    ...
    findpharmacyDirectsalesListController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
})();