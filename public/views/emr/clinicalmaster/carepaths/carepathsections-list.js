(function () {
    ...
    angular
        .module('app.pages')
        .controller('carepathSectionListController', carepathSectionListController);

    function carepathSectionListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        //     $state.go('app.carepathtab.carepathsection', { carepathsectionid: 0 });
        // }
        $scope.openModal = function (Id) {
            utl.Modal.open('app.carepathtab.carepathsection', {
        ...
        $scope.onDeleteConfirmed = function (deleteId) {
            var options = {
                action: 'clinicalmaster/CarePathSection/DeleteCarePathSection',
                data: { Id: deleteId },
                type: 'post',
    ...
    carepathSectionListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
