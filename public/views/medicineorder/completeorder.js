(function () {
    ...
    angular
        .module('app.pages')
        .controller('VirtualMedicineOrderCompleteOrderController', VirtualMedicineOrderCompleteOrderController);

    function VirtualMedicineOrderCompleteOrderController($rootScope, $scope, $filter, $stateParams, $state, $translate, utl, $timeout) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, entity) {
            if (actionType == 'edit') {
                $state.go('app.medicineorderlisttab.medicineorderform', {
                    id: entity.Id,
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                { field: "DeliveryAddress", displayName: $translate.instant('patientportal.medicineorder.location.lbl') },
                {
                    ...
                    cellTemplate: "<div class='ui-grid-cell-contents'><span >{{entity.DeliveryDate | date : 'dd-MMM-yyyy'}} </span>" + "<span >{{entity.DeliveryDate| date: 'HH:mm'}}</span>" + "</div>"
                },
                {
    ...
    VirtualMedicineOrderCompleteOrderController.$inject = ['$rootScope', '$scope', '$filter', '$stateParams', '$state', '$translate', 'utl', '$timeout'];
