(function () {
    ...
    angular
        .module('app.pages')
        .controller('cnProcedureSectionController', cnProcedureSectionController);

    function cnProcedureSectionController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.patientprocedure', {
                    params: { id: entity.Id, pid: $scope.currentcontext.pid, cid: $scope.currentcontext.cid },
                    confirmCallback: $scope.getList
                }
                );
            }
        ...
        vm.gridConfig = {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate: "<ngformatdate date-val='entity.PerformedDate'></ngformatdate>"
                },
    ...
    cnProcedureSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
