(function () {
    ...
    function bannerListController($scope, $stateParams, $state, $translate, utl) {
        var vm = this;
        ...
        $scope.addNew = function () {
            $state.go('app.bannertab.banner', { id: 0 });
        }
        ...
        $scope.handleEvents = function (actionType, entity) {
            ...
            if (actionType == 'edit') {
                $state.go('app.bannertab.banner', { id: entity.Id });
            }
            else if
            (actionType == 'view') {
                $state.go('app.bannertab.banner', { id: entity.Id });
    ...
    bannerListController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
