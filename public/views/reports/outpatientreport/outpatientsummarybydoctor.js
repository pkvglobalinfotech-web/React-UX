(function () {
    ...
    angular
        .module('app.pages')
        .controller('OutpatientSummaryByDoctorController', OutpatientSummaryByDoctorController);

    function OutpatientSummaryByDoctorController($scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
        ...
        $scope.GetListOptions = function () {
            ...
            var options = {
                action: 'Visit/Visit/GetOutpatientSummaryDoctor',
                data: inputData,
                type: 'post',
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'Visit/Visit/PrintOutpatientSummarybyDoctor',
                data: inputData,
                type: 'post'
            };
    ...
    OutpatientSummaryByDoctorController.$inject = ['$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
