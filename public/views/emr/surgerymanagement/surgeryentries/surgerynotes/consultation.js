(function () {
    ...
    angular
        .module('app.pages')
        .controller('SurgeryNoteconsultationController', SurgeryNoteconsultationController);

    function SurgeryNoteconsultationController($scope, $stateParams, $state, $translate, utl, $uibModal, $timeout) {
        var vm = this;

        var SectionNoteTypeId = 4; // OT Reference Id // SectionNoteType
        ...
        function getSectionPath() {
            return "app/views/emr/surgerymanagement/surgeryentries/surgerynotes/sections/";
        }
    ...
    SurgeryNoteconsultationController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModal', '$timeout'];
