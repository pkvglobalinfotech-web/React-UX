(function () {
    ...
    angular
        .module('app.pages')
        .controller('newitemmasterStoreMapController', newitemmasterStoreMapController);

    function newitemmasterStoreMapController($scope, $stateParams, $state, $translate, utl) {
    ...
    newitemmasterStoreMapController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
