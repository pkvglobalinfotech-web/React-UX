(function () {
    ...
    opbilling.controller('opbillingEstListController', opbillingEstListController);

    function opbillingEstListController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
        ...
        $scope.saveItemCallback = function (scope, data, options, hasError) {
            ...
            if (($scope.currentcontext.id > 0 && $scope.item.PatientBillStatusId == 3) && !$scope.item.IsMultiplePayment) {
                if ($scope.item.GuarantorTypeId == 1 && $scope.item.OutStandingAmount == 0) {
                    $scope.print();
            ...
            if (($scope.currentcontext.id > 0 && $scope.item.PatientBillStatusId == 3) &&
                $scope.item.IsMultiplePayment && $scope.item.OutStandingAmount == 0) {
                $scope.print();
            }
    ...
    opbillingEstListController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
