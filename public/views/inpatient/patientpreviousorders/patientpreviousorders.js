(function () {
    ...
    angular
        .module('app.pages')
        .controller('PreviousOrdersController', PreviousOrdersController);

    function PreviousOrdersController($scope, $stateParams, $state, $translate, utl, $filter, $uibModalInstance, modalConfig) {
        var vm = this;
        ...
        if (modalConfig && modalConfig.params) {
            ...
            $scope.currentcontext.patientdispenseid = modalConfig.params.patientdispenseid;
    ...
    PreviousOrdersController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$uibModalInstance', 'modalConfig'];
