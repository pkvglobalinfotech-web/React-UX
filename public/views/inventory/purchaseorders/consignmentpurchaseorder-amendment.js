(function () {
    ...
    angular
        .module('app.pages')
        .controller('consignmentpurchaseOrderAmendController', consignmentpurchaseOrderAmendController);

    function consignmentpurchaseOrderAmendController($rootScope, $scope, $stateParams, $state, $translate, utl, $filter, $timeout) {
        var vm = this;
    ...
    consignmentpurchaseOrderAmendController.$inject = ['$rootScope', '$scope', '$stateParams', '$state', '$translate', 'utl', '$filter', '$timeout'];
