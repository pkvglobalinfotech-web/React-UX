(function () {
    ...
    angular
        .module('app.pages')
        .controller('LabOrderDetailReportController', LabOrderDetailReportController);

    function LabOrderDetailReportController($scope, $stateParams, $state, $translate, $filter, utl) {
        var vm = this;
            ...
            data.Data.forEach(function (rowArray) {
                ...
                if (rowArray.PatientOrder.EncounterType) {
                    if (rowArray.PatientOrder.EncounterType.Description) {
                        patType = rowArray.PatientOrder.EncounterType.Description;
                    }
                }
                ...
                csvContent += Date + ',' + orderNo + ',' + patType + ',' + patName + ',' + mrn + ',' + docName + ',' + testName + ',' + testCode + ',' + dept + ',' + status + "\n";
            });
            var encodedUri = encodeURIComponent(csvContent);
            var hiddenElement = document.createElement('a');
            hiddenElement.href = 'data:text/csv;charset=utf-8,' + encodedUri;
            hiddenElement.target = '_blank';
            hiddenElement.download = 'laborderdetail-report.csv';
            hiddenElement.click();
        ...
        $scope.excelDownload = function () {
            ...
            var options = {
                action: "emr/patientorderdetail/GetPatientOrderDetailswithoutorder",
                data: inputData,
                type: "post",
        ...
        $scope.print = function () {
            ...
            var options = {
                action: 'emr/patientorderdetail/PrintLabDetailReport',
                data: inputData,
                type: 'post'
            };
    ...
    LabOrderDetailReportController.$inject = ['$scope', '$stateParams', '$state', '$translate', '$filter', 'utl'];
