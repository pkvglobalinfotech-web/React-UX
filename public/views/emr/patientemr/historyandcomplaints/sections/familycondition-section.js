...
(function () {
    ...
    function FamilyConditionSectionController($scope, $stateParams, $state, $translate, utl, $filter) {
        var vm = this;
        ...
        $scope.handleEvents = function (actionType, item) {
            ...
            if (actionType == 'edit') {
                utl.Modal.open('patientemr.familyhistoryform', {
    ...
    FamilyConditionSectionController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$filter'];
