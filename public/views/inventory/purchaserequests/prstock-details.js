(function () {
    ...
    angular
        .module('app.pages')
        .controller('prstockdetailsController', prstockdetailsController);

    function prstockdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    prstockdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
