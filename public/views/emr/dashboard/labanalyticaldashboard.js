(function () {
    ...
    angular
        .module('app.pages')
        .controller('labanalyticaldashboardController', labanalyticaldashboardController);

    function labanalyticaldashboardController($rootScope,$timeout,
        $scope, $filter, $stateParams, $state, $translate, utl) {
        var vm = this;
        $scope.items = [];
    ...
    labanalyticaldashboardController.$inject = ['$rootScope','$timeout','$scope', '$filter', '$stateParams', '$state', '$translate', 'utl'];
