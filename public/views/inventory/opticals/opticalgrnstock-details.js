(function() {
    ...
    angular
        .module('app.pages')
        .controller('grnstockdetailsController', grnstockdetailsController);

    function grnstockdetailsController($scope, $stateParams, $state, $translate, utl, $uibModalInstance, modalConfig) {
        var vm = this;
    ...
    grnstockdetailsController.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl', '$uibModalInstance', 'modalConfig'];
