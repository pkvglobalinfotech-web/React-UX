...
import { StoreMasterDetailService } from '../Service/Index';
...
router.post('/AddStoreMaster',
    ...
    (req: Request, res: Response, next: NextFunction): any => {
        const service = ServiceFactory.CreateService(StoreMasterDetailService, req);
        service.AddStoreMasterDetail(req.body)
