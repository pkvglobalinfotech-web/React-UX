(function() {
    ...
    angular
        .module('app.pages')
        .controller('newappointments', newappointments);

function newappointments($scope, $stateParams, $state, $translate, utl) {
    var vm = this;
...
newappointments.$inject = ['$scope', '$stateParams', '$state', '$translate', 'utl'];
