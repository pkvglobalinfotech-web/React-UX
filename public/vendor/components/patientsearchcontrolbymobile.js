(function () {
    ...
    angular
        .module('common.utils')
        .controller('patientSearchMobileCtrl', ['utl', '$scope', '$timeout', '$http', function (utl, $scope, $timeout, $http) {
            var cvm = this;
            cvm.patients = [];
            console.log(cvm);
            cvm.patientdisplay = {};
        ...
        .component('patientsearchmobile', {
            ...
            controller: 'patientSearchMobileCtrl',
            controllerAs: 'cvm',
            templateUrl: 'vendor/components/patientsearchcontrolbymobile.html'
        })
})();